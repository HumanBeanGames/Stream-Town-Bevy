...
{
	[CreateAssetMenu(fileName = "ResourceDataSettings", menuName = "Scriptables/ResourceDataSettings")]
	public class ResourceDataSettings : ScriptableObject, IDataScriptable
	{
		[Header("Food")]
