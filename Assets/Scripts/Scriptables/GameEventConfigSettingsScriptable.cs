...
namespace ScriptablesProcessorInfrastructure
{
	...
	/// </summary>
	[CreateAssetMenu(fileName = "GameEventConfigSettings", menuName = "Scriptables/GameEventConfigSettings")]
	public class GameEventConfigSettings : ScriptableObject, IDataScriptable
	{
