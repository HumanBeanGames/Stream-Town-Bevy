...
namespace Utils
{
    ...
    public static class Noise
    {
        ...
        public static IEnumerator GenerateNoiseMapCoroutine(int mapWidth, int mapHeight, int seed, float scale, int octaves, float persistance, float lacunarity, Vector2 offset, float frameBudgetSeconds, Action<float[,]> onComplete, float multiplier = 1)
        {
            float[,] noiseMap = new float[mapWidth, mapHeight];
