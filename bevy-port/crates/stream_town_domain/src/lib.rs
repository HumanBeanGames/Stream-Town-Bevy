...
pub use presentation::{
    ...
    PresentationCatalog, PresentationError, RainingFishVfxDef, RendererMaterialBinding,
    SceneFireworksBinding, ScenePostProcessBinding, TextureDef, TextureTransform, VfxAlphaKeyframe,
