...
## Corpus Check
- 670 files · ~1,815,447 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9367 nodes · 28130 edges · 320 communities (297 shown, 23 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 1059 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1eb27cfb`
...
### Community 4 - "Res"
Cohesion: 0.03
Nodes (327): AccessibilityFocusVisualQuery, Added, AnimatedBy, AnimationGraphHandle, AnimationTransitions, AudioSink, accessibility_button_enabled(), accessibility_input() (+319 more)

### Community 5 - "stream_town_game/src/lib.rs"
Cohesion: 0.01
Nodes (337): AnyResult, AnimationTransitionOutcome, accessibility_settings_selection(), accessibility_should_clear_focus(), AccessibilityActionDispatch, AccessibilityAnnouncement, AccessibilityCandidate, AccessibilityHighContrastText (+329 more)
...
### Community 9 - ".new"
Cohesion: 0.02
Nodes (198): AccessibilityActionRequest, AccessibleNode, DirtyRegion, generate_world(), generate_world_with_content(), accessibility_motion_preferences_preserve_authored_parameters(), accessibility_scope_keeps_modal_navigation_inside_the_open_surface(), accessibility_tagging_tolerates_ui_removed_before_deferred_annotation() (+190 more)
...
Cohesion: 0.08
Nodes (14): BuildingDamageMaterialHandler, bool, IEnumerator, Renderer, Action, float, Enemy, Action (+6 more)

### Community 16 - ".count"
Cohesion: 0.05
Nodes (77): AccessibilityNode, AssetId, advance_loading_phase(), advance_loading_runtime(), advance_world_loading_cover(), asset_root_collection_ready(), authored_rotating_node_names(), begin_world_loading_cover() (+69 more)
...
### Community 18 - "build_converted_animation"
Cohesion: 0.06
Nodes (55): AnimationClip, AnimationTargetId, add_animation_composition(), add_animation_layer_branch(), add_rotation_curve(), add_scale_curve(), add_translation_curve(), advance_animation_crossfade() (+47 more)
...
Cohesion: 0.06
Nodes (77): animation_property_curves_editor(), apply_building_draft(), apply_enemy_camp_generation_draft(), AssetEditorSection, authoring_apply_preserves_the_complete_local_twitch_setup(), authority_tab(), building_draft(), building_editor_preserves_the_complete_template_record() (+69 more)
...
### Community 25 - "Option"
Cohesion: 0.04
Nodes (165): GameConfig, GameplayConfig, BTreeMap, ArchetypeDef, ArchetypeScene, PresentationCatalog, GeneratedFoliage, GeneratedResource (+157 more)
...
Cohesion: 0.20
Nodes (3): Result, SimulationError, validate_trade_resource()
...
### Community 29 - "Ui"
Cohesion: 0.15
Nodes (42): ArchetypeKind, animation_assets_editor(), animation_condition_mode_choice(), animation_layer_blend_choice(), animation_layers_editor(), animation_transitions_editor(), archetype_kind_choice(), archetype_runtime_editor() (+34 more)

### Community 30 - "setup_rendering"
Cohesion: 0.05
Nodes (82): AmbientLight, ActiveMaterialHandles, AnimatedCharacterShadowReceiver, apply_material_overrides(), authored_post_process_stack(), building_material(), building_snow_strength(), BuildingMaterialInstance (+74 more)
...
### Community 36 - "Result"
Cohesion: 0.20
Nodes (38): aged_buildings(), building_cost_reductions(), building_level_caps(), convert_export(), enemy_camp_generation_layers(), field_value(), foliage_layers(), generated_record_ids() (+30 more)
...
Cohesion: 0.03
Nodes (224): BuildingDef, ContentCatalog, PassiveResourceContribution, RoleSlotContribution, StationDef, StorageContribution, StorageModelDef, TargetingScoreDef (+216 more)
...
### Community 57 - "CommonEnums.cs"
Cohesion: 0.06
Nodes (27): RoleData, AudioClip, bool, float, int, Sprite, string, AudioClip (+19 more)

### Community 58 - "MonoBehaviour"
Cohesion: 0.01
Nodes (111): CameraProcessor, CellSpacePartitioningInstaller, ContainerBuilder, ContainerBuilder, InstantiationBarrier, PersistentScoped, ContainerBuilder, Volume (+103 more)
...
Cohesion: 0.10
Nodes (39): ArchetypeBounds, AuthoredRecord, AuthoredValue, BuildingModelDef, ContentError, default_resource_generation_layers(), EnemyDef, EnemyModelSetDef (+31 more)
...
Cohesion: 0.05
Nodes (21): RotationHandler, float, Quaternion, Vector3, EnemyModelHandlerEditor, bool, int, List (+13 more)
...
Cohesion: 0.10
Nodes (41): asset(), authored_value(), component(), component_at(), ContentConversionReport, convert(), converted_rotating_axis(), converts_active_catalog_references_and_round_trips_ron() (+33 more)
...
Cohesion: 0.11
Nodes (20): authored_trade_rates_clamp_to_stock_gold_and_capacity(), building_damage_and_repair_preserve_health_bounds(), capped_deposit_preserves_inventory_overflow(), default_ruler_vote_cooldown(), deterministic_fish_god_value(), deterministic_weather(), enemy_camps_and_raid_progress_round_trip_with_stable_archetypes(), fish_god_progress_rewards_food_unlocks_pet_and_expires() (+12 more)
...
### Community 76 - ".Log"
Cohesion: 0.05
Nodes (28): Action, Action, CancellationToken, Task, IAsyncInitializableProcessor, ProcessorStartupContext, Container, ContainerBuilder (+20 more)

### Community 77 - "Objective"
Cohesion: 0.07
Nodes (12): int, ChangeTimeStamp, Action, int, Objective, ObjectiveType, ObjectiveData, EnemyType (+4 more)

### Community 78 - "technology_graph.rs"
Cohesion: 0.06
Nodes (67): automatic_layout_is_complete_deterministic_and_valid(), bounded_layout_index(), GraphPoint, GraphSize, id(), reconcile_preserves_moves_and_repairs_catalog_coverage(), BTreeMap, Default (+59 more)
...
Cohesion: 0.16
Nodes (25): WorldGenConfig, authored_grid_centre(), authored_world_to_grid(), cell_hash(), foliage_horizontal_hash(), generate_authored_resources(), generate_candidate_mask(), generate_foliage() (+17 more)

### Community 93 - "buildings_tab"
Cohesion: 0.18
Nodes (19): ability_choices(), action_animation_choices(), animation_events_editor(), animation_quat_keys_editor(), animation_transform_tracks_editor(), animation_vec3_keys_editor(), building_model_node_choices(), buildings_tab() (+11 more)

### Community 94 - "convert_fbx_to_glb.py"
Cohesion: 0.14
Nodes (28): arguments(), bake_uniform_scale(), bounds_record(), convert(), discover_sources(), evaluated_scene_bounds(), inspect_glb(), main() (+20 more)

### Community 95 - "ObjectiveDef"
Cohesion: 0.29
...
Cohesion: 0.12
Nodes (12): CustomLogHandler, Exception, HideInCallstack, LogType, Object, string, Type, Dictionary (+4 more)
...
Cohesion: 0.18
Nodes (14): canonical_preview_node_name(), debug_fingerprint(), default_role_preview_animation(), matching_role_animation_state(), player_animation_controller(), player_preview_controlled_node(), role_preview_animation_choices(), role_preview_animation_request() (+6 more)
...
Cohesion: 0.12
Nodes (30): add_archetype_scene(), animation_controller_editor(), animation_parameter_kind_choice(), animation_parameters_editor(), animation_state_machines_editor(), animation_states_editor(), create_animation_clip(), create_animation_controller() (+22 more)
...
Cohesion: 0.05
Nodes (53): amf_quality_profile_keeps_static_grid_detail_between_keyframes(), append_direct_broadcast_diagnostic(), append_direct_broadcast_diagnostic_to(), AuthorizationEvent, average_milliseconds(), bandwidth_test_url_is_constructed_without_logging_the_key(), build_ingest_url(), configure_amf_quality() (+45 more)
...
Cohesion: 0.11
Nodes (43): AtomicBool, AudioFrame, AudioInput, BroadcastController, BroadcastMetrics, BroadcastPrerequisites, BroadcastTarget, capture_process_audio() (+35 more)
...
Cohesion: 0.07
Nodes (53): apply_direct_broadcast_control(), arm_stream_only_readback(), BroadcastMetricsSnapshot, camera_targets_primary_window(), capture_direct_broadcast_frame(), cleanup_completed_stream_only_readbacks(), configure_direct_broadcast(), DirectBroadcastPhase (+45 more)
...
### Community 143 - "stream_operator_chat_controls"
Cohesion: 0.07
Nodes (28): BroadcastStopDisposition, DirectBroadcastControl, exit_after_broadcast_stops(), moderate_selected_operator_user(), operator_chat_scroll_rows(), operator_window_close_requests_exit(), AppExit, Changed (+20 more)
...
### Community 147 - "UserInterface_RulerVote"
Cohesion: 0.13
...
### Community 150 - "World.Generation"
Cohesion: 0.04
...
Cohesion: 0.17
Nodes (18): animation_parameter_name(), archetype_scenes(), authored_mask(), building_placements(), BuildingPlacement, child_technology_guids(), collect_model_dependencies(), decomposes_combined_unity_flag_values() (+10 more)

### Community 159 - "Instant"
Cohesion: 0.21
Nodes (9): CadenceTick, duration_as_micros(), reset_stream_health_window(), Duration, Instant, stream_readback_due(), twitch_live_request_timeout(), video_cadence_skips_stale_slots_instead_of_bursting_after_a_stall() (+1 more)
...
Cohesion: 0.02
Nodes (89): ContainerBuilder, BuildingConfigSettingsInstaller, ContainerBuilder, GameEventConfigSettingsInstaller, ContainerBuilder, TimeDataSettingsInstaller, ContainerBuilder, WorldGenBehaviorSettingsInstaller (+81 more)
...
### Community 203 - "TechnologyTreeGroup"
Cohesion: 0.20
...
### Community 208 - "UserInterface_Resources"
Cohesion: 0.21
Nodes (7): Slider, TextMeshProUGUI, Color, GameObject, Slider, TextMeshProUGUI, UserInterface_Resources

### Community 209 - ".label"
Cohesion: 0.13
Nodes (26): EnemyCampGenerationDef, apply_role_draft(), delete_selected_role(), draw_world_preview(), duplicate_selected_role(), legacy_content_tab(), legacy_roles_tab(), migration_tab() (+18 more)
...
### Community 267 - "ObjectPoolingSettings"
Cohesion: 0.22
...
### Community 288 - "Utils"
Cohesion: 0.03
Nodes (48): BuildCostModifier, InputButton, Color, GameUserType, UserColours, STStateMachine.States, UserInterface.MainMenu, PlayerControls.ObjectSelection (+40 more)
...
### Community 292 - "RoleProgress"
Cohesion: 0.22
Nodes (4): legacy_simulation_calendar_upgrades_without_advancing_timers(), RoleProgress, Default, Self

### Community 294 - "CreateProjectScopeProcessors.cs"
Cohesion: 0.40
Nodes (3): MenuItem, CreateProjectScopeProcessors, StreamTownEditor

### Community 295 - "complete_gameplay_scenario_round_trips"
Cohesion: 0.25
Nodes (4): complete_gameplay_scenario_round_trips(), Option, technology_vote_starts_persistent_goal_and_unlocks_after_all_objectives(), TownEvent

### Community 296 - "BuildingModelHandler"
Cohesion: 0.25
Nodes (3): BuildingModelHandler, GameObject, List

### Community 297 - "ResourceDataSettings"
Cohesion: 0.25
Nodes (6): ContainerBuilder, ResourceDataSettingsInstaller, bool, int, Vector3, ResourceDataSettings

### Community 298 - "ObjectPoolingRuntimeData"
Cohesion: 0.43
Nodes (7): Dictionary, float, GameObject, List, Queue, ObjectPoolingRuntimeData, TimeSpan

### Community 299 - "ToolState"
Cohesion: 0.08
Nodes (67): apply_foliage_draft(), apply_objective_draft(), apply_resource_generation_draft(), apply_technology_draft(), authoring_snapshot(), AuthoringSnapshot, broadcast_encoder_label(), commit_catalog_candidate() (+59 more)

### Community 300 - "TechTreeSearchWindow"
Cohesion: 0.32
Nodes (6): List, Texture2D, TechTreeSearchWindow, ISearchWindowProvider, SearchTreeEntry, SearchWindowContext

### Community 301 - ".start_technology_ballot"
Cohesion: 0.25
Nodes (7): numbered_technology_ballot_waits_for_a_vote_and_resolves_the_winner(), ObjectiveProgress, Vec, RulerVoteKind, RulerVoteState, TechVote, TownGoalState

### Community 302 - "BuildingScriptablesEditor.cs"
Cohesion: 0.29
...
### Community 304 - "TransformSaveData"
Cohesion: 0.05
...
- **Why does `Utils` connect `Utils` to `SimpleScreenShot`, `SeasonProcessor`, `EnemySpawner`, `RoleDataContainer`, `TechTree.Elements`, `ScriptablesProcessorInfrastructure`, `EventProcessor`, `World.Generation`, `.CreateEnumField`, `GenerationSettings`, `UpdateGraphBounds`, `BuildingScriptablesEditor.cs`, `IRuntimeDataScriptable`, `UnitTextDisplay`, `Easings`, `CommonEnums.cs`, `MonoBehaviour`, `ScriptableObject`, `Objective`, `BuildingPlacer`, `StringUtils`, `SnapToGridMouseMovement`, `FPSDisplay`, `Resource`, `RandomEnabler`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `StableId` connect `StableId` to `stream_town_migrate/src/presentation.rs`, `Res`, `stream_town_game/src/lib.rs`, `.new`, `config.rs`, `.count`, `save.rs`, `build_converted_animation`, `command.rs`, `twitch.rs`, `stream_town_tools/src/main.rs`, `Option`, `SimulationError`, `ModelPreviewRuntime`, `Ui`, `String`, `BTreeMap`, `RoleProgress`, `Result`, `complete_gameplay_scenario_round_trips`, `ToolState`, `AnimationControllerDef`, `.start_technology_ballot`, `legacy.rs`, `Result`, `stream_town_domain/src/content.rs`, `stream_town_migrate/src/menu_scene.rs`, `world.rs`, `simulation.rs`, `technology_graph.rs`, `.label`, `buildings_tab`, `ObjectiveDef`, `.tick`, `stream_town_domain/src/presentation.rs`, `UnityAsset`, `matching_role_animation_state`, `String`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `PlayerProcessor` connect `PlayerProcessor` to `BuildingProcessor`, `TimeProcessor`, `EnemySpawner`, `TwitchChatProcessor`, `BottomBarInterface`, `UserInterface_Debug`, `HealthHandler`, `UserInterface_TownVote`, `WorldGenProcessor`, `Utils`, `TechTreeProcessor`, `SelectedObject`, `Player`, `StreamTownSessionBridge`, `TwitchClientProcessor`, `UIProcessor`, `MonoBehaviour`, `GameEventProcessor`, `PlayerRoleData`, `.Log`, `BuildingPlacer`, `IProcessor`, `RaidEvent`, `Resource`, `SaveProcessor`, `PoolableObject`, `RoleHandler`, `VoteEvent`?**
