...
## Corpus Check
- 605 files · ~1,580,318 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6694 nodes · 17080 edges · 274 communities (245 shown, 29 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 992 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `44272321`
...
### Community 0 - "IInstaller"
Cohesion: 0.04
Nodes (33): CellSpacePartitioningInstaller, ContainerBuilder, ContainerBuilder, InstantiationBarrier, ContainerBuilder, MetaDataInstaller, ContainerBuilder, AllSeasonsSettingsInstaller (+25 more)
...
### Community 4 - "Utils"
Cohesion: 0.06
Nodes (15): BuildCostModifier, PlayerControls.ObjectSelection, Units, Utils, Target, Utils.Pooling, Level, GridSystem.Partitioning (+7 more)
...
### Community 9 - "BinaryWriter"
Cohesion: 0.12
Nodes (6): Action, List, int, string, ObjectiveSaveData, BinaryWriter
...
Cohesion: 0.14
Nodes (13): TargetSettings, TargetableData, Foliage, FoliageSaveType, FoliageType, PLayerActivityStatus, ResourceType, Seasons (+5 more)
...
### Community 36 - "Handle"
Cohesion: 0.14
Nodes (18): BuildingMaterialExtension, BuildingMaterialUniform, CloudMaterialExtension, CloudMaterialUniform, RoleActionAudioCache, Image, TerrainMaterialExtension, TerrainMaterialUniform (+10 more)
...
Cohesion: 0.05
Nodes (64): ObjectiveDef, FromStr, StableId, authored_trade_rates_clamp_to_stock_gold_and_capacity(), BuildingState, capped_deposit_preserves_inventory_overflow(), complete_gameplay_scenario_round_trips(), default_ruler_vote_cooldown() (+56 more)
...
Cohesion: 0.11
Nodes (79): App, AssetServer, PresentationCatalog, actor_material(), AgentAnimation, animate_agents(), apply_agent_commands(), building_age() (+71 more)
...
### Community 95 - "ResourceStorageModifier"
Cohesion: 0.22
...
Cohesion: 0.03
Nodes (156): AnimationClip, AnimationGraph, AnimationGraphHandle, AnimationNodeIndex, AnimationPlayer, AnimationTargetId, BackgroundColor, active_event_text() (+148 more)
...
### Community 135 - "Option"
Cohesion: 0.07
Nodes (81): GameConfig, Default, ContentCatalog, GridPos, ActorState, RoleProgress, Default, String (+73 more)
...
### Community 138 - "World.Generation"
Cohesion: 0.11
Nodes (8): List, CampGenSettings, float, int, string, Vector2, CampGenerationSettings, World.Generation

### Community 139 - "ResourceHolder"
Cohesion: 0.22
...
### Community 148 - "TownResourceRuntimeData"
Cohesion: 0.18
...
### Community 154 - ".SetGeneratedResources"
Cohesion: 0.15
Nodes (7): float, int, List, Resource, uint, Vector3, ResourceTarget

### Community 155 - "AllBuildingDataSettings"
Cohesion: 0.29
...
### Community 184 - "TechTreeSearchWindow"
Cohesion: 0.32
...
### Community 186 - ".RenderResourceType"
Cohesion: 0.18
...
### Community 188 - "VfxParticlePosition"
Cohesion: 0.40
...
### Community 196 - "MonoBehaviour"
Cohesion: 0.05
Nodes (20): CameraProcessor, PersistentScoped, Slider, TextMeshProUGUI, UI_Objective, TextMeshProUGUI, UI_VoteObjectiveRow, Image (+12 more)
...
### Community 224 - "Res"
Cohesion: 0.04
Nodes (109): Added, AmbientLight, AppExit, Assets, ActorAnimationDriver, Agent, agent_is_moving(), AgentEquipmentPresentation (+101 more)
...
### Community 231 - "UIElementWrapper"
Cohesion: 0.08
...
### Community 247 - "load_runtime_config"
Cohesion: 0.50
Nodes (3): AnyResult, load_runtime_config(), main()

### Community 248 - "SimpleRotateOnAxis"
Cohesion: 0.40
...
Cohesion: 0.03
Nodes (47): ContainerBuilder, BuildingConfigSettingsInstaller, ContainerBuilder, CampGenSettingsInstaller, ContainerBuilder, GameEventConfigSettingsInstaller, ContainerBuilder, ResourceDataSettingsInstaller (+39 more)

### Community 280 - "ScriptableObject"
Cohesion: 0.03
Nodes (55): ContainerBuilder, AudioSettingsInstaller, int, AudioSettings, float, Material, Volume, DayAndNightSettings (+47 more)
...
## Knowledge Gaps
- **227 isolated node(s):** `StreamTown.Migration`, `StreamTown.EditorTools`, `Attributes`, `BuildCostModifier`, `StartupState` (+222 more)
...
- **Why does `SaveProcessor` connect `SaveProcessor` to `IInstaller`, `IProcessor`, `BuildingProcessor`, `.InjectRuntimeData`, `SettingsProcessor`, `WorldGenProcessor`, `PlayerCommands`, `PlayerRole`, `SaveDataMapper`, `Character`, `PlayerProcessor`, `DebugProcessor`, `ResourceDataSaveData`, `GameEventProcessor`, `FoliageGenerationSettings`, `SaveFileData`, `ResourceGenerationSettings`, `.Log`, `TechTreeProcessor`, `TimeProcessor`, `SeasonProcessor`, `UserInterface_GameMenu`, `StreamTownSessionBridge`, `ResourceProcessor`, `MonoBehaviour`, `FoliageProcessor`, `MainMenuManager`, `TownGoalProcessor`, `Resource`, `PoolableObject`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `WorldGenProcessor` connect `WorldGenProcessor` to `IInstaller`, `IProcessor`, `BuildingProcessor`, `Utils`, `TwitchChatProcessor`, `World.Generation`, `.GenerateFromSettings`, `PlayerProcessor`, `ScriptableObject`, `DebugProcessor`, `FoliageGenerationSettings`, `CellSpacePartitioning`, `UserInterface_Debug`, `ResourceGenerationSettings`, `.Log`, `ResourceProcessor`, `TwitchClientProcessor`, `Access_Dropdown`, `WorldGenRuntimeData`, `TerrainGenSettings`, `MonoBehaviour`, `GridProcessor`, `FoliageProcessor`, `RaidEvent`, `Coordinator`, `Player`, `EnemySpawner`, `SaveProcessor`, `PoolableObject`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `SettingsProcessor` connect `SettingsProcessor` to `Autosave`, `GraphicsProcessor`, `IProcessor`, `Access_Slider`, `IInstaller`, `SettingsData`, `MainMenuManager`, `UIElementWrapper`, `MonoBehaviour`, `Processors`, `Access_Toggle`, `UserInterface_GameMenu`, `SaveProcessor`, `Access_Text`, `Access_Dropdown`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **What connects `StreamTown.Migration`, `StreamTown.EditorTools`, `Attributes` to the rest of the system?**
  _227 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `IInstaller` be split into smaller, more focused modules?**
