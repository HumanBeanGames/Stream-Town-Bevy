...
## Corpus Check
- 609 files · ~1,608,995 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7079 nodes · 18684 edges · 269 communities (240 shown, 29 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 995 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1a39dd81`
...
Cohesion: 0.05
Nodes (84): GameplayConfig, BTreeMap, ArchetypeBounds, ArchetypeDef, ArchetypeKind, ArchetypeScene, AuthoredRecord, AuthoredValue (+76 more)
...
Cohesion: 0.08
Nodes (13): bool, BoxCollider, Container, GameObject, IEnumerable, int, IReadOnlyList, Mesh (+5 more)

### Community 12 - "String"
Cohesion: 0.05
Nodes (79): AnimationClip, AnimationGraph, AnimationGraphHandle, AnimationNodeIndex, AnimationPlayer, AnimationTargetId, Assets, active_event_text() (+71 more)
...
### Community 15 - "Handle"
Cohesion: 0.08
Nodes (34): actor_material(), building_effect_material(), BuildingMaterialExtension, BuildingMaterialUniform, CloudMaterialExtension, CloudMaterialUniform, combat_material(), cosmetic_color() (+26 more)

### Community 16 - "BinaryWriter"
Cohesion: 0.14
Nodes (6): Action, CancellationToken, List, string, FoliageSaveData, BinaryWriter

### Community 17 - "Option"
Cohesion: 0.08
Nodes (59): AmbientLight, AssetServer, PresentationCatalog, actor_detail_budget(), animation_property_value(), building_material(), cloud_material(), converted_animation_spec() (+51 more)
...
Cohesion: 0.06
Nodes (18): BuildingDamageMaterialHandler, bool, IEnumerator, Renderer, PlayerDeathHandler, bool, float, Vector3 (+10 more)
...
### Community 27 - "load_input"
Cohesion: 0.08
Nodes (56): AppExit, AgentCommand, AgentCommandQueue, broadcaster_gate_precedes_twitch_command_dispatch(), BuildingCommandQueue, BuildingPlacers, BuildingRuntimeCommand, CameraCommandQueue (+48 more)
...
Cohesion: 0.04
Nodes (138): GameConfig, WorldGenConfig, ContentCatalog, GridPos, ActorState, String, authored_foliage_is_deterministic_and_respects_habitat_and_resources(), cell_hash() (+130 more)
...
### Community 43 - "IRuntimeDataScriptable"
Cohesion: 0.07
Nodes (16): CreditsRuntimeData, bool, Dictionary, GUIDRuntimeData, IRuntimeDataScriptable, Dictionary, GameObject, UtilDisplayRuntimeData (+8 more)
...
Cohesion: 0.06
Nodes (16): Container, ContainerBuilder, GUIDProcessor, Dictionary, DebugSettings, ContainerBuilder, DebugSettingsInstaller, Container (+8 more)
...
Cohesion: 0.12
Nodes (16): Dictionary, List, Material, materialIndex, materials, Matrix4x4, Mesh, meshes (+8 more)
...
### Community 69 - "BuildingSaveData"
Cohesion: 0.18
Nodes (9): int, List, string, uint, BuildingSaveData, int, uint, EnemyCampSaveData (+1 more)
...
Cohesion: 0.02
Nodes (119): AnyResult, AudioSink, StreamUserType, adjust_settings_menu(), AgentEquipmentPresentation, AmbienceAudio, begin_animation_crossfade(), building_damage_intensity() (+111 more)
...
### Community 90 - "STSM_Action_PlayerBase"
Cohesion: 0.15
Nodes (3): STSM_Action_Build, STSM_Action_PlayerAttack, STSM_Action_PlayerBase
...
### Community 108 - "WorldInstanceDeterminism"
Cohesion: 0.24
...
Cohesion: 0.04
Nodes (31): DepositResources, ResourceStorageModifier, float, int, PlayerInventory, Dictionary, int, ActiveResourceIncrementer (+23 more)
...
### Community 121 - "LabelDisplayProcessor"
Cohesion: 0.17
...
### Community 129 - "PlayerInputRuntimeData"
Cohesion: 0.33
...
### Community 131 - "Res"
Cohesion: 0.06
Nodes (155): AccumulatedMouseMotion, AccumulatedMouseScroll, Added, App, BackgroundColor, actor_scene_budget(), ActorNameOverlay, Agent (+147 more)
...
### Community 135 - "Utils"
Cohesion: 0.04
Nodes (15): BuildCostModifier, InputButton, Utils, Processors, StreamTown.EditorTools, World, Level, UserInterface (+7 more)
...
### Community 138 - "STSM_Action_Attack"
Cohesion: 0.14
...
### Community 155 - "TechTreeProcessor.cs"
Cohesion: 0.12
...
### Community 159 - "UserInterface_Resources"
Cohesion: 0.21
...
### Community 166 - "HealthModifier"
Cohesion: 0.17
Nodes (7): AttackUnit, HealthModifier, bool, float, GameObject, HealUnit, STSM_Action_Heal

### Community 167 - ".Log"
Cohesion: 0.11
Nodes (8): Action, Container, ContainerBuilder, GameStateProcessor, LoadSceneMode, Scene, bool, GameStateRuntimeData
...
### Community 178 - "EnemyWeaponModel"
Cohesion: 0.24
...
### Community 188 - "BuildingRuntimeData"
Cohesion: 0.19
Nodes (9): BuildPlacerData, GameObject, Renderer, string, Vector2, Dictionary, int, List (+1 more)
...
### Community 195 - "FoliageGenerationSettings"
Cohesion: 0.22
...
### Community 204 - "TechTreeSearchWindow"
Cohesion: 0.32
...
### Community 228 - "STSM_StateAction"
Cohesion: 0.38
Nodes (4): bool, float, int, STSM_StateAction
...
### Community 234 - "UserInterface.MainMenu"
Cohesion: 0.09
Nodes (12): ContainerBuilder, MetaDataInstaller, Vector3, UnityGraphics, ContainerBuilder, SettingsInstaller, UserInterface.MainMenu, URP (+4 more)
...
Cohesion: 0.06
Nodes (28): Action, CancellationToken, Component, Container, float, List, Material, materials (+20 more)

### Community 254 - "append_vec3_keys"
Cohesion: 0.67
...
Cohesion: 0.02
Nodes (79): ContainerBuilder, InstantiationBarrier, ChannelDataInstaller, ContainerBuilder, ContainerBuilder, SaveStateInstaller, ContainerBuilder, AllBuildingDataSettingsInstaller (+71 more)

### Community 279 - "ObjectPoolingSettings"
Cohesion: 0.18
...
- **Why does `SaveProcessor` connect `SaveProcessor` to `BuildingProcessor`, `SaveProcessor.cs`, `SettingsProcessor`, `WorldGenProcessor`, `ObjectPoolingProcessor`, `ScriptablesProcessorInfrastructure`, `PlayerProcessor`, `ScriptableObject`, `RoleProcessor`, `SaveFileData`, `ResourceDataSaveData`, `GameEventProcessor`, `TechTreeProcessor`, `TimeProcessor`, `SeasonProcessor`, `DebugProcessor`, `IProcessor`, `StreamTownSessionBridge`, `ResourceProcessor`, `Player`, `MonoBehaviour`, `FoliageProcessor`, `WorldSaveData`, `TownGoalProcessor`, `MainMenuManager`, `WorldGenSaveData`, `Resource`, `.InjectRuntimeData`, `UserInterface_GameMenu`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `WorldGenProcessor` connect `WorldGenProcessor` to `BuildingProcessor`, `TwitchChatProcessor`, `Target`, `ObjectPoolingProcessor`, `.GenerateFromSettings`, `ScriptablesProcessorInfrastructure`, `PlayerProcessor`, `ScriptableObject`, `UserInterface_Debug`, `.Log`, `DebugProcessor`, `IProcessor`, `ResourceProcessor`, `TwitchClientProcessor`, `Access_Dropdown`, `GridProcessor`, `WorldGenRuntimeData`, `Player`, `MonoBehaviour`, `CellSpacePartitioning`, `FoliageProcessor`, `GameEvent`, `WorldInstanceDeterminism`, `EnemySpawner`, `SaveProcessor`, `.InjectRuntimeData`, `AIPath`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `Player` connect `Player` to `SaveProcessor.cs`, `TwitchChatProcessor`, `RoleData`, `ObjectPoolingProcessor`, `Pet`, `BuildingPlacer`, `PlayerProcessor`, `HealthHandler`, `GameEventProcessor`, `UserInterface_Debug`, `CommandDictionary`, `MiscCommands`, `CharacterModelHandler`, `IRuntimeDataScriptable`, `StreamTownSessionBridge`, `SimpleCancelBuildingPlacer`, `Enemy`, `BuildingRuntimeData`, `UserInterface_DisplayUsernames`, `TargetSensor`, `RoleHandler`, `GameEvent`, `SaveProcessor`, `VoteEvent`, `LabelDisplayProcessor`, `.SetTargetType`, `Station`?**
