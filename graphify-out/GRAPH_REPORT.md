...
## Corpus Check
- 629 files · ~1,640,789 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7545 nodes · 20617 edges · 278 communities (259 shown, 19 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 1012 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c6653613`
...
- `AddEquipmentSet()` --references--> `RoleEquipment`  [EXTRACTED]
  Assets/Scripts/Character/CharacterModelHandler.cs → Assets/Scripts/Character/RoleEquipment.cs
...
Cohesion: 0.06
Nodes (56): AnimationNodeIndex, AnimationPlayer, ActivePetVisual, ActorAnimationDriver, advance_animation_crossfade(), animation_event_occurrences(), animation_nodes_for_selection(), animation_selection_duration() (+48 more)
...
### Community 2 - ".default"
Cohesion: 0.05
Nodes (92): App, generate_world(), generate_world_with_content(), agent_facing_matches_unity_rotation_and_action_targets(), archetype_id_by_source(), authored_assignment_penalty_spreads_farmers_across_farms(), authored_color_grading(), authored_enemies_drive_damage_range_cadence_and_weighted_spawning() (+84 more)

### Community 3 - "stream_town_migrate/src/content.rs"
Cohesion: 0.12
Nodes (28): archetype_kind(), asset(), authored_value(), ContentConversionReport, convert(), converts_active_catalog_references_and_round_trips_ron(), converts_building_role_slot_modifiers(), converts_disable_after_time_lifetime() (+20 more)
...
Cohesion: 0.07
Nodes (14): Action, bool, Container, ContainerBuilder, GameObject, IEnumerable, int, IReadOnlyList (+6 more)
...
### Community 11 - "ResMut"
Cohesion: 0.03
Nodes (120): AccumulatedMouseMotion, AccumulatedMouseScroll, AppExit, advance_loading_phase(), AgentCommand, AgentCommandQueue, apply_player_settings(), autosave_game() (+112 more)
...
Cohesion: 0.11
Nodes (30): ArchetypeBounds, AuthoredRecord, AuthoredValue, BuildingModelDef, ContentError, EnemyDef, EnemyModelSetDef, EnemyRunAnimation (+22 more)
...
Cohesion: 0.22
Nodes (15): animator_component(), animator_reference_path(), collect_prefab_dependencies(), convert_prefab_bindings(), convert_prefab_materials(), fixture_asset(), model_has_animation(), prefab_binding_prefers_authored_animator_controller_and_rig() (+7 more)
...
Cohesion: 0.09
Nodes (14): Vector3, List, Dictionary, List, TargetRuntimeData, bool, BoxCollider, float (+6 more)

### Community 26 - "Res"
Cohesion: 0.07
Nodes (140): Added, AnimationGraph, AnimationGraphHandle, AnimationTransitions, Assets, AudioSink, BackgroundColor, ActorNameOverlay (+132 more)
...
Cohesion: 0.02
Nodes (187): AnyResult, active_event_text(), actor_detail_budget(), actor_scene_budget(), ActorHealthFill, ActorHealthOverlay, adjust_settings_menu(), advance_loading_runtime() (+179 more)

### Community 31 - "BuildingSaveData"
Cohesion: 0.33
...
### Community 35 - "STSM_Action_GatherResource"
Cohesion: 0.13
...
Cohesion: 0.04
Nodes (181): GameConfig, GameplayConfig, BTreeMap, BuildingDef, ContentCatalog, PassiveResourceContribution, RoleDef, RoleSlotContribution (+173 more)
...
### Community 52 - "Units"
Cohesion: 0.05
Nodes (18): AttackUnit, CollectResource, HealthModifier, bool, float, GameObject, HealUnit, AddEquipmentSet() (+10 more)
...
Cohesion: 0.08
Nodes (69): AvatarMaskDef, animation_state_id(), animation_state_machine_id(), animation_take_name(), append_vec3_keys(), array_index(), assign_clip_rigs_and_reference_poses(), avatar_mask_id() (+61 more)
...
### Community 61 - "Option"
Cohesion: 0.05
Nodes (141): AmbientLight, AssetServer, ArchetypeDef, ArchetypeKind, ArchetypeScene, PresentationCatalog, ScenePostProcessBinding, actor_material() (+133 more)
...
Cohesion: 0.09
Nodes (19): Container, ContainerBuilder, TimeProcessor, CreditsRuntimeData, IRuntimeDataScriptable, bool, Dictionary, InputButton (+11 more)
...
### Community 85 - "VfxAnimationController"
Cohesion: 0.11
Nodes (9): Api, TL_API, float, Vector3, SimpleRotateOnAxis, bool, float, VisualEffect (+1 more)
...
Cohesion: 0.04
Nodes (34): RoleSlotModifier, int, PlayerRoleData, AudioClip, bool, float, int, RoleData (+26 more)

### Community 91 - "PoolableObject"
Cohesion: 0.06
Nodes (26): Container, ContainerBuilder, GUIDProcessor, BoxCollider, List, Quaternion, Vector3, bool (+18 more)
...
### Community 95 - "String"
Cohesion: 0.12
Nodes (45): AnimationParameterDef, convert_post_process(), infer_missing_parameters(), inline_color(), inline_component(), inline_file_id(), inline_vec2(), parse_blend_tree() (+37 more)
...
Cohesion: 0.07
Nodes (31): Action, CancellationToken, Task, Mesh, Transform, Vector3, int, uint (+23 more)
...
Cohesion: 0.07
Nodes (52): AnimationClipDef, AnimationConditionMode, AnimationEventDef, AnimationFloatKeyframe, AnimationLayerBlendMode, AnimationLayerDef, AnimationMotionDef, AnimationObjectReference (+44 more)
...
Cohesion: 0.11
Nodes (18): HashSet, BoxCollider, Func, HashSet, List, Material, Resource, Vector2 (+10 more)
...
### Community 143 - ".Log"
Cohesion: 0.07
Nodes (14): HideInCallstack, Object, DebugLogCategory, Action, bool, CancellationToken, Container, ContainerBuilder (+6 more)
...
### Community 146 - "UnityAsset"
Cohesion: 0.21
Nodes (39): aged_buildings(), building_cost_reductions(), building_level_caps(), convert_export(), field_value(), foliage_layers(), generated_record_ids(), objective_definitions() (+31 more)
...
### Community 149 - ".GetMissingDataScriptableDependencies"
Cohesion: 0.22
...
Cohesion: 0.12
Nodes (11): int, Vector2, GridSettings, ContainerBuilder, GridSettingsInstaller, Container, ContainerBuilder, GridProcessor (+3 more)
...
### Community 171 - "Utils"
Cohesion: 0.07
Nodes (10): BuildCostModifier, BuildingScriptablesEditor, Utils, Processors, World, Level, Buildings, Audio (+2 more)

### Community 172 - ".StartMusic"
Cohesion: 0.40
...
### Community 184 - "add_rotation_curve"
Cohesion: 0.31
...
Cohesion: 0.08
Nodes (16): Pets.Enumerations, StreamTown.EditorTools, TownGoal, Character.Enumerations, Core, Pets, UserInterface, GameEventSystem (+8 more)

### Community 191 - "VFXArrowPointer"
Cohesion: 0.33
...
### Community 199 - "InventorySaveData"
Cohesion: 0.29
...
### Community 208 - "CampGenerationSettings"
Cohesion: 0.29
...
Cohesion: 0.01
Nodes (112): CellSpacePartitioningInstaller, ContainerBuilder, ContainerBuilder, InstantiationBarrier, ContainerBuilder, MetaDataInstaller, PersistentScoped, Camera (+104 more)
...
### Community 239 - "MeshSaveData"
Cohesion: 0.18
Nodes (7): bool, int, MeshSaveData, float, Vector2SaveData, float, Vector3SaveData

### Community 240 - ".InitializeAndActivateProcessorsAsync"
Cohesion: 0.21
Nodes (4): CancellationToken, Task, Dictionary, ParallelProgressReporter

### Community 243 - "SaveProcessor"
Cohesion: 0.06
Nodes (22): Component, Container, ContainerBuilder, Dictionary, float, List, Material, materialIndex (+14 more)
...
Cohesion: 0.11
Nodes (20): int, List, string, FoliageGroupSaveData, FoliageInstanceSaveData, FoliageProcessorSaveData, bool, float (+12 more)
...
Cohesion: 0.12
Nodes (6): CameraProcessor, InputButton, UserInterface.MainMenu, MetaData, Settings, PlayerControls
...
Cohesion: 0.02
Nodes (81): List, CampGenSettings, List, FoliageGenSettings, bool, ParticleSystem, Transform, GameEventSettings (+73 more)
...
- **Why does `SaveProcessor` connect `SaveProcessor` to `BuildingProcessor`, `WorldGenProcessor`, `TwitchChatProcessor`, `SettingsProcessor`, `.Log`, `UserInterface_GameMenu`, `PlayerProcessor`, `ScriptableObject`, `SaveFileData`, `GameEventProcessor`, `IProcessor`, `SeasonProcessor`, `ResourceProcessor`, `DebugProcessor`, `TechTreeProcessor`, `StreamTownSessionBridge`, `Character`, `IRuntimeDataScriptable`, `MonoBehaviour`, `FoliageProcessor`, `RoleHandler`, `PoolableObject`, `.LoadGameAsync`, `TownGoalProcessor`, `MainMenuManager`, `WorldSaveData`, `MeshSaveData`, `Resource`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `WorldGenProcessor` connect `WorldGenProcessor` to `BuildingProcessor`, `TwitchChatProcessor`, `.Log`, `PlayerProcessor`, `ScriptableObject`, `Player`, `WorldGenRuntimeData`, `UserInterface_Debug`, `IProcessor`, `GridProcessor`, `ResourceProcessor`, `DebugProcessor`, `TwitchClientProcessor`, `ProjectCamera`, `Target`, `CellSpacePartitioning`, `MonoBehaviour`, `FoliageProcessor`, `PoolableObject`, `Enemy`, `EnemySpawner`, `SaveProcessor`, `.StartupSequence`, `.GenerateFromSettings`, `AIPath`, `GameStateProcessor`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `StableId` connect `StableId` to `drive_converted_animations`, `.default`, `stream_town_migrate/src/content.rs`, `ToolState`, `WorldSimulation`, `ResMut`, `stream_town_domain/src/content.rs`, `save.rs`, `UnityAsset`, `UnityAsset`, `Res`, `stream_town_game/src/lib.rs`, `AnimationControllerDef`, `component_field_value`, `stream_town_migrate/src/presentation.rs`, `String`, `Option`, `twitch.rs`, `convert`, `command.rs`, `String`, `stream_town_domain/src/presentation.rs`, `world.rs`?**
