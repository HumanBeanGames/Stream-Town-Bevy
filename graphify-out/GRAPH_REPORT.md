...
## Corpus Check
- 671 files · ~1,810,211 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9323 nodes · 27856 edges · 327 communities (298 shown, 29 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 1056 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9f46dd79`
...
Cohesion: 0.06
Nodes (55): AnimationClip, AnimationTargetId, AnimationTransitionPlayback, add_animation_composition(), add_animation_layer_branch(), add_rotation_curve(), add_scale_curve(), add_translation_curve() (+47 more)
...
### Community 2 - "String"
Cohesion: 0.09
Nodes (60): MaterialDef, PrefabPresentationBinding, TextureDef, animator_component(), animator_reference_path(), array_index(), assign_clip_rigs_and_reference_poses(), collect_prefab_dependencies() (+52 more)

### Community 3 - "SeasonProcessor"
Cohesion: 0.04
Nodes (32): ContainerBuilder, AllSeasonsSettingsInstaller, float, int, Material, AllSeasonSettings, Exception, IMainThreadInitializableProcessor (+24 more)

### Community 4 - "Res"
Cohesion: 0.03
Nodes (297): Added, AmbientLight, AnimatedBy, AnimationGraphHandle, AnimationTransitions, AudioSink, ActivePetVisual, actor_material() (+289 more)

### Community 5 - "stream_town_game/src/lib.rs"
Cohesion: 0.01
Nodes (273): accessibility_motion_preferences_preserve_authored_parameters(), accessibility_scope_keeps_modal_navigation_inside_the_open_surface(), accessibility_tagging_tolerates_ui_removed_before_deferred_annotation(), AccessibilityActionDispatch, AccessibilityCandidate, AccessibilityHighContrastText, action_ranges_and_tower_acquisition_are_euclidean(), actor_detail_budget() (+265 more)
...
Cohesion: 0.07
Nodes (19): Dictionary, DebugSettings, bool, int, Vector2, GridSettings, ContainerBuilder, DebugSettingsInstaller (+11 more)
...
### Community 16 - "String"
Cohesion: 0.03
Nodes (126): AccessibilityNode, AccessibleNode, AccessibilityAnnouncement, AccessibilityRuntime, active_event_text(), advance_loading_phase(), advance_loading_runtime(), advance_world_loading_cover() (+118 more)
...
### Community 18 - ".new"
Cohesion: 0.03
Nodes (210): GameConfig, GameplayConfig, BTreeMap, generate_world(), generate_world_with_content(), GeneratedFoliage, GeneratedResource, GeneratedWorld (+202 more)
...
### Community 23 - "Option"
Cohesion: 0.03
Nodes (140): AssetId, AnimationTransitionOutcome, ArchetypeDef, ArchetypeScene, PresentationCatalog, RulerVoteKind, ActiveMaterialHandles, AnimatedCharacterShadowReceiver (+132 more)
...
Cohesion: 0.09
Nodes (27): authored_trade_rates_clamp_to_stock_gold_and_capacity(), building_damage_and_repair_preserve_health_bounds(), default_ruler_vote_cooldown(), deterministic_fish_god_value(), deterministic_weather(), enemy_camps_and_raid_progress_round_trip_with_stable_archetypes(), fish_god_progress_rewards_food_unlocks_pet_and_expires(), FishGodState (+19 more)
...
Cohesion: 0.04
Nodes (142): AccessibilityActionRequest, AccessibilityFocusVisualQuery, AnyResult, AppExit, accessibility_button_enabled(), accessibility_input(), accessibility_scope_active(), accessibility_settings_selection() (+134 more)
...
### Community 33 - "stream_town_migrate/src/content.rs"
Cohesion: 0.11
Nodes (36): PassiveResourceContribution, asset(), authored_mask(), component(), component_at(), converts_active_catalog_references_and_round_trips_ron(), converts_building_role_slot_modifiers(), converts_disable_after_time_lifetime() (+28 more)
...
### Community 38 - "Handle"
Cohesion: 0.04
Nodes (92): AccessibilityMotionDefaults, authored_main_ui_image_with_ppu(), authored_ui_image(), authored_ui_image_with_corner_scale(), BoundsMaterialExtension, BoundsMaterialUniform, BuildingMaterialExtension, BuildingMaterialUniform (+84 more)

### Community 39 - "SimulationError"
Cohesion: 0.15
...
Cohesion: 0.11
Nodes (5): NodeUnlockData, Action, Container, List, TechTreeProcessor
...
Cohesion: 0.07
Nodes (21): List, Vector3, List, Dictionary, List, TargetRuntimeData, int, STSM_Helper_Build (+13 more)

### Community 44 - "AnimationControllerDef"
Cohesion: 0.11
Nodes (28): AnimationBlendSelection, AnimationControllerRuntime, AnimationParameterValue, AnimationRuntimeError, authored_state_speed_multiplies_float_parameter(), blends_between_authored_thresholds(), consumes_trigger_when_any_state_transition_fires(), controller() (+20 more)
...
Cohesion: 0.03
Nodes (199): ContentCatalog, Display, FromStr, StableId, GridPos, ActorState, BuildingState, EnemyCampState (+191 more)
...
### Community 57 - "TechnologyGraphLayout"
Cohesion: 0.12
...
Cohesion: 0.01
Nodes (117): CameraProcessor, CellSpacePartitioningInstaller, ContainerBuilder, ContainerBuilder, InstantiationBarrier, ContainerBuilder, MetaDataInstaller, ContainerBuilder (+109 more)

### Community 59 - "TechTreeEditorWindow"
Cohesion: 0.11
Nodes (8): TechTreeGraphView, bool, Button, MenuItem, string, TextField, VisualElement, TechTreeEditorWindow

### Community 60 - "ModelPreviewControls"
Cohesion: 0.21
Nodes (14): content_tab(), discover_texture_assets(), draw_building_visual(), draw_model_preview(), import_texture_asset(), ModelPreviewControls, preview_camera_offset(), preview_camera_starts_in_front_and_pans_in_camera_space() (+6 more)

### Community 61 - "stream_town_domain/src/content.rs"
Cohesion: 0.09
Nodes (46): AuthoredRecord, AuthoredValue, BuildingDef, BuildingModelDef, ContentError, default_resource_generation_layers(), EnemyCampGenerationDef, EnemyDef (+38 more)
...
### Community 76 - ".Log"
Cohesion: 0.04
Nodes (45): Container, ContainerBuilder, GUIDProcessor, Action, CancellationToken, Task, IAsyncInitializableProcessor, ProcessorStartupContext (+37 more)
...
Cohesion: 0.18
Nodes (23): WorldGenConfig, algorithmic_generation_matches_unity_validation_fingerprints(), authored_grid_centre(), authored_world_to_grid(), generate_authored_resources(), generate_candidate_mask(), generate_foliage(), generate_shoreline_resources() (+15 more)
...
Cohesion: 0.03
Nodes (41): DepositResources, ResourceStorageModifier, float, int, PlayerInventory, Dictionary, ResourceInventory, bool (+33 more)

### Community 97 - "SaveProcessor"
Cohesion: 0.07
Nodes (24): Action, CancellationToken, Component, Container, ContainerBuilder, float, List, Material (+16 more)

### Community 98 - "component_field_value"
Cohesion: 0.15
Nodes (31): ArchetypesById, ArchetypeBounds, EnemySpawnerDef, WeightedEnemySpawn, archetype_bounds(), archetype_kind(), building_model_definitions(), building_node_age() (+23 more)

### Community 99 - "stream_town_domain/src/presentation.rs"
Cohesion: 0.05
Nodes (78): AnimationClipDef, AnimationConditionMode, AnimationEventDef, AnimationFloatKeyframe, AnimationLayerBlendMode, AnimationLayerDef, AnimationMotionDef, AnimationObjectReference (+70 more)
...
Cohesion: 0.04
Nodes (27): BuildingModelHandler, GameObject, List, BuildingModelHandlerEditor, BuildingPlacerEditor, BuildingResourceModelHandlerEditor, EnemyModelHandlerEditor, RoleScriptablesEditor (+19 more)
...
Cohesion: 0.08
Nodes (14): Container, IProcessor, Container, ContainerBuilder, TargetProcessor, Container, ContainerBuilder, TimeProcessor (+6 more)
...
### Community 107 - "verify_twitch_public_stream"
Cohesion: 0.15
Nodes (12): CadenceTick, DirectTwitchBroadcastPlugin, duration_as_micros(), LiveVerificationTarget, App, Duration, Instant, Plugin (+4 more)

### Community 108 - ".GetPooledObject"
Cohesion: 0.06
...
Cohesion: 0.16
Nodes (5): bool, int, List, EnemyModelHandler, Vector3

### Community 116 - "stream_town_tools/src/main.rs"
Cohesion: 0.06
Nodes (77): apply_building_draft(), apply_preview_node_visibility(), AssetEditorSection, authority_tab(), building_draft(), building_editor_preserves_the_complete_template_record(), BuildingDraft, canonical_preview_node_name() (+69 more)
...
Cohesion: 0.08
Nodes (25): bounded_history_f32(), BroadcastMetricsSnapshot, moderate_selected_operator_user(), Node, Query, Text, With, Without (+17 more)
...
Cohesion: 0.14
Nodes (34): AtomicBool, AudioFrame, AudioInput, BroadcastController, BroadcastMetrics, BroadcastTarget, capture_process_audio(), discard_pending_audio() (+26 more)
...
### Community 133 - "Enemy"
Cohesion: 0.06
Nodes (18): Transform, Action, float, Enemy, float, int, List, Transform (+10 more)
...
Cohesion: 0.11
Nodes (26): BroadcastConfig, BroadcastEncoderPreference, BroadcastEncoder, BroadcastPrerequisites, configured_1080p60_encoder_sustains_realtime_output(), copy_packed_video_frame(), encoder_candidates(), encoder_input_format() (+18 more)
...
Cohesion: 0.12
Nodes (14): Color, Foldout, List, Sprite, VisualElement, TechTreeNode, Port, ObjectiveSaveData (+6 more)
...
### Community 153 - "GlobalAudioController"
Cohesion: 0.19
...
Cohesion: 0.15
Nodes (26): color_value(), convert_post_process(), extracts_indexed_material_properties(), field_array(), field_bool(), field_f32(), field_str(), field_u64() (+18 more)
...
Cohesion: 0.10
Nodes (14): BuildingResourceModelHandler, GameObject, UnityEvent, EnemyType, Foliage, FoliageSaveType, FoliageType, PLayerActivityStatus (+6 more)
...
### Community 173 - "GameEventProcessor"
Cohesion: 0.11
...
### Community 177 - "world.rs"
Cohesion: 0.14
Nodes (20): authored_foliage_is_deterministic_and_respects_habitat_and_resources(), avalanche_instance_hash(), changing_seed_changes_world_hash(), fnv_mix(), foliage_visual_variant(), foliage_visual_yaw_milliradians(), generated_instance_counts_match_the_sanitized_unity_save_oracle(), generated_resources_preserve_unity_target_types_and_reachable_fish() (+12 more)
...
Cohesion: 0.06
Nodes (100): animation_state_id(), animation_state_machine_id(), animation_take_name(), append_vec3_keys(), avatar_mask_id(), clip_id(), controller_id(), convert_chimney_smoke() (+92 more)
...
Cohesion: 0.13
Nodes (21): animation_parameter_name(), archetype_scenes(), building_placements(), BuildingPlacement, child_technology_guids(), collect_model_dependencies(), ContentConversionReport, convert() (+13 more)
...
Cohesion: 0.05
Nodes (15): PersistentScoped, Transform, PlayerSpawnPoint, float, GameObject, SimpleDisableAfterTime, GameObject, SimpleRandomModelEnabled (+7 more)

### Community 195 - "Character"
Cohesion: 0.06
Nodes (19): TownGoal.Data, Pets.Enumerations, StreamTown.EditorTools, TownGoal, Character.Enumerations, Core, Pets, UserInterface (+11 more)
...
### Community 213 - "stream_town_domain/src/lib.rs"
Cohesion: 0.17
...
### Community 262 - "hash_world"
Cohesion: 0.23
Nodes (14): cell_hash(), foliage_horizontal_hash(), hash_world(), horizontal_hash(), legacy_resource_navigation(), legacy_v1_world_hash(), legacy_v2_world_hash(), legacy_v3_world_hash() (+6 more)
...
Cohesion: 0.09
Nodes (45): apply_preview_material_overrides(), drive_model_preview_animation(), frame_model_preview(), ModelPreviewCamera, ModelPreviewRuntime, player_preview_material_overrides(), preview_material_overrides(), preview_material_resolution_matches_runtime_binding_precedence() (+37 more)
...
### Community 287 - "Utils"
Cohesion: 0.04
Nodes (12): BuildCostModifier, InputButton, UserInterface.MainMenu, Utils, Processors, World, Level, Buildings (+4 more)
...
### Community 292 - "BuildingDamageMaterialHandler"
Cohesion: 0.29
...
### Community 311 - "OpenNode"
Cohesion: 0.43
Nodes (5): OpenNode, Self, Ord, Ordering, PartialOrd

### Community 312 - "PlayerInputRuntimeData"
Cohesion: 0.33
...
- **Why does `Utils` connect `Utils` to `Enemy`, `TechTree.Elements`, `Sensors`, `StringUtils`, `.CreateEnumField`, `Node_SO.cs`, `GenerationSettings`, `CommonEnums.cs`, `UpdateGraphBounds`, `Target`, `ScriptablesProcessorInfrastructure`, `MonoBehaviour`, `SimpleDisableAfterTime`, `Character`, `BuildingPlacer`, `Easings`, `SnapToGridMouseMovement`, `FPSDisplay`, `Editor`, `.GetPooledObject`, `RandomEnabler`, `World.Generation`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `StableId` connect `StableId` to `build_converted_animation`, `String`, `Res`, `stream_town_game/src/lib.rs`, `config.rs`, `String`, `save.rs`, `.new`, `command.rs`, `twitch.rs`, `Option`, `simulation.rs`, `Option`, `stream_town_migrate/src/content.rs`, `SimulationError`, `ToolState`, `AnimationControllerDef`, `legacy.rs`, `world.rs`, `stream_town_migrate/src/presentation.rs`, `TechnologyGraphLayout`, `stream_town_domain/src/content.rs`, `ObjectiveDef`, `stream_town_migrate/src/menu_scene.rs`, `UnityAsset`, `runtime_console.rs`, `technology_graph.rs`, `stream_town_domain/src/lib.rs`, `String`, `component_field_value`, `stream_town_domain/src/presentation.rs`, `stream_town_tools/src/main.rs`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `PlayerProcessor` connect `PlayerProcessor` to `PlayerRoleData`, `BuildingProcessor`, `Enemy`, `TwitchChatProcessor`, `BottomBarInterface`, `RoleHandler`, `UserInterface_Debug`, `SelectedPlayer`, `WorldGenProcessor`, `TechTreeProcessor`, `SelectedPlayerGroup`, `Target`, `GameEventProcessor`, `Player`, `StreamTownSessionBridge`, `NewKingVote`, `UIProcessor`, `TwitchClientProcessor`, `MonoBehaviour`, `.Log`, `UserInterface_TownVote`, `BuildingPlacer`, `RaidEvent`, `Resource`, `SaveProcessor`, `IProcessor`, `GameEvent`?**
