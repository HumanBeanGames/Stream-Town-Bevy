...
## Corpus Check
- 603 files · ~1,541,222 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6254 nodes · 14991 edges · 272 communities (240 shown, 32 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 987 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c132ece0`
...
Cohesion: 0.06
Nodes (16): Dictionary, BuildingDataContainer, int, ResourceCostData, bool, float, Sprite, string (+8 more)

### Community 2 - "ScriptableObject"
Cohesion: 0.04
Nodes (57): List, CampGenSettings, List, FoliageGenSettings, bool, ParticleSystem, Transform, GameEventSettings (+49 more)
...
Cohesion: 0.07
Nodes (77): App, AppExit, AssetServer, actor_material(), Agent, AgentAnimation, animate_agents(), animate_weather_particles() (+69 more)

### Community 5 - ".SendMessage"
Cohesion: 0.10
Nodes (4): BuildingCommands, TwitchClientProcessor, PlayerCommands, RoleCommands
...
### Community 13 - "SavingAndLoading.Structs"
Cohesion: 0.11
...
### Community 15 - "retargeted_animation_clip"
Cohesion: 0.24
...
### Community 16 - "ResourceInventory"
Cohesion: 0.12
Nodes (11): ResourceInventory, bool, int, float, int, Queue, ResourceRateOfChange, Dictionary (+3 more)
...
### Community 31 - "PlayerSaveData"
Cohesion: 0.08
Nodes (20): int, List, string, uint, BuildingSaveData, int, string, uint (+12 more)
...
Cohesion: 0.13
Nodes (12): Action, CancellationToken, Container, ContainerBuilder, float, List, Task, SaveProcessor (+4 more)
...
### Community 47 - "InventorySaveData"
Cohesion: 0.25
...
Cohesion: 0.05
Nodes (24): bool, double, float, Func, int, IReadOnlyList, List, long (+16 more)
...
Cohesion: 0.11
Nodes (35): FromStr, StableId, ActorState, BuildingState, capped_deposit_preserves_inventory_overflow(), complete_gameplay_scenario_round_trips(), deterministic_weather(), id() (+27 more)
...
### Community 85 - "Target"
Cohesion: 0.11
Nodes (8): Units, Target, Utils.Pooling, Sensors, GridSystem.Partitioning, Combat, SavingAndLoading.SavableObjects, GUIDSystem

### Community 86 - "ResourceData"
Cohesion: 0.21
...
Cohesion: 0.09
Nodes (11): Component, Dictionary, materialIndex, meshIndex, Dictionary, Mesh, Transform, Vector3 (+3 more)
...
Cohesion: 0.10
Nodes (78): ArchetypesById, aged_buildings(), archetype_bounds(), archetype_kind(), archetype_scenes(), asset(), authored_value(), building_cost_reductions() (+70 more)
...
Cohesion: 0.07
Nodes (56): animation_root_name(), broadcaster_gate_precedes_twitch_command_dispatch(), building_is_unlocked(), CommandFeedback, converted_animation_spec(), converted_technology_modifiers_change_runtime_rules(), ConvertedAnimationSpec, debug_start_day() (+48 more)
...
Cohesion: 0.09
Nodes (7): Player, Dictionary, GameObject, Vector3, Vector3, GameMasterCommands, RulerCommands
...
### Community 117 - "ObjectPoolingProcessor"
Cohesion: 0.07
Nodes (25): bool, List, ObjectPoolingSettings, Action, bool, CancellationToken, Container, ContainerBuilder (+17 more)
...
Cohesion: 0.06
Nodes (17): DepositResources, PlayerInventory, Dictionary, int, ActiveResourceIncrementer, IResourceHolder, Container, ContainerBuilder (+9 more)

### Community 120 - "BuildPlacerData"
Cohesion: 0.22
...
Cohesion: 0.07
Nodes (16): Container, ContainerBuilder, GUIDProcessor, BoxCollider, List, Quaternion, Vector3, bool (+8 more)
...
### Community 131 - "BuildingProcessor"
Cohesion: 0.09
Nodes (9): bool, Dictionary, int, BuildingSettings, Container, ContainerBuilder, Dictionary, List (+1 more)
...
### Community 135 - "Utils"
Cohesion: 0.07
Nodes (7): STStateMachine.States, Utils, Behaviours, Animation, STStateMachine, Pathfinding, STStateMachine.Helpers
...
### Community 137 - "DayAndNightSettings"
Cohesion: 0.33
...
### Community 143 - "WorldGenSaveData"
Cohesion: 0.09
...
### Community 147 - "load_runtime_config"
Cohesion: 0.50
...
### Community 164 - ".DrawDataFieldAndLabel"
Cohesion: 0.28
...
Cohesion: 0.13
Nodes (8): Container, ContainerBuilder, TimeProcessor, int, TimeSettings, float, int, TimeRuntimeData
...
### Community 177 - "GridPos"
Cohesion: 0.09
Nodes (48): ConfigError, default_configuration_is_valid_and_round_trips_ron(), enabled_twitch_requires_public_configuration(), GameConfig, GameplayConfig, BTreeMap, Default, Result (+40 more)
...
Cohesion: 0.10
Nodes (15): List, Vector3, Container, ContainerBuilder, List, TargetProcessor, Dictionary, List (+7 more)
...
Cohesion: 0.09
Nodes (44): AmbientLight, AnimationGraph, AnimationGraphHandle, AnimationNodeIndex, AnimationPlayer, Assets, ActorAnimationDriver, animation_nodes_for_selection() (+36 more)
...
### Community 263 - "STSM_StateAction"
Cohesion: 0.15
Nodes (8): RotationHandler, float, Quaternion, Vector3, bool, float, int, STSM_StateAction

### Community 264 - "MonoBehaviour"
Cohesion: 0.02
Nodes (82): CameraProcessor, CellSpacePartitioningInstaller, ContainerBuilder, ContainerBuilder, MetaDataInstaller, ContainerBuilder, AllBuildingDataSettingsInstaller, ContainerBuilder (+74 more)

### Community 268 - "Buildings"
Cohesion: 0.07
Nodes (6): BuildCostModifier, PlayerControls.ObjectSelection, Level, Buildings, Enemies, GameResources
...
### Community 294 - "STSM_Idle_Player"
Cohesion: 0.06
...
- `RenderAssets` (2× useful, score=1.993795858) _(code changed — re-verify)_

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `SaveProcessor` connect `SaveProcessor` to `ScriptableObject`, `BuildingProcessor`, `DebugProcessor`, `MonoBehaviour`, `SettingsProcessor`, `WorldGenProcessor`, `Character`, `PlayerProcessor`, `SaveFileData`, `GameEventProcessor`, `PlayerSaveData`, `TechTreeProcessor`, `TimeProcessor`, `SeasonProcessor`, `ResourceProcessor`, `UIProcessor`, `.SaveGameAsync`, `IProcessor`, `PlayerRole`, `FoliageProcessor`, `SaveDataMapper`, `FoliageGenerationSettings`, `MainMenuManager`, `TownGoalProcessor`, `ObjectPoolingProcessor`, `Resource`, `UserInterface_GameMenu`, `PoolableObject`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `WorldGenProcessor` connect `WorldGenProcessor` to `ScriptableObject`, `BuildingProcessor`, `DebugProcessor`, `TwitchChatProcessor`, `MonoBehaviour`, `.GenerateFromSettings`, `PlayerProcessor`, `CellSpacePartitioning`, `UserInterface_Debug`, `SaveProcessor`, `GameStateProcessor`, `ResourceProcessor`, `TwitchClientProcessor`, `ProjectCamera`, `WorldGenRuntimeData`, `AIPath`, `RaidEvent`, `IProcessor`, `GridProcessor`, `Target`, `FoliageProcessor`, `SaveDataMapper`, `Player`, `DayAndNightProcessor`, `ObjectPoolingProcessor`, `PoolableObject`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `SettingsProcessor` connect `SettingsProcessor` to `ScriptablesProcessorInfrastructure`, `GraphicsProcessor`, `Access_Slider`, `IProcessor`, `SettingsData`, `SaveProcessor`, `MainMenuManager`, `MonoBehaviour`, `Access_Dropdown`, `Access_Toggle`, `UIElementWrapper`, `Access_Text`, `ProjectCamera`, `Autosave`, `UserInterface_GameMenu`?**
