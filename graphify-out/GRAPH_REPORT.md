...
## Corpus Check
- 607 files · ~1,587,011 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6768 nodes · 17403 edges · 294 communities (264 shown, 30 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 993 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f18ff5f1`
...
Cohesion: 0.06
Nodes (20): CameraProcessor, PersistentScoped, ContainerBuilder, AudioSettingsInstaller, Slider, TextMeshProUGUI, UI_Objective, TextMeshProUGUI (+12 more)
...
Cohesion: 0.15
Nodes (26): ArchetypeBounds, AuthoredRecord, AuthoredValue, BuildingDef, ContentError, EnemyDef, EnemySpawnerDef, HealthDef (+18 more)
...
Cohesion: 0.02
Nodes (154): AnimationClip, AnimationGraph, AnimationNodeIndex, AnimationPlayer, AnimationTargetId, AnyResult, active_event_text(), ActivePetVisual (+146 more)
...
Cohesion: 0.10
Nodes (12): Pets.Enumerations, TownGoal, Character.Enumerations, Core, Pets, GameEventSystem, GameEventSystem.Events, SavingAndLoading (+4 more)
...
Cohesion: 0.09
Nodes (49): BackgroundColor, ActionPresentation, actor_combat_visual(), actor_material(), building_effect_material(), BuildingEffectKind, BuildingEffectParticle, BuildingPlacement (+41 more)

### Community 19 - "FoliageGroupSaveData"
Cohesion: 0.32
Nodes (6): int, List, string, FoliageGroupSaveData, FoliageInstanceSaveData, FoliageProcessorSaveData

### Community 20 - "Targetable"
Cohesion: 0.07
Nodes (24): List, Vector3, TargetSettings, Container, ContainerBuilder, List, TargetProcessor, Dictionary (+16 more)
...
### Community 26 - "TerrainGenSettings"
Cohesion: 0.22
...
### Community 30 - "FoliageGenerationSettings.cs"
Cohesion: 0.50
...
### Community 32 - "Buildings"
Cohesion: 0.07
Nodes (11): BuildCostModifier, PlayerControls.ObjectSelection, Units, Target, Utils.Pooling, Level, Buildings, Combat (+3 more)
...
Cohesion: 0.05
Nodes (97): ConfigError, default_configuration_is_valid_and_round_trips_ron(), enabled_twitch_requires_public_configuration(), GameConfig, GameplayConfig, BTreeMap, Default, Result (+89 more)
...
Cohesion: 0.05
Nodes (78): ObjectiveDef, ObjectiveKind, FromStr, StableId, ActorState, authored_trade_rates_clamp_to_stock_gold_and_capacity(), building_damage_and_repair_preserve_health_bounds(), BuildingState (+70 more)
...
### Community 76 - ".Log"
Cohesion: 0.11
Nodes (5): Action, Action, HideInCallstack, Object, ResourceData[]&gt;
...
### Community 90 - "Option"
Cohesion: 0.09
Nodes (67): App, AssetServer, ArchetypeDef, ArchetypeKind, ArchetypeScene, PresentationCatalog, actor_detail_budget(), actor_scene_budget() (+59 more)
...
Cohesion: 0.08
Nodes (10): LoadType, MetaData, Button, GameObject, IEnumerator, int, MainMenuManager, GameObject (+2 more)

### Community 103 - "TownGoalProcessor"
Cohesion: 0.19
Nodes (6): Container, ContainerBuilder, Goal, List, Objective, TownGoalProcessor

### Community 104 - "BinaryReader"
Cohesion: 0.17
...
Cohesion: 0.06
Nodes (117): Added, AmbientLight, AnimationGraphHandle, AppExit, Assets, ActorAnimationDriver, Agent, agent_is_moving() (+109 more)
...
Cohesion: 0.08
Nodes (20): Component, Dictionary, List, Mesh, Transform, Vector3, SaveDataMapper, List (+12 more)
...
### Community 167 - "SelectableObject"
Cohesion: 0.14
...
### Community 169 - "UserInterface_Resources"
Cohesion: 0.21
...
### Community 189 - "PlayerRole"
Cohesion: 0.09
Nodes (14): RoleData, AudioClip, bool, float, int, Sprite, string, bool (+6 more)
...
### Community 193 - "Utils"
Cohesion: 0.06
Nodes (9): STStateMachine.States, Utils, Behaviours, Animation, Sensors, GridSystem.Partitioning, STStateMachine, Pathfinding (+1 more)
...
### Community 199 - "TownResourceRuntimeData"
Cohesion: 0.18
...
### Community 217 - "GameEventRuntimeData"
Cohesion: 0.25
...
### Community 221 - ".DrawDataFieldAndLabel"
Cohesion: 0.28
...
### Community 231 - "ResourceDataSettings"
Cohesion: 0.25
...
### Community 235 - "GameEventSettings"
Cohesion: 0.25
...
### Community 239 - "ObjectPoolingSettings"
Cohesion: 0.25
...
### Community 264 - "TownGoalSettings"
Cohesion: 0.33
...
### Community 273 - "PlayerRuntimeData"
Cohesion: 0.47
...
### Community 279 - "PostProcessingInstaller"
Cohesion: 0.40
Nodes (3): ContainerBuilder, Volume, PostProcessingInstaller

### Community 280 - "ScriptableObject"
Cohesion: 0.04
Nodes (43): ContainerBuilder, BuildingConfigSettingsInstaller, ContainerBuilder, FoliageGenSettingsInstaller, ContainerBuilder, GameEventConfigSettingsInstaller, ContainerBuilder, TimeDataSettingsInstaller (+35 more)

### Community 281 - "Q: role level experience progression station equipment inventory skill upgrade"
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: role level experience progression station equipment inventory skill upgrade, Source Nodes

### Community 282 - "AudioMixerInstaller"
Cohesion: 0.40
...
### Community 285 - "SavingAndLoading.Structs"
Cohesion: 0.04
Nodes (37): int, List, string, uint, BuildingSaveData, int, uint, EnemyCampSaveData (+29 more)
...
- **Why does `SaveProcessor` connect `SaveProcessor` to `MonoBehaviour`, `IProcessor`, `BuildingProcessor`, `SettingsProcessor`, `GUIDProcessor`, `WorldGenProcessor`, `Player`, `RoleProcessor`, `PlayerSaveData`, `Character`, `FoliageGroupSaveData`, `PlayerProcessor`, `ScriptableObject`, `ResourceDataSaveData`, `SavingAndLoading.Structs`, `GameEventProcessor`, `SaveFileData`, `ResourceGenerationSettings`, `ObjectPoolingProcessor`, `TechTreeProcessor`, `TimeProcessor`, `IInstaller`, `SeasonProcessor`, `StreamTownSessionBridge`, `ResourceProcessor`, `FoliageProcessor`, `MainMenuManager`, `TownGoalProcessor`, `Resource`, `DebugProcessor`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `WorldGenProcessor` connect `WorldGenProcessor` to `MonoBehaviour`, `IProcessor`, `BuildingProcessor`, `WorldGenScaleSettings`, `TwitchChatProcessor`, `GUIDProcessor`, `Player`, `PlayerSaveData`, `PlayerProcessor`, `ScriptableObject`, `TerrainGenSettings`, `CampGenerationSettings`, `Buildings`, `UserInterface_Debug`, `ResourceGenerationSettings`, `ObjectPoolingProcessor`, `IInstaller`, `ResourceProcessor`, `TwitchClientProcessor`, `ProjectCamera`, `WorldGenRuntimeData`, `GameEvent`, `GameStateProcessor`, `.Log`, `GridProcessor`, `CellSpacePartitioning`, `FoliageProcessor`, `.StartupSequence`, `EnemySpawner`, `SaveProcessor`, `WorldGenDebugSettings`, `DebugProcessor`, `WorldGenBehaviorSettings`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `SettingsProcessor` connect `SettingsProcessor` to `Autosave`, `GraphicsProcessor`, `IProcessor`, `Access_Slider`, `Access_GOList`, `SettingsData`, `MainMenuManager`, `MonoBehaviour`, `IInstaller`, `Access_Dropdown`, `SaveProcessor`, `ScriptablesProcessorInfrastructure`, `Access_Text`, `ProjectCamera`, `Access_TextInput`, `Access_Toggle`?**
