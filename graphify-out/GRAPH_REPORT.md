...
## Corpus Check
- 607 files · ~1,593,394 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6826 nodes · 17731 edges · 264 communities (238 shown, 26 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 993 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a1d0c1a2`
...
Cohesion: 0.03
Nodes (147): AnimationNodeIndex, AnimationPlayer, AnyResult, BackgroundColor, ActionPresentation, active_event_text(), ActivePetVisual, ActorAnimationDriver (+139 more)
...
### Community 12 - "Player"
Cohesion: 0.07
Nodes (11): Player, Dictionary, GameObject, Vector3, Vector3, BuildingCommands, OnChatCommandReceivedArgs, TwitchClientProcessor (+3 more)
...
### Community 19 - "GameMasterCommands"
Cohesion: 0.11
...
Cohesion: 0.07
Nodes (65): WorldGenConfig, GridPos, authored_foliage_is_deterministic_and_respects_habitat_and_resources(), cell_hash(), changing_seed_changes_world_hash(), foliage_hash(), foliage_noise(), generate_foliage() (+57 more)
...
Cohesion: 0.05
Nodes (29): Container, ContainerBuilder, GUIDProcessor, bool, BoxCollider, Container, ContainerBuilder, float (+21 more)
...
Cohesion: 0.09
Nodes (11): Action, CancellationToken, Func, int, List, UTF8Encoding, BinarySaveCodec, List (+3 more)
...
### Community 47 - ".Log"
Cohesion: 0.06
Nodes (20): Action, Container, ContainerBuilder, HideInCallstack, Object, DebugLogCategory, DebugProcessor, Action (+12 more)
...
Cohesion: 0.15
Nodes (3): RoleSlotModifier, int, PlayerRole

### Community 57 - "StableId"
Cohesion: 0.04
Nodes (113): GameplayConfig, BTreeMap, ContentCatalog, ObjectiveDef, ObjectiveKind, RoleDef, FromStr, StableId (+105 more)
...
### Community 67 - "retargeted_animation_clip"
Cohesion: 0.20
...
### Community 85 - "Option"
Cohesion: 0.07
Nodes (38): actor_detail_budget(), actor_scene_budget(), animation_root_name(), BuildingMaterialExtension, BuildingMaterialUniform, CloudMaterialExtension, CloudMaterialUniform, debug_building_health() (+30 more)
...
Cohesion: 0.07
Nodes (132): App, AppExit, AssetServer, GameConfig, Default, PresentationCatalog, actor_material(), Agent (+124 more)
...
Cohesion: 0.04
Nodes (27): DepositResources, ResourceStorageModifier, float, int, PlayerInventory, Dictionary, Dictionary, float (+19 more)
...
### Community 121 - "Query"
Cohesion: 0.06
Nodes (76): Added, AmbientLight, AnimationGraph, AnimationGraphHandle, Assets, add_animation_layer_branch(), AgentEquipmentPresentation, animate_combat_effects() (+68 more)
...
### Community 133 - "CreditsProcessor"
Cohesion: 0.22
...
### Community 176 - "Enemy"
Cohesion: 0.21
Nodes (5): Action, float, Enemy, SaveableEnemy, EnemyType
...
### Community 188 - "ObjectPoolingSettings"
Cohesion: 0.25
...
### Community 203 - "ObjectiveSaveData"
Cohesion: 0.50
...
Cohesion: 0.08
Nodes (10): PersistentScoped, Transform, PlayerSpawnPoint, float, Vector3, SimpleRotateOnAxis, bool, float (+2 more)
...
Cohesion: 0.02
Nodes (87): CameraProcessor, CellSpacePartitioningInstaller, ContainerBuilder, ContainerBuilder, InstantiationBarrier, ContainerBuilder, MetaDataInstaller, ContainerBuilder (+79 more)

### Community 280 - "ScriptableObject"
Cohesion: 0.04
Nodes (51): float, Material, Volume, DayAndNightSettings, bool, ParticleSystem, Transform, GameEventSettings (+43 more)
...
- **Why does `SaveProcessor` connect `SaveProcessor` to `BuildingProcessor`, `SettingsProcessor`, `WorldGenProcessor`, `RoleProcessor`, `SaveProcessor.cs`, `GameMasterCommands`, `PlayerProcessor`, `MonoBehaviour`, `ResourceGenerationSettings`, `ResourceDataSaveData`, `GameEventProcessor`, `SaveFileData`, `FoliageGenerationSettings`, `ObjectPoolingProcessor`, `TechTreeProcessor`, `TimeProcessor`, `SeasonProcessor`, `.Log`, `IProcessor`, `StreamTownSessionBridge`, `ResourceProcessor`, `UserInterface_GameMenu`, `WorldGenSaveData`, `FoliageProcessor`, `WorldSaveData`, `TownGoalProcessor`, `MainMenuManager`, `Resource`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `WorldGenProcessor` connect `WorldGenProcessor` to `BuildingProcessor`, `.GenerateFromSettings`, `Buildings`, `TwitchChatProcessor`, `GameStateProcessor`, `GameMasterCommands`, `PlayerProcessor`, `ScriptableObject`, `ResourceGenerationSettings`, `MonoBehaviour`, `UserInterface_Debug`, `FoliageGenerationSettings`, `ObjectPoolingProcessor`, `.Log`, `IProcessor`, `ResourceProcessor`, `TwitchClientProcessor`, `WorldGenRuntimeData`, `CampGenerationSettings`, `GenerationSettings`, `ProjectCamera`, `CellSpacePartitioning`, `FoliageProcessor`, `RaidEvent`, `Coordinator`, `GridProcessor`, `EnemySpawner`, `SaveProcessor`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `SettingsProcessor` connect `SettingsProcessor` to `Access_Slider`, `GraphicsProcessor`, `Access_Dropdown`, `SettingsData`, `Access_GOList`, `MainMenuManager`, `ProjectCamera`, `IProcessor`, `SaveProcessor`, `ScriptablesProcessorInfrastructure`, `Access_Text`, `MonoBehaviour`, `UserInterface_GameMenu`, `Autosave`, `UIElementWrapper`?**
