...
## Corpus Check
- 672 files · ~1,830,256 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9556 nodes · 29106 edges · 301 communities (279 shown, 22 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 1063 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `658b01a0`
...
Cohesion: 0.04
Nodes (82): AmbientLight, ActiveMaterialHandles, authored_post_process_stack(), authored_rgb_filter(), blend_environment_palette(), building_damage_intensity(), building_damage_value(), building_snow_strength() (+74 more)
...
### Community 2 - "String"
Cohesion: 0.09
Nodes (63): animator_component(), animator_reference_path(), array_index(), assign_clip_rigs_and_reference_poses(), collect_prefab_dependencies(), convert(), convert_avatar_masks(), convert_controllers() (+55 more)
...
### Community 4 - "ResMut"
Cohesion: 0.03
Nodes (184): AccessibilityActionRequest, AccessibilityFocusVisualQuery, AnyResult, accessibility_button_enabled(), accessibility_input(), accessibility_scope_active(), accessibility_should_clear_focus(), AccessibilityAnnouncement (+176 more)

### Community 5 - "stream_town_game/src/lib.rs"
Cohesion: 0.01
Nodes (434): AccessibleNode, AnimationClip, AnimationTargetId, PlayerSettings, Default, accessibility_motion_preferences_preserve_authored_parameters(), accessibility_scope_keeps_modal_navigation_inside_the_open_surface(), accessibility_settings_selection() (+426 more)
...
### Community 7 - "GridPos"
Cohesion: 0.07
Nodes (102): GameConfig, DirtyRegion, GridPos, GeneratedWorld, ActionPresentation, active_resource_at(), active_station_ids(), actor_idle_anchor() (+94 more)
...
### Community 11 - "TownResourceProcessor"
Cohesion: 0.05
Nodes (16): DepositResources, Container, ContainerBuilder, Dictionary, TownResourceProcessor, Container, ContainerBuilder, TradeProcessor (+8 more)
...
### Community 16 - "TownGoal.Data"
Cohesion: 0.09
Nodes (8): InputButton, SharedTypes, TownGoal.Data, StreamTown.EditorTools, TechTree.Data, TechTree.ScriptableObjects, Data, GameEventSystem.Events.Voting
...
### Community 18 - ".new"
Cohesion: 0.03
Nodes (196): ArchetypeKind, generate_world(), generate_world_with_content(), accessibility_navigation_preserves_editable_text_focus(), agent_facing_matches_unity_rotation_and_action_targets(), animated_pets_resolve_their_own_unity_controllers_and_rigs(), archetype_by_source(), archetype_id_by_source() (+188 more)
...
Cohesion: 0.09
Nodes (13): Vector3, List, Dictionary, List, TargetRuntimeData, bool, BoxCollider, float (+5 more)

### Community 23 - "ContentCatalog"
Cohesion: 0.07
Nodes (75): ContentCatalog, StationUpdateMode, ActorState, RoleProgress, Default, String, action_animation_speed(), action_cooldown() (+67 more)
...
### Community 25 - "Option"
Cohesion: 0.05
Nodes (175): ArchetypeBounds, ArchetypeDef, ArchetypeScene, HealthDef, RotatingNodeDef, Option, actor_material(), advance_falling_fish() (+167 more)
...
### Community 30 - "Res"
Cohesion: 0.03
Nodes (227): Added, AnimatedBy, AnimationGraphHandle, AnimationTransitions, AudioSink, ActivePetVisual, ActorAnimationDriver, ActorNameOverlay (+219 more)
...
### Community 38 - "Handle"
Cohesion: 0.04
Nodes (97): AccessibilityMotionDefaults, authored_main_ui_image_with_ppu(), authored_ui_image(), authored_ui_image_with_corner_scale(), BoundsMaterialExtension, BoundsMaterialUniform, BuildingMaterialExtension, BuildingMaterialUniform (+89 more)
...
Cohesion: 0.13
Nodes (4): STSM_Action_GatherResource, STSM_Action_Heal, STSM_Action_PlayerAttack, STSM_Action_PlayerBase
...
Cohesion: 0.02
Nodes (85): List, CampGenSettings, float, Material, Volume, DayAndNightSettings, List, FoliageGenSettings (+77 more)
...
Cohesion: 0.05
Nodes (97): GameplayConfig, BTreeMap, AuthoredRecord, AuthoredValue, BuildingDef, BuildingModelDef, ContentError, default_resource_generation_layers() (+89 more)
...
Cohesion: 0.06
Nodes (99): animation_state_id(), animation_state_machine_id(), animation_take_name(), append_vec3_keys(), avatar_mask_id(), color_value(), controller_id(), convert_chimney_smoke() (+91 more)
...
Cohesion: 0.05
Nodes (58): ObjectiveDef, ObjectiveKind, authored_trade_rates_clamp_to_stock_gold_and_capacity(), building_damage_and_repair_preserve_health_bounds(), building_upgrade_reenters_the_full_construction_phase(), BuildingState, capped_deposit_preserves_inventory_overflow(), complete_gameplay_scenario_round_trips() (+50 more)
...
Cohesion: 0.09
Nodes (16): SimpleToggleCarry, CharacterModelHandler, bool, int, List, Transform, RoleEquipment, bool (+8 more)
...
### Community 83 - "String"
Cohesion: 0.13
Nodes (15): AuthorizationEvent, DirectTwitchBroadcastPlugin, format_minutes_seconds(), LiveVerification, LiveVerificationEvent, LiveVerificationTarget, PreparedBroadcast, App (+7 more)
...
Cohesion: 0.09
Nodes (19): TargetSettings, Container, ContainerBuilder, TargetProcessor, TargetableData, Dictionary, List, Foliage (+11 more)
...
### Community 92 - ".Log"
Cohesion: 0.04
Nodes (32): Container, ContainerBuilder, HideInCallstack, Object, DebugProcessor, Container, ContainerBuilder, GameStateProcessor (+24 more)

### Community 93 - "MonoBehaviour"
Cohesion: 0.01
Nodes (122): CellSpacePartitioningInstaller, ContainerBuilder, ContainerBuilder, InstantiationBarrier, ContainerBuilder, MetaDataInstaller, ContainerBuilder, Volume (+114 more)
...
Cohesion: 0.10
Nodes (21): camera_targets_primary_window(), NativeGameAudioMix, NativeGameAudioRouting, NativeGameAudioVoice, Assets, Default, Entity, Handle (+13 more)

### Community 96 - "Resource"
Cohesion: 0.04
Nodes (30): BuildingResourceModelHandler, GameObject, ResourceStorageModifier, float, int, PlayerInventory, Dictionary, ResourceInventory (+22 more)

### Community 97 - "SaveProcessor"
Cohesion: 0.06
Nodes (33): Action, CancellationToken, Component, Container, ContainerBuilder, float, List, Task (+25 more)
...
Cohesion: 0.05
Nodes (90): AnimationClipDef, AnimationConditionMode, AnimationEventDef, AnimationFloatKeyframe, AnimationLayerBlendMode, AnimationLayerDef, AnimationMotionDef, AnimationObjectReference (+82 more)
...
Cohesion: 0.10
Nodes (27): bounded_history_f32(), BroadcastMetricsSnapshot, cleanup_completed_stream_only_readbacks(), disarm_stream_only_readbacks(), operator_restart_button_requests_a_stream_restart(), BackgroundColor, Commands, Node (+19 more)
...
Cohesion: 0.08
Nodes (30): gpu_readbacks_are_published_in_render_order_even_when_they_finish_out_of_order(), moderate_selected_operator_user(), NativeGameAudioClip, NativeGameAudioState, operator_chat_scroll_rows(), pcm16_wav_clip(), pcm16_wav_data(), BTreeMap (+22 more)
...
Cohesion: 0.06
Nodes (41): append_direct_broadcast_diagnostic_to(), average_milliseconds(), bandwidth_test_url_is_constructed_without_logging_the_key(), build_ingest_url(), configure_direct_broadcast(), direct_broadcast_diagnostics_are_persisted_without_a_live_session(), DirectBroadcastPhase, DirectBroadcastSnapshot (+33 more)
...
### Community 132 - "IRuntimeDataScriptable"
Cohesion: 0.11
Nodes (24): Queue, AudioRuntimeData, CreditsRuntimeData, UnityEvent, DebugRuntimeData, bool, GameStateRuntimeData, IRuntimeDataScriptable (+16 more)
...
Cohesion: 0.05
Nodes (16): BuildingModelHandler, GameObject, List, BuildingModelHandlerEditor, BuildingPlacerEditor, BuildingResourceModelHandlerEditor, RoleScriptablesEditor, WindControllerEditor (+8 more)
...
Cohesion: 0.07
Nodes (39): append_direct_broadcast_diagnostic(), apply_direct_broadcast_control(), arm_stream_only_readback(), bandwidth_test_never_claims_to_be_publicly_live(), begin_twitch_live_verification(), capture_direct_broadcast_frame(), direct_broadcast_log_path(), DirectBroadcastControl (+31 more)

### Community 139 - "WorldInstanceDeterminism"
Cohesion: 0.30
Nodes (5): int, Quaternion, uint, Vector3, WorldInstanceDeterminism

### Community 140 - "SeasonDataSettings"
Cohesion: 0.18
...
Cohesion: 0.05
Nodes (61): AccessibilityNode, AssetId, advance_loading_phase(), advance_loading_runtime(), advance_world_loading_cover(), asset_root_collection_ready(), autosave_game(), begin_world_loading_cover() (+53 more)
...
### Community 159 - "stream_town_domain/src/lib.rs"
Cohesion: 0.13
...
### Community 163 - "draw_world_preview"
Cohesion: 0.29
...
Cohesion: 0.06
Nodes (16): PlayerDeathHandler, bool, float, Vector3, PlayerRoleData, AudioClip, bool, float (+8 more)
...
Cohesion: 0.03
Nodes (26): PersistentScoped, Transform, PlayerSpawnPoint, Slider, TextMeshProUGUI, UI_Objective, Image, TextMeshProUGUI (+18 more)

### Community 171 - "IntWrapper"
Cohesion: 0.33
...
Cohesion: 0.15
Nodes (25): clip_id(), convert_clips(), convert_post_process(), field_bool(), field_f32(), field_str(), field_u64(), field_value() (+17 more)
...
### Community 187 - "EnemyCampSaveData"
Cohesion: 0.50
...
Cohesion: 0.14
Nodes (10): int, string, ObjectiveSaveData, List, Material, Mesh, string, Vector3 (+2 more)
...
Cohesion: 0.05
Nodes (81): animation_property_curves_editor(), apply_building_draft(), AssetEditorSection, authoring_apply_preserves_the_complete_local_twitch_setup(), authority_tab(), building_draft(), building_editor_preserves_the_complete_template_record(), BuildingDraft (+73 more)
...
### Community 301 - "SettingsProcessor.cs"
Cohesion: 0.14
...
- **Why does `Utils` connect `Utils` to `GenerationSettings`, `EnemySpawner`, `SnapToGridMouseMovement`, `RandomEnabler`, `Editor`, `SimpleDisableAfterTime`, `TownGoal.Data`, `BuildingPlacer`, `UpdateGraphBounds`, `MonoBehaviour`, `CommonEnums.cs`, `StringUtils`, `Easings`, `ScriptableObject`, `TechTree.Elements`, `FPSDisplay`, `EventProcessor`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `StableId` connect `StableId` to `setup_rendering`, `String`, `stream_town_game/src/lib.rs`, `GridPos`, `config.rs`, `save.rs`, `.new`, `command.rs`, `twitch.rs`, `String`, `ContentCatalog`, `Option`, `advance_world_loading_cover`, `String`, `Res`, `stream_town_domain/src/lib.rs`, `draw_world_preview`, `Option`, `ToolState`, `AnimationControllerDef`, `Option`, `convert`, `stream_town_migrate/src/menu_scene.rs`, `stream_town_migrate/src/presentation.rs`, `stream_town_migrate/src/content.rs`, `WorldSimulation`, `technology_graph.rs`, `stream_town_tools/src/main.rs`, `world.rs`, `runtime_console.rs`, `PresentationCatalog`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `PlayerProcessor` connect `PlayerProcessor` to `BuildingProcessor`, `RoleProcessor`, `EnemySpawner`, `TwitchChatProcessor`, `BottomBarInterface`, `TownResourceProcessor`, `HealthHandler`, `IProcessor`, `WorldGenProcessor`, `RoleHandler`, `TechTreeProcessor`, `RoleData`, `Player`, `StreamTownSessionBridge`, `TwitchClientProcessor`, `UIProcessor`, `UserInterface_TownVote`, `Utils`, `PlayerRole`, `BuildingPlacer`, `SelectedObject`, `TimeProcessor`, `GameEvent`, `.Log`, `MonoBehaviour`, `SaveProcessor`, `GameEventProcessor`, `SelectedPlayer`, `UserInterface_RulerVote`?**
