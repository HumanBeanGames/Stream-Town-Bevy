...
## Corpus Check
- 604 files · ~1,571,272 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6565 nodes · 16557 edges · 275 communities (252 shown, 23 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 991 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `59c59421`
...
Cohesion: 0.11
Nodes (37): ArchetypeBounds, ArchetypeDef, ArchetypeKind, ArchetypeScene, AuthoredRecord, AuthoredValue, BuildingDef, ContentError (+29 more)

### Community 3 - "String"
Cohesion: 0.23
Nodes (26): inline_file_id(), parse_blend_tree(), parse_child_references(), parse_conditions(), parse_controller(), parse_layers(), parse_parameters(), parse_reference_list() (+18 more)

### Community 4 - "Character"
Cohesion: 0.06
Nodes (23): ActivityStatus, bool, float, string, UserType, TwitchUser, Color, GameUserType (+15 more)

### Community 5 - "TwitchConnection"
Cohesion: 0.10
Nodes (32): AppExit, AgentCommand, AgentCommandQueue, broadcaster_gate_precedes_twitch_command_dispatch(), BuildingCommandQueue, BuildingPlacement, BuildingPlacers, BuildingRuntimeCommand (+24 more)
...
### Community 9 - "String"
Cohesion: 0.07
Nodes (47): AnimationGraph, AnimationNodeIndex, AnimationPlayer, active_event_text(), ActorAnimationDriver, add_animation_layer_branch(), agent_action_animation(), agent_is_moving() (+39 more)
...
### Community 17 - "TechTreeProcessor.cs"
Cohesion: 0.06
Nodes (17): InputButton, SharedTypes, int, ChangeTimeStamp, DataStructures, TownGoal.Enumerations, TownGoal.Data, TownGoal (+9 more)
...
Cohesion: 0.07
Nodes (28): HashSet, BoxCollider, Func, HashSet, List, Material, Resource, Vector2 (+20 more)

### Community 21 - "NodeSaveData"
Cohesion: 0.18
...
Cohesion: 0.07
Nodes (16): Func, BuildingDamageMaterialHandler, bool, IEnumerator, Renderer, PlayerDeathHandler, bool, float (+8 more)
...
### Community 34 - "RoleDataContainer"
Cohesion: 0.09
...
Cohesion: 0.04
Nodes (135): AnyResult, GameConfig, Default, ContentCatalog, GridPos, ActorState, RoleProgress, Default (+127 more)
...
### Community 56 - ".Log"
Cohesion: 0.12
Nodes (5): Action, HideInCallstack, Object, DebugLogCategory, ResourceData[]&gt;

### Community 57 - "StableId"
Cohesion: 0.06
Nodes (54): ObjectiveDef, FromStr, StableId, authored_trade_rates_clamp_to_stock_gold_and_capacity(), BuildingState, capped_deposit_preserves_inventory_overflow(), complete_gameplay_scenario_round_trips(), default_ruler_vote_cooldown() (+46 more)
...
Cohesion: 0.09
Nodes (64): animation_state_id(), animation_state_machine_id(), array_index(), assign_clip_rigs_and_reference_poses(), avatar_mask_id(), clip_id(), collect_prefab_dependencies(), color_value() (+56 more)
...
### Community 95 - "SeasonDataSettings"
Cohesion: 0.18
...
Cohesion: 0.10
Nodes (39): AnimationClipDef, AnimationConditionDef, AnimationConditionMode, AnimationControllerDef, AnimationLayerBlendMode, AnimationLayerDef, AnimationMotionDef, AnimationParameterDef (+31 more)

### Community 100 - "Editor"
Cohesion: 0.11
Nodes (7): BuildingModelHandlerEditor, BuildingPlacerEditor, BuildingResourceModelHandlerEditor, WindControllerEditor, GridSystemEditor, Globals, Editor

### Community 101 - "ErrorData"
Cohesion: 0.22
...
### Community 108 - "WorldGenSaveData"
Cohesion: 0.15
...
### Community 117 - "ResourceStorageModifier"
Cohesion: 0.27
...
Cohesion: 0.07
Nodes (21): Action, CancellationToken, Task, IAsyncInitializableProcessor, ProcessorStartupContext, Action, bool, BoxCollider (+13 more)
...
Cohesion: 0.17
Nodes (12): ConfigError, default_configuration_is_valid_and_round_trips_ron(), enabled_twitch_requires_public_configuration(), GameplayConfig, BTreeMap, Result, Self, String (+4 more)
...
### Community 139 - "CampGenerationSettings"
Cohesion: 0.17
...
Cohesion: 0.18
Nodes (18): AnimationClip, AnimationTargetId, AnimationTransformTrack, add_rotation_curve(), add_scale_curve(), add_translation_curve(), ensure_two_keyframes(), normalized_quat() (+10 more)

### Community 155 - "TechnologyTreeGroup"
Cohesion: 0.23
...
### Community 158 - "SelectedPlayerGroup"
Cohesion: 0.23
...
### Community 162 - "AllSeasonSettings"
Cohesion: 0.29
...
### Community 174 - "append_vec3_keys"
Cohesion: 0.67
...
### Community 209 - "UIElementWrapper"
Cohesion: 0.08
Nodes (14): GameObject, List, PresetButtons, Access_ChannelNameInput, ContainerBuilder, Access_GOList, GameObject, List (+6 more)

### Community 210 - "ObjectPoolingRuntimeData"
Cohesion: 0.43
...
### Community 212 - "FoliageGenerationSettings"
Cohesion: 0.22
Nodes (7): List, Material, Mesh, string, Vector3, FoliageGenerationSettings, FoliageMeshSettings

### Community 213 - "environment_palette"
Cohesion: 0.29
Nodes (8): environment_palette(), environment_palette_covers_every_season_and_weather(), EnvironmentPalette, EnvironmentPresentation, parse_weather(), Season, WeatherParticle, Weather

### Community 214 - "Key Rules"
Cohesion: 0.29
Nodes (7): 1. **Namespace and Interface**, 2. **CreateAssetMenu**, 3. **State Management**, 4. **Events**, 5. **Initialization**, 6. **No Logic Beyond State**, Key Rules

### Community 215 - "GridSettings"
Cohesion: 0.29
...
### Community 220 - "ResourceGenerationSettings"
Cohesion: 0.12
...
### Community 224 - "Option"
Cohesion: 0.07
Nodes (130): Added, AmbientLight, AnimationGraphHandle, App, Assets, AssetServer, GeneratedWorld, Vec (+122 more)
...
### Community 228 - "GameEventConfigSettingsInstaller"
Cohesion: 0.33
...
### Community 235 - "WorldGenBehaviorSettings"
Cohesion: 0.33
...
Cohesion: 0.03
Nodes (36): CameraProcessor, CellSpacePartitioningInstaller, ContainerBuilder, ContainerBuilder, MetaDataInstaller, PersistentScoped, ContainerBuilder, GameSettingsInstaller (+28 more)
...
Cohesion: 0.04
Nodes (32): ContainerBuilder, InstantiationBarrier, AudioMixerInstaller, AudioMixer, ContainerBuilder, AutosaveIntervalsInstaller, ContainerBuilder, List (+24 more)

### Community 280 - "ScriptableObject"
Cohesion: 0.03
Nodes (48): ContainerBuilder, FoliageGenSettingsInstaller, ContainerBuilder, TimeDataSettingsInstaller, ContainerBuilder, WaterFoliageGenSettingsInstaller, ContainerBuilder, WorldGenDebugSettingsInstaller (+40 more)

### Community 281 - "Q: role level experience progression station equipment inventory skill upgrade"
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: role level experience progression station equipment inventory skill upgrade, Source Nodes

### Community 284 - "IRuntimeDataScriptable"
Cohesion: 0.12
...
## Knowledge Gaps
- **225 isolated node(s):** `StreamTown.Migration`, `StreamTown.EditorTools`, `Attributes`, `BuildCostModifier`, `StartupState` (+220 more)
...
- **Why does `SaveProcessor` connect `SaveProcessor` to `BuildingProcessor`, `Character`, `MonoBehaviour`, `SettingsProcessor`, `WorldGenProcessor`, `PlayerCommands`, `IInstaller`, `UserInterface_GameMenu`, `PlayerProcessor`, `ScriptableObject`, `ResourceDataSaveData`, `GameEventProcessor`, `SaveFileData`, `SaveDataMapper`, `TechTreeProcessor`, `TimeProcessor`, `SeasonProcessor`, `PlayerRole`, `StreamTownSessionBridge`, `ResourceProcessor`, `IProcessor`, `FoliageProcessor`, `ResourceGenerationSettings`, `WorldSaveData`, `MainMenuManager`, `TownGoalProcessor`, `GUIDProcessor`, `Resource`, `DebugProcessor`, `ObjectPoolingProcessor`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `WorldGenProcessor` connect `WorldGenProcessor` to `BuildingProcessor`, `TwitchChatProcessor`, `MonoBehaviour`, `CampGenerationSettings`, `.GenerateFromSettings`, `IInstaller`, `PlayerProcessor`, `ScriptableObject`, `SaveDataMapper`, `RaidEvent`, `CellSpacePartitioning`, `UserInterface_Debug`, `SaveProcessor`, `Target`, `ResourceProcessor`, `TwitchClientProcessor`, `Access_Dropdown`, `WorldGenRuntimeData`, `.Log`, `TerrainGenSettings`, `IProcessor`, `FoliageProcessor`, `GridProcessor`, `ResourceGenerationSettings`, `GameStateProcessor`, `Coordinator`, `Player`, `WorldGenBehaviorSettings`, `EnemySpawner`, `GUIDProcessor`, `WorldGenLayerSettings`, `WorldGenScaleSettings`, `DebugProcessor`, `ObjectPoolingProcessor`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `SettingsProcessor` connect `SettingsProcessor` to `Access_Slider`, `GraphicsProcessor`, `IProcessor`, `SettingsData`, `SaveProcessor`, `MainMenuManager`, `MonoBehaviour`, `Coordinator.cs`, `Access_Toggle`, `UIElementWrapper`, `Autosave`, `Access_Text`, `IInstaller`, `Access_Dropdown`, `UserInterface_GameMenu`?**
