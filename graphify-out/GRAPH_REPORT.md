...
## Corpus Check
- 608 files · ~1,602,223 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6966 nodes · 18239 edges · 258 communities (234 shown, 24 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 994 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c2636347`
...
## Communities (258 total, 24 thin omitted)

### Community 0 - "world.rs"
Cohesion: 0.19
Nodes (19): WorldGenConfig, authored_foliage_is_deterministic_and_respects_habitat_and_resources(), cell_hash(), changing_seed_changes_world_hash(), foliage_hash(), foliage_noise(), generate_foliage(), generate_world_from_layers() (+11 more)
...
### Community 4 - "Target"
Cohesion: 0.10
Nodes (11): TargetSettings, ContainerBuilder, TargetSettingsInstaller, TargetableData, Units, Target, Utils.Pooling, GridSystem.Partitioning (+3 more)
...
### Community 12 - "Player"
Cohesion: 0.07
Nodes (11): Player, Dictionary, GameObject, Vector3, Vector3, BuildingCommands, TwitchClientProcessor, PlayerCommands (+3 more)
...
Cohesion: 0.02
Nodes (62): CameraProcessor, PersistentScoped, Transform, PlayerSpawnPoint, Slider, TextMeshProUGUI, UI_Objective, TextMeshProUGUI (+54 more)

### Community 16 - "Character"
Cohesion: 0.05
Nodes (26): ActivityStatus, bool, float, string, UserType, TwitchUser, Color, GameUserType (+18 more)

### Community 18 - "Coordinator.cs"
Cohesion: 0.12
Nodes (6): InputButton, UserInterface.MainMenu, Core, MetaData, Settings, PlayerControls

### Community 19 - "drive_converted_animations"
Cohesion: 0.06
Nodes (61): AnimationClip, AnimationGraph, AnimationNodeIndex, AnimationPlayer, AnimationTargetId, ActorAnimationDriver, add_animation_layer_branch(), add_rotation_curve() (+53 more)
...
Cohesion: 0.09
Nodes (15): BuildingPlacer, bool, BoxCollider, Color, int, LayerMask, List, string (+7 more)
...
### Community 27 - "ResMut"
Cohesion: 0.06
Nodes (58): AccumulatedMouseMotion, AccumulatedMouseScroll, AppExit, BackgroundColor, PlayerSettings, Default, animation_property_value(), apply_player_settings() (+50 more)
...
Cohesion: 0.05
Nodes (121): App, GameConfig, ContentCatalog, GridPos, ActorState, RoleProgress, Default, String (+113 more)
...
### Community 39 - "Option"
Cohesion: 0.08
Nodes (44): StreamUserType, active_event_text(), actor_detail_budget(), animation_root_name(), archetype_id_by_source(), building_age(), building_definition_id(), building_model_node_names() (+36 more)
...
Cohesion: 0.07
Nodes (29): authored_trade_rates_clamp_to_stock_gold_and_capacity(), building_damage_and_repair_preserve_health_bounds(), BuildingState, default_ruler_vote_cooldown(), deterministic_fish_god_value(), deterministic_weather(), enemy_camps_and_raid_progress_round_trip_with_stable_archetypes(), EnemyCampState (+21 more)
...
Cohesion: 0.11
Nodes (19): bool, HashSet, int, long, MenuItem, string, BevyMigrationExporter, NeutralComponent (+11 more)

### Community 57 - "WorldSimulation"
Cohesion: 0.12
Nodes (14): capped_deposit_preserves_inventory_overflow(), complete_gameplay_scenario_round_trips(), healing_and_food_revives_preserve_health_invariants(), role_progression_matches_unity_curve_and_carries_excess(), BTreeMap, Result, VecDeque, ruler_vote_rejects_duplicates_and_invalid_candidates() (+6 more)
...
Cohesion: 0.16
Nodes (13): BuildingMaterialExtension, BuildingMaterialUniform, CloudMaterialExtension, CloudMaterialUniform, Image, TerrainMaterialExtension, TerrainMaterialUniform, TreeMaterialExtension (+5 more)
...
Cohesion: 0.02
Nodes (124): AnyResult, ActionPresentation, ActivePetVisual, actor_combat_visual(), adjust_settings_menu(), AgentCommand, AgentCommandQueue, AgentEquipmentPresentation (+116 more)
...
Cohesion: 0.06
Nodes (99): AmbientLight, Assets, AssetServer, ArchetypeDef, ArchetypeKind, ArchetypeScene, PresentationCatalog, actor_material() (+91 more)

### Community 91 - "RoleProcessor"
Cohesion: 0.06
Nodes (14): RoleSlot, bool, int, Container, ContainerBuilder, int, List, RoleProcessor (+6 more)

### Community 92 - "GameEvent"
Cohesion: 0.05
Nodes (23): Animator, GameObject, IEnumerator, int, FishGodEvent, bool, IEnumerator, int (+15 more)

### Community 93 - "GameMasterCommands"
Cohesion: 0.12
...
Cohesion: 0.07
Nodes (11): BuildingModelHandlerEditor, BuildingPlacerEditor, BuildingResourceModelHandlerEditor, EnemyModelHandlerEditor, CellPartitioningEditor, GridProcessorEditor, GridSystemEditor, GridSystem.Utils (+3 more)
...
### Community 115 - "StableId"
Cohesion: 0.14
Nodes (11): ObjectiveDef, ObjectiveKind, FromStr, StableId, objective_increment(), ObjectiveEvent, Option, stable() (+3 more)
...
### Community 121 - "Res"
Cohesion: 0.09
Nodes (97): Added, AnimationGraphHandle, AudioSink, ActorNameOverlay, Agent, agent_is_moving(), AgentAnimation, animate_agents() (+89 more)
...
Cohesion: 0.14
Nodes (15): HashSet, Func, HashSet, List, Vector2, Vector3, GenerateDebugPositions(), GetPositiveNoiseOffset() (+7 more)

### Community 132 - ".SerializeComponent"
Cohesion: 0.24
Nodes (9): Component, GameObject, List, Object, NeutralAsset, NeutralAsset, NeutralField, NeutralGameObject (+1 more)

### Community 133 - ".PropertyValue"
Cohesion: 0.14
...
### Community 143 - ".Log"
Cohesion: 0.07
Nodes (23): Container, ContainerBuilder, GameStateProcessor, Action, bool, CancellationToken, Container, ContainerBuilder (+15 more)
...
### Community 150 - "BuildingConfigSettings"
Cohesion: 0.15
Nodes (9): ContainerBuilder, BuildingConfigSettingsInstaller, RequirementType, object, Requirement, Dictionary, int, BuildingConfigSettings (+1 more)
...
Cohesion: 0.11
Nodes (7): WindControllerEditor, float, Material, Vector2, WindController, Audio, Environment
...
### Community 170 - "SeasonDataSettings"
Cohesion: 0.18
...
### Community 178 - "SaveDataMapper"
Cohesion: 0.12
Nodes (12): Mesh, Vector3, SaveDataMapper, bool, int, MeshSaveData, int, PlayerRoleSaveData (+4 more)
...
### Community 193 - "Utils"
Cohesion: 0.06
Nodes (10): RoleScriptablesEditor, STStateMachine.States, Utils, Behaviours, Animation, Sensors, ScriptablesEditor, STStateMachine (+2 more)
...
### Community 224 - "GameEventConfigSettingsInstaller"
Cohesion: 0.33
...
Cohesion: 0.07
Nodes (23): Action, CancellationToken, Component, Container, ContainerBuilder, float, List, Task (+15 more)

### Community 246 - "TradeSettings"
Cohesion: 0.33
...
Cohesion: 0.02
Nodes (77): ContainerBuilder, FoliageGenSettingsInstaller, ContainerBuilder, TerrainGenSettingsInstaller, ContainerBuilder, TimeDataSettingsInstaller, ContainerBuilder, WaterFoliageGenSettingsInstaller (+69 more)
...
- **Why does `SaveProcessor` connect `SaveProcessor` to `BuildingProcessor`, `SettingsProcessor`, `WorldGenProcessor`, `.Log`, `Character`, `MonoBehaviour`, `PlayerProcessor`, `ScriptableObject`, `IInstaller`, `SaveFileData`, `.CaptureFoliageGroups`, `GameEventProcessor`, `ResourceProcessor`, `FoliageGenerationSettings`, `TechTreeProcessor`, `TimeProcessor`, `UserInterface_GameMenu`, `SeasonProcessor`, `DebugProcessor`, `IProcessor`, `SaveDataMapper`, `StreamTownSessionBridge`, `PoolableObject`, `FoliageProcessor`, `RoleProcessor`, `GameMasterCommands`, `TownGoalProcessor`, `MainMenuManager`, `Resource`, `ResourceGenerationSettings`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `WorldGenProcessor` connect `WorldGenProcessor` to `BuildingProcessor`, `.GenerateFromSettings`, `Target`, `TwitchChatProcessor`, `.Log`, `MonoBehaviour`, `PlayerProcessor`, `ScriptableObject`, `IInstaller`, `ResourceProcessor`, `UserInterface_Debug`, `CampGenerationSettings`, `DebugProcessor`, `IProcessor`, `TwitchClientProcessor`, `PoolableObject`, `WorldGenRuntimeData`, `Access_Dropdown`, `GridProcessor`, `CellSpacePartitioning`, `FoliageProcessor`, `GameEvent`, `GameMasterCommands`, `Coordinator`, `EnemySpawner`, `SaveProcessor`, `ResourceGenerationSettings`, `AIPath`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `SettingsProcessor` connect `SettingsProcessor` to `Autosave`, `GraphicsProcessor`, `Access_Slider`, `SettingsData`, `MainMenuManager`, `UserInterface_GameMenu`, `Access_Dropdown`, `UIElementWrapper`, `MonoBehaviour`, `IProcessor`, `SaveProcessor`, `ScriptablesProcessorInfrastructure`, `Access_Text`, `IInstaller`, `Access_Toggle`?**
