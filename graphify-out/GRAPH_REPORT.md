...
## Corpus Check
- 675 files · ~1,855,655 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9856 nodes · 30555 edges · 307 communities (285 shown, 22 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 1072 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `44c80ea6`
...
## Communities (307 total, 22 thin omitted)

### Community 0 - ".new"
Cohesion: 0.03
Nodes (160): RoleProgress, Default, generate_world(), accessibility_motion_preferences_preserve_authored_parameters(), accessibility_scope_keeps_modal_navigation_inside_the_open_surface(), accessibility_tagging_tolerates_ui_removed_before_deferred_annotation(), action_ranges_and_tower_acquisition_are_euclidean(), apply_passive_building_income() (+152 more)
...
### Community 4 - ".count"
Cohesion: 0.03
Nodes (96): AccessibilityNode, AssetId, advance_loading_phase(), advance_loading_runtime(), advance_world_loading_cover(), AgentRecoveryRuntime, asset_root_collection_ready(), authored_rotating_node_names() (+88 more)

### Community 5 - "stream_town_game/src/lib.rs"
Cohesion: 0.01
Nodes (293): accessibility_navigation_preserves_editable_text_focus(), accessibility_should_clear_focus(), AccessibilityActionDispatch, AccessibilityAnnouncement, AccessibilityCandidate, AccessibilityHighContrastText, actor_combat_visual(), actor_detail_budget() (+285 more)
...
### Community 9 - "Query"
Cohesion: 0.04
Nodes (186): Added, AnimatedBy, AnimationGraphHandle, AnimationTransitions, ActivePetVisual, ActorAnimationDriver, ActorHealthFill, ActorNameOverlay (+178 more)
...
Cohesion: 0.05
Nodes (117): GameConfig, GameplayConfig, BTreeMap, DirtyRegion, generate_world_with_content(), GeneratedFoliage, GeneratedWorld, advance_falling_fish() (+109 more)

### Community 18 - "Reflex.Core"
Cohesion: 0.01
Nodes (92): CellSpacePartitioningInstaller, ContainerBuilder, ContainerBuilder, InstantiationBarrier, ContainerBuilder, MetaDataInstaller, ContainerBuilder, Volume (+84 more)
...
Cohesion: 0.02
Nodes (69): Api, CameraProcessor, PersistentScoped, UnitTravelToPosition, Vector3, PlacementProbe, float, PlacementProbeHandler (+61 more)
...
Cohesion: 0.04
Nodes (97): ObjectiveDef, Display, FromStr, StableId, actor_appearance_hash(), actor_appearances_are_seeded_varied_and_persisted(), ActorCustomization, authored_trade_rates_clamp_to_stock_gold_and_capacity() (+89 more)
...
### Community 29 - "Ui"
Cohesion: 0.10
Nodes (50): animation_condition_mode_choice(), animation_controller_editor(), animation_events_editor(), animation_layer_blend_choice(), animation_layers_editor(), animation_parameter_kind_choice(), animation_parameters_editor(), animation_quat_keys_editor() (+42 more)

### Community 30 - "Res"
Cohesion: 0.03
Nodes (190): AccessibilityActionRequest, AccessibilityFocusVisualQuery, accessibility_button_enabled(), accessibility_input(), accessibility_scope_active(), AccessibilityRuntime, AccessibleButtonNodeQuery, AccessibleButtonScope (+182 more)
...
### Community 32 - "Option"
Cohesion: 0.02
Nodes (162): AmbientLight, SeasonalTerrainPalette, TerrainAppearanceConfig, ActiveMaterialHandles, animate_fish_school(), animate_main_menu_clouds(), animation_root_name(), apply_authored_ui_fonts() (+154 more)

### Community 33 - ".default"
Cohesion: 0.09
Nodes (44): authority_tab(), character_model_choices_include_converted_hierarchy_nodes(), checked_in_authoring_assets_pass_headless_validation(), default_catalog_path(), default_config_path(), default_presentation_path(), default_technology_layout_path(), foliage_editor_rejects_invalid_generation_values_without_mutation() (+36 more)

### Community 34 - "GenerationSettings"
Cohesion: 0.06
Nodes (35): Action, IEnumerator, Vector2, Noise, float, int, string, Vector2 (+27 more)

### Community 35 - "RenderAssets"
Cohesion: 0.05
Nodes (166): PresentationCatalog, actor_material(), actor_scene_budget(), animate_chimney_smoke_particles(), apply_authored_main_menu_camera(), apply_building_placement_ghosts(), authored_main_ui_image_with_ppu(), authored_scene_rotation() (+158 more)
...
Cohesion: 0.04
Nodes (74): amf_quality_profile_keeps_static_grid_detail_between_keyframes(), append_direct_broadcast_diagnostic(), append_direct_broadcast_diagnostic_to(), AuthorizationEvent, average_milliseconds(), bandwidth_test_never_claims_to_be_publicly_live(), bandwidth_test_url_is_constructed_without_logging_the_key(), BroadcastPrerequisites (+66 more)
...
Cohesion: 0.05
Nodes (30): Exception, IMainThreadInitializableProcessor, IPostInitializeProcessor, ProcessorStartupReport, ProcessorStartupStage, Container, ContainerBuilder, DebugProcessor (+22 more)
...
Cohesion: 0.13
Nodes (29): AnimationClip, AnimationTargetId, add_rotation_curve(), add_scale_curve(), add_translation_curve(), authored_player_run_clip_loop_pose_correction_closes_the_seam(), building_material_round_robin_covers_every_instance_with_a_bounded_batch(), close_rotation_loop() (+21 more)
...
Cohesion: 0.09
Nodes (34): BroadcastConfig, BroadcastEncoderPreference, BroadcastEncoder, BroadcastMetrics, BroadcastTarget, configured_1080p60_encoder_sustains_realtime_output(), copy_packed_video_frame(), discard_pending_audio() (+26 more)
...
Cohesion: 0.08
Nodes (53): build_fine_navigation(), building_construction_cost(), building_cost_summary(), building_definition_id(), building_instance_ids(), building_placement_is_available(), BuildingPlacement, buy_town_resource() (+45 more)

### Community 50 - "IRuntimeDataScriptable"
Cohesion: 0.04
Nodes (34): AudioHandler, AudioClip, AudioSource, bool, Camera, float, PlayerAudioHandler, ContainerBuilder (+26 more)
...
Cohesion: 0.05
Nodes (127): ContentCatalog, RoleDef, BTreeSet, StationDef, GridPos, ActorKind, ActorState, String (+119 more)
...
### Community 54 - ".new"
Cohesion: 0.12
Nodes (24): closing_the_operator_window_requests_a_graceful_game_exit(), configure_direct_broadcast(), controller_counts_replaced_video_without_rejecting_the_newest_frame(), direct_broadcast_stays_offline_until_operator_requests_it(), DirectTwitchBroadcastPlugin, ending_stream_returns_the_operator_to_main_menu_after_shutdown(), explicit_automatic_start_uses_the_normal_broadcast_configuration_path_once(), graceful_stop_replaces_capture_with_the_offline_frame_before_aborting() (+16 more)
...
Cohesion: 0.07
Nodes (38): AnyResult, automatic_resume_save_path(), EnemyPathOpenNode, is_jump_start_path(), jump_start_saves_are_identifiable_and_never_reuse_an_existing_path(), jump_start_snapshot_path(), jump_start_working_path(), legacy_unity_settings_path() (+30 more)
...
Cohesion: 0.02
Nodes (109): ContainerBuilder, AllSeasonsSettingsInstaller, ContainerBuilder, CampGenSettingsInstaller, ContainerBuilder, ResourceDataSettingsInstaller, ContainerBuilder, WaterResourceGenSettingsInstaller (+101 more)
...
Cohesion: 0.05
Nodes (20): Action, Container, ContainerBuilder, List, Transform, Vector3, PlayerProcessor, Dictionary (+12 more)

### Community 61 - "stream_town_domain/src/content.rs"
Cohesion: 0.05
Nodes (74): ArchetypeBounds, ArchetypeDef, ArchetypeKind, ArchetypeScene, AuthoredRecord, AuthoredValue, BuildingDef, BuildingModelDef (+66 more)
...
Cohesion: 0.11
Nodes (30): automatic_layout_is_complete_deterministic_and_valid(), bounded_layout_index(), GraphPoint, GraphSize, id(), reconcile_preserves_moves_and_repairs_catalog_coverage(), Default, Result (+22 more)

### Community 74 - "Utils"
Cohesion: 0.03
Nodes (41): BuildCostModifier, InputButton, STStateMachine.States, UserInterface.MainMenu, PlayerControls.ObjectSelection, Units, Utils, Processors (+33 more)

### Community 75 - "Option"
Cohesion: 0.10
Nodes (52): ability_choices(), action_animation_choices(), animation_assets_editor(), building_model_node_choices(), buildings_tab(), cached_gltf_metadata(), content_tab(), content_tab_contents() (+44 more)
...
### Community 82 - "NativeGameAudioRouting"
Cohesion: 0.11
Nodes (14): AudioFrame, AudioInput, capture_process_audio(), NativeGameAudioMix, NativeGameAudioRouting, NativeGameAudioVoice, pcm16_wav_clip(), pcm16_wav_data() (+6 more)
...
Cohesion: 0.10
Nodes (38): AtomicBool, BroadcastController, capture_stream_only_target(), configure_stream_capture_ring(), copy_gpu_rows_into(), GpuStreamCaptureRing, GpuStreamCaptureShared, GpuStreamCaptureSlot (+30 more)
...
Cohesion: 0.04
Nodes (44): Container, ContainerBuilder, GUIDProcessor, Action, CancellationToken, Task, IAsyncInitializableProcessor, ProcessorStartupContext (+36 more)
...
### Community 107 - "MeshSaveData"
Cohesion: 0.14
Nodes (9): Mesh, Vector3, bool, int, MeshSaveData, float, Vector2SaveData, float (+1 more)

### Community 108 - "animate_healing_effects"
Cohesion: 0.30
Nodes (14): animate_healing_effects(), f32_to_u16_saturating(), gradient_material(), healing_burst_effect(), healing_channel_effect(), healing_effect_curves_preserve_authored_lifetimes_and_channel_keys(), healing_effect_duration(), healing_effect_extent_stays_within_character_scale() (+6 more)
...
### Community 111 - "TechTreeNode"
Cohesion: 0.06
Nodes (34): NodeUnlockSaveData, Button, EnumField, ObjectiveVisualElement, Color, Foldout, List, Port (+26 more)
...
Cohesion: 0.06
Nodes (63): animation_property_curves_editor(), apply_building_draft(), archetype_kind_choice(), AssetEditorSection, authoring_apply_preserves_the_complete_local_twitch_setup(), broadcast_encoder_label(), building_draft(), building_editor_preserves_the_complete_template_record() (+55 more)
...
### Community 126 - "OperatorChatRuntime"
Cohesion: 0.26
Nodes (6): moderate_selected_operator_user(), operator_chat_scroll_stays_anchored_when_new_messages_arrive(), OperatorChatBadges, OperatorChatLine, OperatorChatRuntime, Into
...
Cohesion: 0.03
Nodes (88): AccessibleNode, PlayerSettings, Default, accessibility_settings_selection(), active_event_text(), add_animation_composition(), add_animation_layer_branch(), adjust_settings_menu() (+80 more)
...
### Community 131 - "update_stream_operator_chat"
Cohesion: 0.08
Nodes (30): bounded_history_f32(), BroadcastMetricsSnapshot, DirectBroadcastPhase, DirectBroadcastSnapshot, operator_live_button_label(), operator_window_close_requests_exit(), prepared_broadcast_can_start(), MessageReader (+22 more)

### Community 132 - ".StartMusic"
Cohesion: 0.49
...
### Community 136 - "CreditsProcessor"
Cohesion: 0.24
Nodes (3): Container, ContainerBuilder, CreditsProcessor

### Community 137 - "TargetSensor"
Cohesion: 0.05
Nodes (17): RotationHandler, float, Quaternion, Vector3, ProjectileShooter, float, int, string (+9 more)

### Community 138 - "DirectBroadcastRuntime"
Cohesion: 0.07
Nodes (50): apply_direct_broadcast_control(), AutomaticBroadcastStart, begin_twitch_live_verification(), BroadcastStopDisposition, camera_targets_primary_window(), capture_direct_broadcast_frame(), DirectBroadcastControl, DirectBroadcastRuntime (+42 more)

### Community 139 - "StationProcessor"
Cohesion: 0.22
Nodes (7): Container, ContainerBuilder, StationProcessor, Dictionary, List, Queue, StationRuntimeData
...
Cohesion: 0.08
Nodes (13): Action, Dictionary, IReadOnlyList, List, CommandDictionary, Dictionary, MiscCommands, Dictionary (+5 more)
...
### Community 153 - "Vec"
Cohesion: 0.13
Nodes (24): actor_movement_speed(), actor_movement_speed_on_path(), append_world_diagnostic_quad(), build_enemy_navigation_field(), building_fine_navigation_cells(), completed_path_levels_accelerate_citizens_by_five_percent_each(), completed_player_gate_navigation_cells(), default_navigation_footprint_thirds() (+16 more)
...
### Community 162 - "drive_world_audio"
Cohesion: 0.28
Nodes (9): AudioSink, AmbienceAudio, CachedRoleActionAudio, drive_world_audio(), RoleActionAudioCache, Arc, AudioSource, setup_world_audio_sources() (+1 more)

### Community 163 - "UserInterface_ObjectSelection"
Cohesion: 0.04
Nodes (21): SelectedBuilding, SelectedEnemyCamp, object, UnityAction, SelectedObject, List, SelectedPlayerGroup, SelectedResource (+13 more)

### Community 164 - "PlayerSaveData"
Cohesion: 0.06
...
Cohesion: 0.04
Nodes (42): RoleSlotModifier, int, RoleData, AudioClip, bool, float, int, Sprite (+34 more)
...
Cohesion: 0.03
Nodes (40): AnimationHandler, Animator, bool, Dictionary, float, int, PlayerDeathHandler, bool (+32 more)
...
### Community 267 - "GpuStreamCaptureCounters"
Cohesion: 0.67
...
### Community 307 - "select_grid_cell"
Cohesion: 0.13
Nodes (17): DisplayMode, player_window_mode(), ray_sphere_distance(), Button, PrimaryWindow, Window, select_grid_cell(), SelectedActor (+9 more)
...
- **Why does `StableId` connect `StableId` to `.new`, `.new`, `String`, `stream_town_migrate/src/content.rs`, `.count`, `stream_town_game/src/lib.rs`, `Query`, `config.rs`, `GeneratedWorld`, `command.rs`, `Vec`, `String`, `Ui`, `Res`, `Option`, `.default`, `RenderAssets`, `retargeted_animation_clip`, `runtime_console.rs`, `AnimationControllerDef`, `ToolState`, `process_injected_commands`, `Option`, `ContentCatalog`, `select_grid_cell`, `stream_town_domain/src/content.rs`, `stream_town_migrate/src/menu_scene.rs`, `stream_town_migrate/src/presentation.rs`, `twitch.rs`, `xtask/src/main.rs`, `TechnologyGraphLayout`, `Option`, `technology_graph.rs`, `legacy.rs`, `stream_town_domain/src/presentation.rs`, `animate_healing_effects`, `world.rs`, `stream_town_tools/src/main.rs`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `Utils` connect `Utils` to `EnemySpawner`, `WeatherProcessor`, `Easings`, `Reflex.Core`, `MonoBehaviour`, `.DrawDataFieldAndLabel`, `TechTree.Elements`, `GenerationSettings`, `DebugProcessor`, `IRuntimeDataScriptable`, `ScriptablesProcessorInfrastructure`, `BuildingPlacer`, `LabelDisplayProcessor`, `RandomEnabler`, `SnapToGridMouseMovement`, `StringUtils`, `FPSDisplay`, `CommonEnums.cs`, `UpdateGraphBounds`, `BuildingDataSettings`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `PlayerProcessor` connect `PlayerProcessor` to `BuildingProcessor`, `EnemySpawner`, `TwitchChatProcessor`, `BottomBarInterface`, `UserInterface_Debug`, `HealthHandler`, `Reflex.Core`, `MonoBehaviour`, `PlayerRoleData`, `WorldGenProcessor`, `UserInterface_ObjectSelection`, `RoleHandler`, `TechTreeProcessor`, `UIProcessor`, `Player`, `StreamTownSessionBridge`, `TwitchClientProcessor`, `NewKingVote`, `Utils`, `BuildingPlacer`, `RaidEvent`, `ObjectPoolingProcessor`, `SelectedPlayer`, `Resource`, `SaveProcessor`, `GameEventProcessor`, `UserInterface_TownVote`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **What connects `StreamTown.EditorTools`, `Attributes`, `BuildCostModifier` to the rest of the system?**
  _400 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `.new` be split into smaller, more focused modules?**
  _Cohesion score 0.02908429902294933 - nodes in this community are weakly interconnected._
- **Should `BuildingProcessor` be split into smaller, more focused modules?**
  _Cohesion score 0.04324450677886863 - nodes in this community are weakly interconnected._
