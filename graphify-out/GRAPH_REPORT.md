...
## Corpus Check
- 644 files · ~1,685,056 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8119 nodes · 22837 edges · 307 communities (283 shown, 24 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 1022 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `085a965a`
...
Cohesion: 0.07
Nodes (32): ObjectiveDef, ObjectiveKind, authored_trade_rates_clamp_to_stock_gold_and_capacity(), building_damage_and_repair_preserve_health_bounds(), BuildingState, default_ruler_vote_cooldown(), deterministic_fish_god_value(), deterministic_weather() (+24 more)

### Community 4 - "ScriptableObject"
Cohesion: 0.03
Nodes (62): ContainerBuilder, AllRoleDataSettingsInstaller, int, AudioSettings, List, CampGenSettings, List, FoliageGenSettings (+54 more)

### Community 5 - ".default"
Cohesion: 0.04
Nodes (106): generate_world(), generate_world_with_content(), agent_facing_matches_unity_rotation_and_action_targets(), archetype_id_by_source(), authored_assignment_penalty_spreads_farmers_across_farms(), authored_building_nodes_follow_construction_age_and_storage_fill(), authored_enemies_drive_damage_range_cadence_and_weighted_spawning(), authored_level_curves_drive_effective_role_stats() (+98 more)
...
Cohesion: 0.05
Nodes (129): GameConfig, GeneratedWorld, actor_combat_visual(), actor_material(), advance_falling_fish(), animate_chimney_smoke_particles(), append_terrain_skirt(), apply_authored_main_menu_camera() (+121 more)
...
Cohesion: 0.06
Nodes (23): uint, GUIDComponent, List, SaveableBuilding, SaveableEnemy, SaveableEnemyCamp, string, SaveableObject (+15 more)
...
### Community 13 - "Option"
Cohesion: 0.04
Nodes (107): ArchetypeScene, PresentationCatalog, animated_pets_resolve_their_own_unity_controllers_and_rigs(), animation_property_value(), animation_root_name(), animation_selection_duration(), apply_material_overrides(), archetype_by_source() (+99 more)
...
Cohesion: 0.09
Nodes (22): capped_deposit_preserves_inventory_overflow(), complete_gameplay_scenario_round_trips(), healing_and_food_revives_preserve_health_invariants(), BTreeMap, Option, Result, VecDeque, ruler_vote_rejects_duplicates_and_invalid_candidates() (+14 more)
...
### Community 26 - "Res"
Cohesion: 0.06
Nodes (166): Aabb, Added, AmbientLight, AnimationGraphHandle, AnimationPlayer, AnimationTransitions, Assets, AudioSink (+158 more)
...
Cohesion: 0.06
Nodes (21): HashSet, bool, BoxCollider, Container, ContainerBuilder, Func, GameObject, HashSet (+13 more)
...
### Community 36 - "ResMut"
Cohesion: 0.03
Nodes (148): AccumulatedMouseMotion, AccumulatedMouseScroll, AppExit, PlayerSettings, Default, adjust_settings_menu(), AgentCommandQueue, apply_player_settings() (+140 more)
...
Cohesion: 0.09
Nodes (77): ContentCatalog, GridPos, ActorState, String, action_animation_speed(), action_cooldown(), ActionPresentation, actor_accepts_resource() (+69 more)
...
Cohesion: 0.01
Nodes (221): AnyResult, BackgroundColor, DisplayMode, actor_detail_budget(), actor_scene_budget(), ActorHealthFill, ActorHealthOverlay, AgentEnemyModelPresentation (+213 more)
...
### Community 57 - "Handle"
Cohesion: 0.05
Nodes (56): bottom_bar_texture(), BoundsMaterialExtension, BoundsMaterialUniform, BuildingMaterialExtension, BuildingMaterialUniform, CharacterMaterialExtension, CharacterMaterialUniform, CloudMaterialExtension (+48 more)
...
### Community 70 - "preview_grid_point"
Cohesion: 0.67
...
### Community 74 - "STSM_Action_PlayerBase"
Cohesion: 0.09
...
### Community 83 - "String"
Cohesion: 0.03
Nodes (109): AnimationClip, AnimationGraph, AnimationNodeIndex, AnimationTargetId, active_event_text(), add_animation_composition(), add_animation_layer_branch(), add_rotation_curve() (+101 more)
...
### Community 95 - "BuildingResourceModelHandler"
Cohesion: 0.11
...
Cohesion: 0.09
Nodes (35): FromStr, StableId, AgentCommand, assign_group_role(), bottom_bar_entries(), building_construction_cost(), building_cost_reduction_percent(), building_definition_id() (+27 more)
...
Cohesion: 0.12
Nodes (15): ChildrenSaveData, List, Vector2, NodeSaveData, NodeUnlockSaveData, Color, Foldout, List (+7 more)
...
### Community 146 - "advance_loading_phase"
Cohesion: 0.19
Nodes (15): advance_loading_phase(), advance_loading_runtime(), BootDestination, LoadingProgressFill, LoadingStatusText, MenuLoadingRuntime, sync_boot_loading_screen(), sync_loading_screen_status() (+7 more)
...
Cohesion: 0.11
Nodes (43): MainMenuCameraReference, MainMenuCorrectiveBake, MainMenuEmbeddedMesh, MainMenuFoliageVisual, MainMenuModelInstance, MainMenuResourceVisual, MainMenuSceneReference, Option (+35 more)
...
### Community 200 - "Utils"
Cohesion: 0.04
Nodes (8): BuildCostModifier, Utils, Level, Buildings, SavingAndLoading, SavingAndLoading.Structs, GameResources, World.Generation
...
### Community 215 - ".RestoreWorldState"
Cohesion: 0.16
...
### Community 217 - "FoliageGenerationSettings"
Cohesion: 0.22
...
### Community 240 - "DayAndNightSettings"
Cohesion: 0.22
...
### Community 256 - "selected_building_footprint"
Cohesion: 0.22
Nodes (9): EnemyCampState, RaidState, BTreeSet, recruit_group_order_at_cell(), RecruitGroupOrder, selected_building_footprint(), selected_building_id_at_cell(), selected_enemy_camp_at_cell() (+1 more)
...
### Community 294 - "IntWrapper"
Cohesion: 0.33
Nodes (3): Access_Preset, ContainerBuilder, IntWrapper

### Community 295 - "PostProcessingInstaller"
Cohesion: 0.40
Nodes (3): ContainerBuilder, Volume, PostProcessingInstaller

### Community 296 - "settings.rs"
Cohesion: 0.11
Nodes (26): AudioMixSettings, BuildingHealthDisplayMode, CameraSettings, clamp_sensitivity(), clamp_unit(), defaults_are_valid_and_round_trip(), imports_unity_json_indices_and_clamps_values(), imports_unity_subscriber_name_display_index() (+18 more)

### Community 297 - "AudioMixerInstaller"
Cohesion: 0.40
Nodes (3): AudioMixerInstaller, AudioMixer, ContainerBuilder

### Community 298 - "AutosaveIntervalsInstaller"
Cohesion: 0.40
Nodes (3): AutosaveIntervalsInstaller, ContainerBuilder, List

### Community 299 - "VfxAnimationController"
Cohesion: 0.05
Nodes (17): PersistentScoped, Transform, PlayerSpawnPoint, Image, TextMeshProUGUI, UIRoleDisplay, List, SimpleEventOnStart (+9 more)
...
### Community 304 - ".GetCompatiblePorts"
Cohesion: 0.50
...
- **Why does `Utils` connect `Utils` to `UpdateGraphBounds`, `CommonEnums.cs`, `Processors`, `Target`, `StringUtils`, `SimpleScreenShot`, `BuildingPlacer`, `Character`, `LabelDisplayProcessor`, `RandomEnabler`, `UserInterface`, `GenerationSettings`, `SimpleDisableAfterTime`, `VfxAnimationController`, `TechTree.Elements`, `ScriptablesProcessorInfrastructure`, `MonoBehaviour`, `Easings`, `.DrawDataFieldAndLabel`, `FPSDisplay`, `EnemySpawner`, `TechTreeNode`, `SnapToGridMouseMovement`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `WorldGenProcessor` connect `WorldGenProcessor` to `BuildingProcessor`, `ScriptableObject`, `TwitchChatProcessor`, `ResourceProcessor`, `WorldGenRuntimeData`, `Target`, `.Log`, `ObjectPoolingProcessor`, `Player`, `IProcessor`, `UserInterface_Debug`, `WorldInstanceDeterminism`, `TwitchClientProcessor`, `ProjectCamera`, `MonoBehaviour`, `GameStateProcessor`, `PlayerProcessor`, `GUIDProcessor`, `CellSpacePartitioning`, `FoliageProcessor`, `TerrainGenSettings`, `GameEvent`, `SaveProcessor`, `Coordinator`, `EnemySpawner`, `AIPath`, `GridProcessor`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `StableId` connect `StableId` to `selected_building_footprint`, `world.rs`, `simulation.rs`, `.default`, `runtime_console.rs`, `RenderAssets`, `Option`, `legacy.rs`, `stream_town_domain/src/content.rs`, `save.rs`, `WorldSimulation`, `stream_town_tools/src/main.rs`, `Res`, `String`, `ResMut`, `ContentCatalog`, `stream_town_migrate/src/content.rs`, `AnimationControllerDef`, `stream_town_game/src/lib.rs`, `BTreeMap`, `command.rs`, `stream_town_migrate/src/menu_scene.rs`, `twitch.rs`, `stream_town_migrate/src/presentation.rs`, `String`, `stream_town_domain/src/presentation.rs`, `Result`?**
