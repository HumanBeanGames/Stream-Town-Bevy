...
## Corpus Check
- 671 files · ~1,783,096 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9006 nodes · 26348 edges · 317 communities (290 shown, 27 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 1046 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2783d38c`
...
1. `StableId` - 374 edges
2. `WorldSimulation` - 171 edges
3. `Utils` - 159 edges
4. `ContentCatalog` - 159 edges
...
### Community 0 - "Vec"
Cohesion: 0.05
Nodes (74): AnimationClip, AnimationGraph, AnimationNodeIndex, AnimationTargetId, add_animation_composition(), add_animation_layer_branch(), add_rotation_curve(), add_scale_curve() (+66 more)
...
### Community 3 - "IProcessor"
Cohesion: 0.05
Nodes (31): ContainerBuilder, AllSeasonsSettingsInstaller, float, int, Material, AllSeasonSettings, Container, IMainThreadInitializableProcessor (+23 more)

### Community 4 - "Query"
Cohesion: 0.04
Nodes (143): Aabb, Added, AnimatedBy, AnimationGraphHandle, AnimationPlayer, AudioSink, AccessibilityHighContrastText, ActivePetVisual (+135 more)

### Community 5 - "stream_town_game/src/lib.rs"
Cohesion: 0.01
Nodes (349): accessibility_motion_preferences_preserve_authored_parameters(), accessibility_navigation_preserves_editable_text_focus(), accessibility_scope_keeps_modal_navigation_inside_the_open_surface(), accessibility_settings_selection(), accessibility_tagging_tolerates_ui_removed_before_deferred_annotation(), AccessibilityActionDispatch, AccessibilityCandidate, action_ranges_and_tower_acquisition_are_euclidean() (+341 more)

### Community 6 - "TwitchChatProcessor"
Cohesion: 0.08
Nodes (17): bool, float, Func, int, PlayerExistsByIDDelegate, PlayerExistsByNameDelegate, Queue, string (+9 more)

### Community 7 - "advance_world_loading_cover"
Cohesion: 0.07
Nodes (46): AccessibilityNode, advance_loading_phase(), advance_loading_runtime(), advance_world_loading_cover(), asset_root_collection_ready(), finish_menu_reveal(), finish_world_reveal(), foliage_batch_key() (+38 more)
...
Cohesion: 0.05
Nodes (21): Action, Container, ContainerBuilder, List, Transform, Vector3, PlayerProcessor, Dictionary (+13 more)
...
Cohesion: 0.08
Nodes (18): uint, GUIDComponent, List, SaveableBuilding, SaveableEnemy, SaveableEnemyCamp, string, SaveableObject (+10 more)
...
### Community 18 - "Option"
Cohesion: 0.04
Nodes (176): ArchetypeScene, MainMenuSceneReference, Option, PresentationCatalog, actor_combat_visual(), actor_detail_budget(), actor_scene_budget(), advance_falling_fish() (+168 more)
...
Cohesion: 0.06
Nodes (55): BTreeSet, TwitchConfig, secrets_restart_requirements(), bot_and_broadcaster_tokens_use_distinct_vault_entries(), broadcaster_oauth_uses_only_the_stream_key_scope(), channel_point_reward_tag_survives_privmsg_conversion(), CredentialVault, DeviceAuthorization (+47 more)
...
Cohesion: 0.08
Nodes (52): ArchetypeBounds, ArchetypeDef, ArchetypeKind, AuthoredRecord, AuthoredValue, BuildingDef, BuildingModelDef, ContentError (+44 more)
...
Cohesion: 0.06
Nodes (57): ObjectiveDef, ObjectiveKind, Display, FromStr, StableId, authored_trade_rates_clamp_to_stock_gold_and_capacity(), building_damage_and_repair_preserve_health_bounds(), BuildingState (+49 more)
...
### Community 29 - "Utils"
Cohesion: 0.04
Nodes (11): int, ChangeTimeStamp, DataStructures, TownGoal.Enumerations, Utils, SavingAndLoading, SavingAndLoading.Structs, GameResources (+3 more)

### Community 30 - "MenuRuntime"
Cohesion: 0.04
Nodes (139): AccessibilityActionRequest, AccessibilityFocusVisualQuery, AnyResult, AppExit, DirectBroadcastControl, accessibility_button_enabled(), accessibility_input(), accessibility_scope_active() (+131 more)
...
Cohesion: 0.03
Nodes (104): BackgroundColor, AccessibilityMotionDefaults, authored_main_ui_image_with_ppu(), authored_ui_image(), authored_ui_image_with_corner_scale(), BoundsMaterialExtension, BoundsMaterialUniform, BuildingMaterialExtension (+96 more)
...
### Community 43 - "GeneratedWorld"
Cohesion: 0.12
Nodes (45): generate_world(), GeneratedWorld, authored_assignment_penalty_spreads_farmers_across_farms(), battering_ram_targets_and_damages_buildings_from_authored_mask(), builder_completes_and_upgrades_authored_construction(), building_approach(), building_base_max_health(), building_region() (+37 more)
...
Cohesion: 0.07
Nodes (89): GameConfig, GameplayConfig, BTreeMap, ContentCatalog, GridPos, ActorState, String, ActionPresentation (+81 more)
...
Cohesion: 0.07
Nodes (16): AudioHandler, AudioClip, AudioSource, bool, Camera, float, PlayerAudioHandler, ContainerBuilder (+8 more)
...
### Community 57 - "UserInterface_Event"
Cohesion: 0.11
...
Cohesion: 0.02
Nodes (86): CameraProcessor, CellSpacePartitioningInstaller, ContainerBuilder, ContainerBuilder, InstantiationBarrier, ContainerBuilder, MetaDataInstaller, PersistentScoped (+78 more)
...
Cohesion: 0.07
Nodes (17): Dictionary, IEnumerator, List, SerializableDictionary, SerializableKeyValuePair, Color, float, string (+9 more)
...
### Community 74 - "setup_rendering"
Cohesion: 0.05
Nodes (72): AmbientLight, ActiveMaterialHandles, building_snow_strength(), CharacterBaseMaterialCache, CharacterBaseMaterialVariant, chimney_alpha_progress(), cosmetic_color(), CosmeticMaterialCache (+64 more)
...
### Community 82 - "Target"
Cohesion: 0.13
Nodes (10): UserInterface.MainMenu, Target, Utils.Pooling, Sensors, GridSystem.Partitioning, Combat, Environment, SavingAndLoading.SavableObjects (+2 more)

### Community 83 - "DirectBroadcastRuntime"
Cohesion: 0.08
Nodes (36): apply_direct_broadcast_control(), AuthorizationEvent, bandwidth_test_never_claims_to_be_publicly_live(), begin_twitch_live_verification(), BroadcastMetricsSnapshot, BroadcastPrerequisites, BroadcastTarget, DirectBroadcastPhase (+28 more)
...
### Community 87 - "TidalPcmMix"
Cohesion: 0.32
Nodes (5): VecDeque, stream_only_music_tap_mixes_pre_monitor_pcm_into_wasapi_audio(), stream_only_music_tap_resamples_to_the_twitch_clock(), TidalPcmMix, NativeAudioFrame

### Community 88 - "PlayerSettings"
Cohesion: 0.07
Nodes (57): AudioMixSettings, BuildingHealthDisplayMode, CameraSettings, clamp_sensitivity(), clamp_unit(), default_ui_scale_percent(), defaults_are_valid_and_round_trip(), imports_unity_json_indices_and_clamps_values() (+49 more)
...
### Community 92 - "World.Generation.Settings"
Cohesion: 0.05
Nodes (30): CampGenerationSettings, List, CampGenerationSettingsContainer, FoliageGenerationSettings, List, FoliageGenerationSettingsContainer, List, ResourceGenerationSettings (+22 more)

### Community 93 - "IRuntimeDataScriptable"
Cohesion: 0.06
Nodes (25): TargetSettings, ContainerBuilder, TargetSettingsInstaller, Container, ContainerBuilder, TargetProcessor, Queue, AudioRuntimeData (+17 more)
...
Cohesion: 0.04
Nodes (28): DontDestroyOnLoad, ContainerBuilder, LoadType, MetaData, bool, string, MainMenuRuntimeData, Dictionary (+20 more)

### Community 107 - "Res"
Cohesion: 0.04
Nodes (156): AnimationTransitions, actor_material(), ActorHealthOverlay, ActorNameOverlay, agent_is_moving(), AgentAnimation, AgentCommandQueue, animate_agents() (+148 more)
...
### Community 119 - "GridProcessor"
Cohesion: 0.24
Nodes (3): Container, ContainerBuilder, GridProcessor

### Community 120 - "VoteEvent"
Cohesion: 0.09
Nodes (17): List, KeepKingVote, int, List, NewKingVote, PlayerVote, Dictionary, TechVote (+9 more)
...
### Community 126 - "effective_role_stats"
Cohesion: 0.15
Nodes (17): RoleProgress, Default, action_animation_speed(), action_cooldown(), actor_movement_speed(), building_construction_cost(), building_cost_reduction_percent(), building_upgrade_cost() (+9 more)
...
Cohesion: 0.16
Nodes (31): AtomicBool, AudioFrame, AudioInput, BroadcastController, BroadcastMetrics, capture_process_audio(), discard_pending_audio(), encode_broadcast_session() (+23 more)

### Community 132 - "PlayerControls"
Cohesion: 0.14
...
### Community 134 - "SelectedPlayerGroup"
Cohesion: 0.17
...
### Community 153 - ".UserIsSubscribed"
Cohesion: 0.15
...
### Community 162 - "GameStateProcessor"
Cohesion: 0.19
Nodes (3): Container, ContainerBuilder, GameStateProcessor

### Community 163 - ".RenderResourceType"
Cohesion: 0.18
...
Cohesion: 0.06
Nodes (21): AnimationHandler, Animator, bool, Dictionary, float, int, bool, int (+13 more)
...
Cohesion: 0.02
Nodes (96): ContainerBuilder, BuildingConfigSettingsInstaller, ContainerBuilder, CampGenSettingsInstaller, ContainerBuilder, FoliageGenSettingsInstaller, ContainerBuilder, GameEventConfigSettingsInstaller (+88 more)
...
### Community 194 - "Processors"
Cohesion: 0.07
Nodes (7): BuildCostModifier, PlayerControls.ObjectSelection, Units, Processors, Level, Buildings, Audio

### Community 195 - "STStateMachine.States"
Cohesion: 0.09
...
### Community 198 - "ProcessorStartupReport"
Cohesion: 0.67
...
### Community 208 - "PassiveResourceIncrementer"
Cohesion: 0.24
...
Cohesion: 0.12
Nodes (14): GlobalAudioController, AudioSource, bool, float, IEnumerator, SeasonAudioData, AudioClip, List (+6 more)

### Community 211 - "GridGraph"
Cohesion: 0.31
Nodes (3): Action, GridGraph, ResourceData[]&gt;
...
Cohesion: 0.04
Nodes (84): AccessibleNode, AssetId, AccessibilityAnnouncement, AccessibilityRuntime, active_event_text(), announce_accessibility_state(), authored_rotating_node_names(), AuthoredCreditsElement (+76 more)
...
### Community 276 - "ResourceDataSettings"
Cohesion: 0.25
...
### Community 289 - "EventProcessor"
Cohesion: 0.25
Nodes (4): Action, Container, ContainerBuilder, EventProcessor

### Community 290 - "PlayerRoleData"
Cohesion: 0.11
...
Cohesion: 0.07
Nodes (36): amf_quality_profile_keeps_static_grid_detail_between_keyframes(), average_milliseconds(), bandwidth_test_url_is_constructed_without_logging_the_key(), build_ingest_url(), CadenceTick, configure_amf_quality(), configure_direct_broadcast(), DirectBroadcastSnapshot (+28 more)
...
Cohesion: 0.13
Nodes (26): authoring_snapshot(), AuthoringSnapshot, poll_tool_job_events(), push_authoring_undo(), redo_authoring_edit(), refresh_catalog_drafts(), refresh_foliage_draft(), refresh_technology_draft() (+18 more)

### Community 300 - "Character"
Cohesion: 0.07
Nodes (20): ActivityStatus, bool, float, string, UserType, TwitchUser, Color, GameUserType (+12 more)

### Community 302 - "player_window_mode"
Cohesion: 0.67
...
### Community 304 - "animate_loading_icon"
Cohesion: 0.67
...
### Community 318 - "capture_direct_broadcast_frame"
Cohesion: 0.14
Nodes (11): capture_direct_broadcast_frame(), duration_as_micros(), publish_stream_only_frame(), Duration, Error, On, Time, SensitiveScreenActive (+3 more)
...
## Knowledge Gaps
- **380 isolated node(s):** `StreamTown.EditorTools`, `Attributes`, `BuildCostModifier`, `StartupState`, `InputButton` (+375 more)
...
- **Why does `Utils` connect `Utils` to `PlayerControls`, `EnemySpawner`, `TechTree.Elements`, `.CreateEnumField`, `GenerationSettings`, `UpdateGraphBounds`, `Character`, `SimpleScreenShot`, `MonoBehaviour`, `CommonEnums.cs`, `CameraController`, `Processors`, `STStateMachine.States`, `ScriptablesEditor`, `ScriptablesProcessorInfrastructure`, `BuildingPlacer`, `Target`, `SnapToGridMouseMovement`, `FPSDisplay`, `UnitTextDisplay`, `Editor`, `UserInterface`, `RandomEnabler`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `StableId` connect `StableId` to `Vec`, `String`, `Query`, `stream_town_game/src/lib.rs`, `advance_world_loading_cover`, `config.rs`, `save.rs`, `Option`, `command.rs`, `twitch.rs`, `world.rs`, `stream_town_domain/src/content.rs`, `Option`, `tools_ui`, `update_vote_panels`, `TechnologyGraphViewState`, `GeneratedWorld`, `AnimationControllerDef`, `runtime_console.rs`, `String`, `ContentCatalog`, `ToolState`, `stream_town_migrate/src/presentation.rs`, `Result`, `stream_town_migrate/src/menu_scene.rs`, `stream_town_migrate/src/content.rs`, `setup_rendering`, `stream_town_domain/src/presentation.rs`, `String`, `Res`, `.default`, `effective_role_stats`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `PlayerProcessor` connect `PlayerProcessor` to `RoleHandler`, `BuildingProcessor`, `IProcessor`, `EnemySpawner`, `SelectedPlayerGroup`, `TwitchChatProcessor`, `BottomBarInterface`, `UserInterface_Debug`, `HealthHandler`, `WorldGenProcessor`, `PlayerRoleData`, `TechTreeProcessor`, `Player`, `StreamTownSessionBridge`, `TwitchClientProcessor`, `UIProcessor`, `UserInterface_Event`, `MonoBehaviour`, `.Log`, `UserInterface_TownVote`, `BuildingPlacer`, `Target`, `GameEvent`, `Resource`, `SaveProcessor`, `TimeProcessor`, `SelectedPlayer`, `GameEventProcessor`, `VoteEvent`?**
