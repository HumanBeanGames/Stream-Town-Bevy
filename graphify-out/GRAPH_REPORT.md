...
## Corpus Check
- 623 files · ~1,622,771 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7290 nodes · 19415 edges · 279 communities (253 shown, 26 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 1003 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `763589ba`
...
### Community 0 - "Vec"
Cohesion: 0.06
Nodes (52): AnimationNodeIndex, AnimationPlayer, advance_animation_crossfade(), animation_event_occurrences(), animation_nodes_for_selection(), apply_animation_blend(), building_instance_ids(), BuildingMaterialInstance (+44 more)
...
### Community 2 - "Res"
Cohesion: 0.05
Nodes (160): AccumulatedMouseMotion, AccumulatedMouseScroll, Added, AmbientLight, AnimationGraph, AnimationGraphHandle, AppExit, Assets (+152 more)
...
Cohesion: 0.13
Nodes (32): ArchetypeBounds, AuthoredRecord, AuthoredValue, BuildingDef, BuildingModelDef, ContentError, EnemyDef, EnemySpawnerDef (+24 more)

### Community 5 - "UserInterface"
Cohesion: 0.06
Nodes (19): InputButton, SharedTypes, Slider, TextMeshProUGUI, UI_Objective, TextMeshProUGUI, UI_VoteObjectiveRow, Image (+11 more)
...
### Community 12 - "retargeted_animation_clip"
Cohesion: 0.12
Nodes (28): AnimationClip, AnimationTargetId, add_rotation_curve(), add_scale_curve(), add_translation_curve(), bottom_bar_action_buttons(), bottom_bar_main_buttons(), bottom_bar_scroll_buttons() (+20 more)

### Community 13 - "Option"
Cohesion: 0.04
Nodes (99): ArchetypeDef, ArchetypeKind, ArchetypeScene, StreamUserType, active_event_text(), actor_detail_budget(), animated_pets_resolve_their_own_unity_controllers_and_rigs(), animation_property_value() (+91 more)
...
Cohesion: 0.05
Nodes (80): App, generate_world(), authored_building_nodes_follow_construction_age_and_storage_fill(), bounds_material(), building_bounds_material_preserves_unity_placement_contract(), building_material(), cloud_material(), converted_technology_modifiers_change_runtime_rules() (+72 more)
...
Cohesion: 0.09
Nodes (24): authored_trade_rates_clamp_to_stock_gold_and_capacity(), building_damage_and_repair_preserve_health_bounds(), BuildingState, complete_gameplay_scenario_round_trips(), default_ruler_vote_cooldown(), deterministic_fish_god_value(), enemy_camps_and_raid_progress_round_trip_with_stable_archetypes(), fish_god_progress_rewards_food_unlocks_pet_and_expires() (+16 more)

### Community 19 - "RenderAssets"
Cohesion: 0.10
Nodes (82): AssetServer, GameConfig, PresentationCatalog, actor_material(), actor_scene_budget(), building_age(), building_effect_material(), BuildingEffectKind (+74 more)
...
Cohesion: 0.08
Nodes (13): PlayerDeathHandler, bool, float, Vector3, int, STSM_Helper_Attack, Action, bool (+5 more)
...
### Community 26 - "Handle"
Cohesion: 0.07
Nodes (40): bottom_bar_texture(), BoundsMaterialExtension, BoundsMaterialUniform, BuildingMaterialExtension, BuildingMaterialUniform, CloudMaterialExtension, CloudMaterialUniform, CritterMaterialExtension (+32 more)
...
Cohesion: 0.02
Nodes (150): AnyResult, ActionPresentation, actor_combat_visual(), adjust_settings_menu(), AgentCommand, AgentCommandQueue, AgentEquipmentPresentation, AmbienceAudio (+142 more)
...
### Community 34 - "ResourceStorageModifier"
Cohesion: 0.13
...
Cohesion: 0.06
Nodes (101): ContentCatalog, GridPos, ActorState, String, GeneratedWorld, action_animation_speed(), action_cooldown(), actor_accepts_resource() (+93 more)
...
Cohesion: 0.11
Nodes (14): SimpleToggleCarry, AddEquipmentSet(), CharacterModelHandler, bool, int, List, Transform, RoleEquipment (+6 more)
...
### Community 46 - "StableId"
Cohesion: 0.17
Nodes (10): FromStr, StableId, capped_deposit_preserves_inventory_overflow(), BTreeMap, Result, SimulationError, stable(), TechVote (+2 more)

### Community 47 - "legacy.rs"
Cohesion: 0.17
Nodes (39): ActorCustomization, binary_fixture(), BinaryParser, decode_json(), json_active_goal(), json_buildings(), json_customization(), json_enemies() (+31 more)
...
### Community 69 - "WorldSimulation"
Cohesion: 0.10
Nodes (18): deterministic_weather(), EnemyCampState, ObjectiveProgress, RaidState, BTreeSet, Option, Vec, VecDeque (+10 more)

### Community 70 - "CommonEnums.cs"
Cohesion: 0.08
Nodes (22): List, Vector3, List, Dictionary, List, TargetRuntimeData, TargetableData, Dictionary (+14 more)
...
Cohesion: 0.04
Nodes (34): DepositResources, PlayerInventory, Dictionary, ResourceInventory, bool, int, int, ActiveResourceIncrementer (+26 more)
...
### Community 121 - "Enemy"
Cohesion: 0.06
Nodes (22): Action, float, Enemy, Animator, GameObject, IEnumerator, int, FishGodEvent (+14 more)
...
### Community 131 - "Processors"
Cohesion: 0.05
Nodes (14): ObjectSelectionProcessor, InputButton, Transform, PlayerSpawnPoint, UserInterface.MainMenu, Processors, World, Processors.Editor (+6 more)

### Community 132 - "RoleData"
Cohesion: 0.08
Nodes (20): RoleData, AudioClip, bool, float, int, Sprite, string, AudioClip (+12 more)

### Community 133 - "IProcessor"
Cohesion: 0.06
Nodes (15): Container, ContainerBuilder, GridProcessor, Container, IProcessor, Action, Container, ContainerBuilder (+7 more)

### Community 134 - "ConfirmCheck"
Cohesion: 0.21
Nodes (5): Button, GameObject, TMP_Text, UnityAction, ConfirmCheck

### Community 135 - "Twitch"
Cohesion: 0.08
...
Cohesion: 0.04
Nodes (42): Container, ContainerBuilder, GUIDProcessor, Action, CancellationToken, Exception, Task, IAsyncInitializableProcessor (+34 more)
...
Cohesion: 0.10
Nodes (12): Container, ContainerBuilder, DayAndNightProcessor, float, Material, Volume, DayAndNightSettings, IPostInitializeProcessor (+4 more)
...
### Community 156 - ".EnsureValidCredentials"
Cohesion: 0.19
...
Cohesion: 0.09
Nodes (18): Container, ContainerBuilder, GameStateProcessor, Queue, AudioRuntimeData, CreditsRuntimeData, UnityEvent, DebugRuntimeData (+10 more)

### Community 165 - "MiscCommands"
Cohesion: 0.15
Nodes (5): Dictionary, MiscCommands, Dictionary, MessageSender, EnemyType

### Community 166 - "ResourceProcessor"
Cohesion: 0.16
...
### Community 168 - "WorldInstanceDeterminism"
Cohesion: 0.24
...
Cohesion: 0.14
Nodes (17): clamped_cell(), ImportReport, json_pet_name(), legacy_objective_matches(), legacy_pet_name(), LegacyGoal, LegacyObjective, nearest_walkable() (+9 more)

### Community 171 - "ResourceRuntimeData"
Cohesion: 0.32
Nodes (11): Dictionary, float, List, Material, materialIndex, materials, Matrix4x4, Mesh (+3 more)

### Community 172 - "STSM_Idle"
Cohesion: 0.17
...
### Community 188 - "TL_Secrets"
Cohesion: 0.35
Nodes (3): string, TL_Secrets, TwitchCredentialData

### Community 189 - ".UserIsSubscribed"
Cohesion: 0.15
...
### Community 203 - ".InitializeAndActivateProcessorsAsync"
Cohesion: 0.17
...
### Community 210 - "BuildingDamageMaterialHandler"
Cohesion: 0.29
...
### Community 212 - "WorldGenRuntimeData"
Cohesion: 0.20
...
### Community 224 - "CreditsProcessor"
Cohesion: 0.28
...
### Community 240 - "FoliageGroupSaveData"
Cohesion: 0.38
Nodes (6): int, List, string, FoliageGroupSaveData, FoliageInstanceSaveData, FoliageProcessorSaveData

### Community 243 - "SaveProcessor"
Cohesion: 0.04
Nodes (51): Action, CancellationToken, Component, Container, ContainerBuilder, Dictionary, float, List (+43 more)
...
### Community 273 - "Utils"
Cohesion: 0.04
Nodes (21): BuildCostModifier, DisableOnAwake, SelectionBase, List, SimpleEventOnStart, SimpleHideRendererOnAwake, GameObject, SimpleRandomModelEnabled (+13 more)

### Community 276 - "MonoBehaviour"
Cohesion: 0.02
Nodes (109): CameraProcessor, CellSpacePartitioningInstaller, ContainerBuilder, ContainerBuilder, InstantiationBarrier, ContainerBuilder, MetaDataInstaller, PersistentScoped (+101 more)
...
Cohesion: 0.03
Nodes (72): int, AudioSettings, List, CampGenSettings, List, FoliageGenSettings, bool, ParticleSystem (+64 more)
...
## Knowledge Gaps
- **267 isolated node(s):** `StreamTown.Migration`, `StreamTown.EditorTools`, `Attributes`, `BuildCostModifier`, `StartupState` (+262 more)
...
- **Why does `SaveProcessor` connect `SaveProcessor` to `BuildingProcessor`, `IProcessor`, `SettingsProcessor`, `WorldGenProcessor`, `ObjectPoolingProcessor`, `MonoBehaviour`, `PlayerProcessor`, `ScriptableObject`, `SaveFileData`, `GameEventProcessor`, `PlayerRole`, `ResourceProcessor`, `TechTreeProcessor`, `StreamTownSessionBridge`, `TimeProcessor`, `SeasonProcessor`, `FoliageProcessor`, `UserInterface_GameMenu`, `Target`, `TownGoalProcessor`, `MainMenuManager`, `WorldSaveData`, `Resource`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `WorldGenProcessor` connect `WorldGenProcessor` to `BuildingProcessor`, `.InjectRuntimeData`, `IProcessor`, `TwitchChatProcessor`, `ObjectPoolingProcessor`, `MonoBehaviour`, `PlayerProcessor`, `ScriptableObject`, `TerrainGenSettings`, `UserInterface_Debug`, `IRuntimeDataScriptable`, `ResourceProcessor`, `WorldInstanceDeterminism`, `ResourceData`, `TwitchClientProcessor`, `Player`, `.StartupSequence`, `Access_Dropdown`, `WorldGenRuntimeData`, `.GenerateFromSettings`, `CellSpacePartitioning`, `FoliageProcessor`, `Target`, `EnemySpawner`, `SaveProcessor`, `Enemy`, `AIPath`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `Player` connect `Player` to `BuildingProcessor`, `BuildingRuntimeData`, `RoleData`, `TwitchChatProcessor`, `Twitch`, `ObjectPoolingProcessor`, `Pet`, `BuildingPlacer`, `PlayerProcessor`, `HealthHandler`, `RoleHandler`, `GameEventProcessor`, `Station`, `PlayerRole`, `UserInterface_Debug`, `CommandDictionary`, `MiscCommands`, `CharacterModelHandler`, `StreamTownSessionBridge`, `LabelDisplayProcessor`, `BuildingBase`, `UserInterface_DisplayUsernames`, `TargetSensor`, `Target`, `Targetable`, `SaveProcessor`, `VoteEvent`?**
...
- **Should `Res` be split into smaller, more focused modules?**
  _Cohesion score 0.047720125786163525 - nodes in this community are weakly interconnected._