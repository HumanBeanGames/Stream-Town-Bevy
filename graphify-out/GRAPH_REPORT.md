...
## Corpus Check
- 603 files · ~1,536,139 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6207 nodes · 14695 edges · 270 communities (247 shown, 23 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 985 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1f053676`
...
Cohesion: 0.04
Nodes (57): int, AudioSettings, List, CampGenSettings, List, FoliageGenSettings, bool, ParticleSystem (+49 more)

### Community 3 - "Processors"
Cohesion: 0.06
Nodes (13): GridProcessorEditor, ObjectSelectionProcessor, InputButton, UserInterface.MainMenu, Processors, Processors.Editor, MetaData, Audio (+5 more)
...
Cohesion: 0.09
Nodes (14): Action, bool, double, object, EventType, GameEvent, SortGameEventStartTime, bool (+6 more)
...
Cohesion: 0.11
Nodes (8): PlayerDeathHandler, bool, float, Vector3, RoleHandler, bool, Dictionary, UnityEvent
...
### Community 47 - "TransformSaveData"
Cohesion: 0.10
...
Cohesion: 0.08
Nodes (36): round_trips_through_serde(), Err, Formatter, FromStr, Into, Result, Self, String (+28 more)
...
### Community 83 - "VfxAnimationController"
Cohesion: 0.06
Nodes (15): PersistentScoped, Transform, PlayerSpawnPoint, Image, TextMeshProUGUI, UIRoleDisplay, GameObject, SimpleRandomModelEnabled (+7 more)
...
Cohesion: 0.06
Nodes (19): AnimationHandler, Animator, bool, Dictionary, float, int, RotationHandler, float (+11 more)

### Community 91 - "GridPos"
Cohesion: 0.09
Nodes (35): can_plan_for_three_hundred_agents(), DirtyRegion, grid(), GridPos, manhattan(), NavGrid, NavigationError, OpenNode (+27 more)

### Community 92 - "PlayerSaveData"
Cohesion: 0.06
Nodes (28): Component, Dictionary, Mesh, Transform, Vector3, SaveDataMapper, bool, int (+20 more)

### Community 93 - "FoliageGenerationSettings.cs"
Cohesion: 0.50
...
Cohesion: 0.06
Nodes (90): AmbientLight, AppExit, ActorAnimationDriver, Agent, AgentAnimation, animate_weather_particles(), broadcaster_gate_precedes_twitch_command_dispatch(), camera_controls() (+82 more)
...
### Community 133 - ".RestoreWorldState"
Cohesion: 0.20
...
Cohesion: 0.12
Nodes (37): AnimationGraph, Assets, AssetServer, actor_material(), animate_agents(), animation_root_name(), converted_asset_exists(), debug_start_day() (+29 more)

### Community 138 - "PlayerRoleData"
Cohesion: 0.10
Nodes (9): PlayerRoleData, AudioClip, bool, float, int, StatModifiers, Dictionary, List (+1 more)

### Community 139 - "TargetProcessor"
Cohesion: 0.20
...
### Community 162 - "run"
Cohesion: 0.27
Nodes (9): App, embedded_presentation(), locate_asset_root(), PathBuf, run(), RuntimeAssetRoot, StreamTownGamePlugin, ClearColor (+1 more)
...
Cohesion: 0.24
Nodes (12): ChatCommand, CommandParseError, no_argument(), Err, FromStr, Option, Result, Self (+4 more)
...
Cohesion: 0.12
Nodes (21): AnyResult, ConfigError, default_configuration_is_valid_and_round_trips_ron(), enabled_twitch_requires_public_configuration(), GameConfig, GameplayConfig, BTreeMap, Default (+13 more)
...
### Community 191 - ".DrawDataFieldAndLabel"
Cohesion: 0.28
...
Cohesion: 0.09
Nodes (21): Vector3, List, Dictionary, List, TargetRuntimeData, TargetableData, Dictionary, List (+13 more)
...
### Community 210 - "LabelDisplayProcessor"
Cohesion: 0.32
...
### Community 212 - ".RenderFoliageType"
Cohesion: 0.32
...
### Community 221 - "PlayerInputRuntimeData"
Cohesion: 0.33
...
Cohesion: 0.09
Nodes (44): AnimationClip, AnimationGraphHandle, AnimationNodeIndex, AnimationPlayer, AnimationTargetId, add_rotation_curve(), add_scale_curve(), add_translation_curve() (+36 more)
...
### Community 228 - "TechTreeSearchWindow"
Cohesion: 0.32
...
### Community 239 - "AllRoleDataSettings"
Cohesion: 0.29
...
Cohesion: 0.02
Nodes (79): CameraProcessor, CellSpacePartitioningInstaller, ContainerBuilder, ContainerBuilder, InstantiationBarrier, ContainerBuilder, MetaDataInstaller, Camera (+71 more)
...
- **Why does `SaveProcessor` connect `SaveProcessor` to `BuildingProcessor`, `ScriptableObject`, `DebugProcessor`, `.RestoreWorldState`, `MonoBehaviour`, `SettingsProcessor`, `WorldGenProcessor`, `Resource`, `WorldSaveData`, `PlayerRole`, `Character`, `PlayerProcessor`, `ResourceDataSaveData`, `GameEventProcessor`, `SaveFileData`, `GUIDProcessor`, `TechTreeProcessor`, `TimeProcessor`, `SeasonProcessor`, `ResourceProcessor`, `StreamTownSessionBridge`, `.RestoreObjectiveProgress`, `IProcessor`, `FoliageProcessor`, `PlayerSaveData`, `MainMenuManager`, `TownGoalProcessor`, `ResourceGenerationSettings`, `UserInterface_GameMenu`, `.Log`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `WorldGenProcessor` connect `WorldGenProcessor` to `BuildingProcessor`, `ScriptableObject`, `DebugProcessor`, `TwitchChatProcessor`, `MonoBehaviour`, `TerrainGenSettings`, `GridProcessor`, `.GenerateFromSettings`, `PlayerProcessor`, `GUIDProcessor`, `CellSpacePartitioning`, `UserInterface_Debug`, `SaveProcessor`, `ResourceProcessor`, `TwitchClientProcessor`, `Access_Dropdown`, `IRuntimeDataScriptable`, `RaidEvent`, `IProcessor`, `WorldGenDebugSettings`, `Buildings`, `GridGraph`, `FoliageProcessor`, `PlayerSaveData`, `Player`, `DayAndNightProcessor`, `ResourceGenerationSettings`, `.Log`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `SettingsProcessor` connect `SettingsProcessor` to `ScriptablesProcessorInfrastructure`, `GraphicsProcessor`, `Access_Slider`, `IProcessor`, `SettingsData`, `SaveProcessor`, `MainMenuManager`, `MonoBehaviour`, `UIElementWrapper`, `Access_GOList`, `Access_Text`, `SaveState`, `Access_Dropdown`, `Autosave`, `UserInterface_GameMenu`?**
