...
## Corpus Check
- 603 files · ~1,540,658 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6252 nodes · 14972 edges · 285 communities (248 shown, 37 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 987 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `deb37cf0`
...
Cohesion: 0.09
Nodes (61): AppExit, Agent, AgentAnimation, animate_agents(), animate_weather_particles(), camera_controls(), capture_screenshot(), CommandFeedback (+53 more)
...
### Community 15 - "PlayerRuntimeData"
Cohesion: 0.47
...
Cohesion: 0.10
Nodes (18): int, List, string, uint, BuildingSaveData, int, string, uint (+10 more)
...
Cohesion: 0.15
Nodes (29): ArchetypeBounds, ArchetypeDef, ArchetypeKind, ArchetypeScene, AuthoredRecord, AuthoredValue, BuildingDef, ContentCatalog (+21 more)
...
Cohesion: 0.11
Nodes (16): Action, CancellationToken, Container, ContainerBuilder, float, List, Material, materials (+8 more)
...
### Community 51 - ".GetResourceTarget"
Cohesion: 0.18
...
Cohesion: 0.13
Nodes (27): FromStr, StableId, ActorState, BuildingState, capped_deposit_preserves_inventory_overflow(), complete_gameplay_scenario_round_trips(), deterministic_weather(), id() (+19 more)
...
Cohesion: 0.13
Nodes (14): int, TechTreeSettings, Action, bool, Dictionary, IEnumerable, List, TechnologyTree (+6 more)
...
### Community 83 - "PlayerSpawnPoint"
Cohesion: 0.06
Nodes (16): Transform, PlayerSpawnPoint, Slider, TextMeshProUGUI, UI_Objective, TextMeshProUGUI, UI_VoteObjectiveRow, Image (+8 more)
...
Cohesion: 0.08
Nodes (13): Component, Dictionary, materialIndex, meshIndex, Dictionary, Mesh, Transform, Vector3 (+5 more)
...
Cohesion: 0.10
Nodes (77): ArchetypesById, aged_buildings(), archetype_bounds(), archetype_kind(), archetype_scenes(), asset(), authored_value(), building_cost_reductions() (+69 more)
...
Cohesion: 0.06
Nodes (69): AnimationNodeIndex, AnimationPlayer, cell_hash(), changing_seed_changes_world_hash(), generate_world(), GeneratedResource, GeneratedWorld, generation_is_deterministic() (+61 more)
...
### Community 115 - "run"
Cohesion: 0.27
Nodes (10): App, embedded_presentation(), locate_asset_root(), PathBuf, run(), RuntimeAssetRoot, RuntimeContent, RuntimePresentation (+2 more)

### Community 116 - "Goal"
Cohesion: 0.11
Nodes (9): bool, Dictionary, float, int, TechTreeRuntimeData, EventType, Action, Dictionary (+1 more)

### Community 117 - ".Process"
Cohesion: 0.13
Nodes (12): Action, CancellationToken, Task, IAsyncInitializableProcessor, ProcessorStartupContext, Action, CancellationToken, Task (+4 more)
...
Cohesion: 0.06
Nodes (29): bool, BoxCollider, Container, ContainerBuilder, float, int, List, LoadSceneMode (+21 more)

### Community 126 - "generate_and_spawn_world"
Cohesion: 0.09
Nodes (46): AmbientLight, AnimationGraph, Assets, AssetServer, actor_material(), animation_root_name(), building_construction_stage(), BuildingPresentation (+38 more)
...
### Community 170 - ".SetGeneratedResources"
Cohesion: 0.40
...
### Community 199 - "Access_TextInput"
Cohesion: 0.29
...
Cohesion: 0.02
Nodes (85): CameraProcessor, CellSpacePartitioningInstaller, ContainerBuilder, ContainerBuilder, MetaDataInstaller, Camera, GameObject, ProjectCameraInstaller (+77 more)
...
### Community 272 - "BuildingRuntimeData"
Cohesion: 0.50
...
- **Why does `SaveProcessor` connect `SaveProcessor` to `BuildingProcessor`, `ScriptableObject`, `DebugProcessor`, `MonoBehaviour`, `SettingsProcessor`, `WorldGenProcessor`, `Character`, `PlayerProcessor`, `SaveFileData`, `GameEventProcessor`, `TechTreeProcessor`, `TimeProcessor`, `SeasonProcessor`, `ResourceProcessor`, `UIProcessor`, `GUIDProcessor`, `.SaveGameAsync`, `IProcessor`, `PlayerRole`, `FoliageProcessor`, `SaveDataMapper`, `MainMenuManager`, `TownGoalProcessor`, `Resource`, `UserInterface_GameMenu`, `ObjectPoolingProcessor`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `WorldGenProcessor` connect `WorldGenProcessor` to `BuildingProcessor`, `ScriptableObject`, `DebugProcessor`, `TwitchChatProcessor`, `MonoBehaviour`, `.GenerateFromSettings`, `PlayerProcessor`, `CellSpacePartitioning`, `UserInterface_Debug`, `SaveProcessor`, `GameStateProcessor`, `ResourceProcessor`, `TwitchClientProcessor`, `ProjectCamera`, `WorldGenRuntimeData`, `GUIDProcessor`, `RaidEvent`, `IProcessor`, `TerrainGenSettings`, `GridProcessor`, `Target`, `GridGraph`, `FoliageProcessor`, `SaveDataMapper`, `Player`, `EnemySpawner`, `.Process`, `ObjectPoolingProcessor`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `SettingsProcessor` connect `SettingsProcessor` to `ScriptablesProcessorInfrastructure`, `GraphicsProcessor`, `Access_Slider`, `IProcessor`, `SettingsData`, `SaveProcessor`, `MainMenuManager`, `Access_TextInput`, `MonoBehaviour`, `Access_Dropdown`, `Access_Toggle`, `Access_GOList`, `Access_Text`, `ProjectCamera`, `Autosave`, `UserInterface_GameMenu`?**
...
- **Should `ScriptableObject` be split into smaller, more focused modules?**
  _Cohesion score 0.0365296803652968 - nodes in this community are weakly interconnected._