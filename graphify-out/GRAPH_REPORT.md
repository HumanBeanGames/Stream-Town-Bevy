...
## Corpus Check
- 672 files · ~1,852,389 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9805 nodes · 30398 edges · 307 communities (283 shown, 24 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 1071 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `59128e74`
...
- CustomLogHandler
- LevelHandler
- .ApplyDeterministicResourceVisuals
- UpdateGraphBounds
...
Cohesion: 0.05
Nodes (118): GameConfig, GameplayConfig, BTreeMap, GeneratedFoliage, GeneratedWorld, active_station_ids(), actor_idle_anchor(), actor_movement_speed() (+110 more)
...
Cohesion: 0.03
Nodes (93): AccessibilityActionRequest, AccessibilityNode, AssetId, advance_loading_phase(), advance_loading_runtime(), advance_world_loading_cover(), asset_root_collection_ready(), authored_rotating_node_names() (+85 more)

### Community 5 - "stream_town_game/src/lib.rs"
Cohesion: 0.01
Nodes (330): AccessibleNode, accessibility_settings_selection(), AccessibilityActionDispatch, AccessibilityCandidate, AccessibilityHighContrastText, active_event_text(), actor_combat_visual(), actor_detail_budget() (+322 more)
...
### Community 17 - "Vec"
Cohesion: 0.04
Nodes (96): AnimationClip, AnimationTargetId, add_animation_composition(), add_animation_layer_branch(), add_rotation_curve(), add_scale_curve(), add_translation_curve(), advance_animation_crossfade() (+88 more)
...
Cohesion: 0.01
Nodes (118): CameraProcessor, CellSpacePartitioningInstaller, ContainerBuilder, ContainerBuilder, InstantiationBarrier, PersistentScoped, ContainerBuilder, Volume (+110 more)

### Community 21 - "NavGrid"
Cohesion: 0.09
Nodes (34): actor_specific_exception_opens_only_the_requested_blocked_cell(), calculate_topology_signature(), can_plan_for_three_hundred_agents(), diagonal_steps_do_not_cut_blocked_corners(), DirtyRegion, grid(), NavGrid, NavigationError (+26 more)
...
### Community 29 - "Ui"
Cohesion: 0.09
Nodes (57): animation_condition_mode_choice(), animation_controller_editor(), animation_events_editor(), animation_layer_blend_choice(), animation_layers_editor(), animation_parameter_kind_choice(), animation_parameters_editor(), animation_property_curves_editor() (+49 more)

### Community 30 - "Res"
Cohesion: 0.04
Nodes (214): Added, AnimatedBy, AnimationGraphHandle, AnimationTransitions, AudioSink, ActivePetVisual, ActorAnimationDriver, ActorNameOverlay (+206 more)

### Community 31 - "WorldGenProcessor"
Cohesion: 0.08
Nodes (13): Action, bool, BoxCollider, Container, GameObject, IEnumerable, int, IReadOnlyList (+5 more)

### Community 32 - "ResMut"
Cohesion: 0.03
Nodes (175): AccessibilityFocusVisualQuery, AnyResult, accessibility_button_enabled(), accessibility_input(), accessibility_scope_active(), accessibility_should_clear_focus(), AccessibilityAnnouncement, AccessibilityRuntime (+167 more)
...
### Community 35 - ".new"
Cohesion: 0.03
Nodes (184): generate_world(), generate_world_with_content(), accessibility_motion_preferences_preserve_authored_parameters(), accessibility_scope_keeps_modal_navigation_inside_the_open_surface(), accessibility_tagging_tolerates_ui_removed_before_deferred_annotation(), action_ranges_and_tower_acquisition_are_euclidean(), ActionPresentation, animated_pets_resolve_their_own_unity_controllers_and_rigs() (+176 more)

### Community 36 - "PlayerSettings"
Cohesion: 0.09
Nodes (41): AudioMixSettings, BuildingHealthDisplayMode, CameraSettings, clamp_sensitivity(), clamp_unit(), default_ui_scale_percent(), defaults_are_valid_and_round_trip(), DisplayMode (+33 more)
...
### Community 38 - "Option"
Cohesion: 0.04
Nodes (181): ArchetypeScene, MainMenuSceneReference, Option, PresentationCatalog, ActiveMaterialHandles, actor_material(), animation_property_value(), apply_authored_main_menu_camera() (+173 more)

### Community 39 - "BinarySaveCodec"
Cohesion: 0.09
Nodes (11): Action, CancellationToken, Func, int, List, UTF8Encoding, BinarySaveCodec, string (+3 more)
...
### Community 42 - "process_injected_commands"
Cohesion: 0.12
Nodes (37): building_blocks_navigation(), building_construction_cost(), building_cost_reduction_percent(), building_cost_summary(), building_definition_id(), building_instance_ids(), building_upgrade_cost(), buy_town_resource() (+29 more)

### Community 43 - "ContentCatalog"
Cohesion: 0.07
Nodes (78): ContentCatalog, ActorState, RoleProgress, Default, String, action_animation_speed(), action_cooldown(), actor_accepts_resource() (+70 more)
...
Cohesion: 0.09
Nodes (38): BroadcastConfig, BroadcastEncoderPreference, AudioFrame, AudioInput, BroadcastEncoder, BroadcastMetrics, BroadcastTarget, capture_process_audio() (+30 more)
...
Cohesion: 0.07
Nodes (85): SavedTerrainMesh, StreamUserType, absolute_path(), actor_prefix(), backup_candidate(), binary_fixture(), binary_schemas_one_through_three_decode_and_validate_trailer(), BinaryParser (+77 more)
...
Cohesion: 0.01
Nodes (125): ContainerBuilder, BuildingConfigSettingsInstaller, ContainerBuilder, CampGenSettingsInstaller, ContainerBuilder, FoliageGenSettingsInstaller, ContainerBuilder, GameEventConfigSettingsInstaller (+117 more)
...
Cohesion: 0.09
Nodes (47): ArchetypeBounds, ArchetypeDef, ArchetypeKind, AuthoredRecord, AuthoredValue, BuildingDef, BuildingModelDef, default_resource_generation_layers() (+39 more)
...
Cohesion: 0.10
Nodes (21): moderate_selected_operator_user(), operator_chat_scroll_rows(), Changed, Interaction, MouseWheel, send_operator_chat_message(), stream_operator_chat_controls(), stream_operator_settings_controls() (+13 more)
...
Cohesion: 0.04
Nodes (39): Station, Dictionary, float, int, List, Queue, Transform, Vector3 (+31 more)
...
### Community 85 - "BroadcastController"
Cohesion: 0.11
Nodes (24): AtomicBool, BroadcastController, capture_direct_broadcast_frame(), gpu_readback_padding_is_removed_without_corrupting_rows(), gpu_readbacks_are_published_in_render_order_even_when_they_finish_out_of_order(), publish_latest_video(), publish_stream_only_frame(), remove_gpu_row_padding() (+16 more)

### Community 86 - "runtime_console.rs"
Cohesion: 0.16
Nodes (20): invalid_requests_are_rejected_before_writing(), read_optional_json(), request_and_status_round_trip_through_atomic_store(), BTreeMap, Error, Into, Option, Path (+12 more)

### Community 87 - "TraversalWearRuntime"
Cohesion: 0.11
Nodes (30): SeasonalTerrainPalette, TerrainAppearanceConfig, autosave_game(), CommandSaveRuntime, foliage_should_be_hidden(), MovementStats, PathSurfaceRuntime, PlayerSettingsRuntime (+22 more)
...
### Community 95 - "Result"
Cohesion: 0.13
Nodes (31): animation_assets_editor(), apply_enemy_camp_generation_draft(), content_tab(), create_animation_clip(), create_animation_controller(), create_material_definition(), create_texture_definition(), delete_enemy_camp_generation_layer() (+23 more)
...
Cohesion: 0.05
Nodes (35): Action, CancellationToken, Component, Container, ContainerBuilder, float, List, Material (+27 more)
...
### Community 100 - "TownGoal.Data"
Cohesion: 0.08
Nodes (14): int, TechTreeSettings, ContainerBuilder, TechTreeSettingsInstaller, InputButton, SharedTypes, int, ChangeTimeStamp (+6 more)
...
### Community 103 - "IRuntimeDataScriptable"
Cohesion: 0.06
Nodes (24): CreditsRuntimeData, UnityEvent, DebugRuntimeData, bool, GameStateRuntimeData, IRuntimeDataScriptable, Dictionary, GameObject (+16 more)
...
### Community 108 - "Vec3"
Cohesion: 0.11
Nodes (31): animate_chimney_smoke_particles(), auto_camera_citizen_translation(), auto_camera_focus_translation(), BuildingEffectKind, BuildingEffectParticle, chimney_alpha_step(), chimney_particle_scale(), ChimneySmokeParticle (+23 more)
...
### Community 111 - ".ApplyDeterministicResourceVisuals"
Cohesion: 0.23
Nodes (4): List, Material, Mesh, Resource
...
Cohesion: 0.08
Nodes (16): Color, List, Texture2D, EditorUtils, bool, Color, Dictionary, GUIStyle (+8 more)

### Community 115 - "world.rs"
Cohesion: 0.08
Nodes (63): WorldGenConfig, ResourceGenerationHabitat, ResourceGenerationLayerDef, algorithmic_generation_matches_unity_validation_fingerprints(), authored_foliage_is_deterministic_and_respects_habitat_and_resources(), authored_grid_centre(), authored_world_to_grid(), avalanche_instance_hash() (+55 more)

### Community 116 - "RuntimePlayerSettings"
Cohesion: 0.08
Nodes (31): animate_fish_school(), animate_loading_icon(), animate_main_menu_clouds(), apply_loading_icon_rotation(), fish_school_noise_axis(), fish_school_transform(), FishSchoolParticle, game_menu_mouse_actions_use_authoritative_requests_and_settings() (+23 more)
...
Cohesion: 0.13
Nodes (39): ability_choices(), action_animation_choices(), add_archetype_scene(), building_model_node_choices(), buildings_tab(), cached_gltf_metadata(), content_tab_contents(), create_model_archetype() (+31 more)

### Community 123 - "CommonEnums.cs"
Cohesion: 0.09
Nodes (16): EnemyModelHandlerEditor, bool, int, List, EnemyModelHandler, Foliage, FoliageSaveType, FoliageType (+8 more)
...
Cohesion: 0.06
Nodes (45): amf_quality_profile_keeps_static_grid_detail_between_keyframes(), AuthorizationEvent, bandwidth_test_url_is_constructed_without_logging_the_key(), bounded_history_f32(), BroadcastPrerequisites, build_ingest_url(), configure_amf_quality(), draw_centered_label() (+37 more)
...
Cohesion: 0.13
Nodes (16): DirectBroadcastControl, exit_after_broadcast_stops(), operator_window_close_requests_exit(), poll_direct_broadcast_authorization(), request_automatic_broadcast_start(), return_to_main_menu_after_broadcast_stops(), AppExit, MessageReader (+8 more)
...
### Community 134 - "DirectBroadcastRuntime"
Cohesion: 0.11
Nodes (24): append_direct_broadcast_diagnostic(), append_direct_broadcast_diagnostic_to(), average_milliseconds(), bandwidth_test_never_claims_to_be_publicly_live(), begin_twitch_live_verification(), direct_broadcast_diagnostics_are_persisted_without_a_live_session(), direct_broadcast_log_path(), DirectBroadcastPhase (+16 more)
...
Cohesion: 0.10
Nodes (35): arm_stream_only_readback(), BroadcastMetricsSnapshot, camera_targets_primary_window(), cleanup_completed_stream_only_readbacks(), disarm_stream_only_readbacks(), Assets, Commands, Entity (+27 more)
...
Cohesion: 0.07
Nodes (66): GridPos, ActorKind, GeneratedResource, active_resource_at(), agent_path(), build_enemy_navigation_field(), build_fine_navigation(), building_fine_navigation_cells() (+58 more)
...
Cohesion: 0.07
Nodes (63): apply_building_draft(), authoring_apply_preserves_the_complete_local_twitch_setup(), authority_tab(), building_draft(), building_editor_preserves_the_complete_template_record(), BuildingDraft, canonical_preview_node_name(), character_model_choices_include_converted_hierarchy_nodes() (+55 more)
...
### Community 172 - "LiveVerification"
Cohesion: 0.19
Nodes (9): DirectTwitchBroadcastPlugin, LiveVerification, LiveVerificationEvent, LiveVerificationTarget, App, Drop, Plugin, Sender (+1 more)

### Community 173 - "Handle"
Cohesion: 0.04
Nodes (104): accessibility_navigation_preserves_editable_text_focus(), AccessibilityMotionDefaults, apply_authored_ui_fonts(), authored_main_ui_image_with_ppu(), authored_ui_image(), authored_ui_image_with_corner_scale(), BoundsMaterialExtension, BoundsMaterialUniform (+96 more)
...
Cohesion: 0.14
Nodes (25): AdaptiveMusicSignature, drive_tidal_music(), intensity_program_needs_update(), point_inside_viewport(), position_is_onscreen(), report_once(), Camera, GlobalTransform (+17 more)
...
Cohesion: 0.11
Nodes (19): AutomaticBroadcastStart, NativeGameAudioClip, NativeGameAudioMix, NativeGameAudioRouting, NativeGameAudioRoutingInner, NativeGameAudioState, NativeGameAudioVoice, pcm16_wav_clip() (+11 more)

### Community 212 - "BuildingDataSettings"
Cohesion: 0.18
Nodes (9): Dictionary, BuildingDataContainer, int, ResourceCostData, bool, float, Sprite, string (+1 more)

### Community 213 - "ToolState"
Cohesion: 0.07
Nodes (54): apply_foliage_draft(), apply_resource_generation_draft(), AssetEditorSection, authoring_config_save_bar(), broadcast_encoder_label(), delete_foliage_layer(), delete_resource_generation_layer(), duplicate_foliage_layer() (+46 more)
...
### Community 218 - "Behaviours"
Cohesion: 0.12
Nodes (9): AttackUnit, HealthModifier, bool, float, GameObject, HealUnit, UnitTravelToPosition, Vector3 (+1 more)
...
### Community 234 - "WorldGenRuntimeData"
Cohesion: 0.20
...
### Community 253 - "ResourceDataSettings"
Cohesion: 0.25
...
Cohesion: 0.11
Nodes (8): BuildingPlacerEditor, BuildingResourceModelHandlerEditor, string, ScriptableObjectAssetData, WindControllerEditor, GridSystemEditor, Globals, Editor
...
### Community 276 - "GenerationSettings"
Cohesion: 0.08
Nodes (20): Action, IEnumerator, Vector2, Noise, float, int, string, Vector2 (+12 more)
...
Cohesion: 0.08
Nodes (51): apply_preview_material_overrides(), apply_preview_node_visibility(), drive_model_preview_animation(), frame_model_preview(), ModelPreviewCamera, ModelPreviewRuntime, ModelPreviewScene, player_preview_material_overrides() (+43 more)
...
Cohesion: 0.12
Nodes (9): Api, TL_API, float, GameObject, IEnumerator, RandomEnabler, int, string (+1 more)

### Community 299 - "commit_catalog_candidate"
Cohesion: 0.15
Nodes (31): apply_objective_draft(), apply_technology_draft(), authoring_snapshot(), AuthoringSnapshot, commit_catalog_candidate(), connect_technology_nodes(), create_technology_group(), create_technology_node() (+23 more)
...
Cohesion: 0.09
Nodes (35): AmbientLight, authored_post_process_stack(), authored_rgb_filter(), blend_environment_palette(), building_snow_strength(), BuildingMaterialInstance, BuildingMaterialInstances, daylight_signature() (+27 more)
...
- **Why does `Utils` connect `Utils` to `SeasonProcessor`, `EnemySpawner`, `ScriptablesProcessorInfrastructure`, `MonoBehaviour`, `TechTree.Elements`, `StringUtils`, `MeshData`, `RoleHandler`, `RandomEnabler`, `AudioHandler`, `Easings`, `ScriptableObject`, `UnitTextDisplay`, `BuildingPlacer`, `SnapToGridMouseMovement`, `Behaviours`, `FPSDisplay`, `Resource`, `TownGoal.Data`, `IRuntimeDataScriptable`, `UpdateGraphBounds`, `.CreateEnumField`, `CommonEnums.cs`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `StableId` connect `StableId` to `GeneratedWorld`, `stream_town_domain/src/lib.rs`, `stream_town_migrate/src/content.rs`, `stream_town_game/src/lib.rs`, `convert_post_process`, `config.rs`, `Vec`, `command.rs`, `GridPos`, `String`, `ModelPreviewRuntime`, `Ui`, `Res`, `ResMut`, `xtask/src/main.rs`, `stream_town_tools/src/main.rs`, `.new`, `Option`, `process_injected_commands`, `ContentCatalog`, `AnimationControllerDef`, `Handle`, `commit_catalog_candidate`, `update_environment_presentation`, `BTreeMap`, `legacy.rs`, `stream_town_domain/src/content.rs`, `stream_town_migrate/src/menu_scene.rs`, `stream_town_migrate/src/presentation.rs`, `twitch.rs`, `technology_graph.rs`, `ToolState`, `runtime_console.rs`, `stream_town_domain/src/presentation.rs`, `Vec3`, `world.rs`, `String`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `PlayerProcessor` connect `PlayerProcessor` to `Enemy`, `BuildingProcessor`, `EnemySpawner`, `TwitchChatProcessor`, `BottomBarInterface`, `UserInterface_Debug`, `MonoBehaviour`, `PlayerRoleData`, `SelectedPlayerGroup`, `IProcessor`, `WorldGenProcessor`, `RoleHandler`, `TechTreeProcessor`, `UIProcessor`, `VoteEvent`, `Player`, `StreamTownSessionBridge`, `TwitchClientProcessor`, `GUIDProcessor`, `TimeProcessor`, `Utils`, `BuildingPlacer`, `GameEvent`, `.Log`, `Resource`, `SaveProcessor`, `GameEventProcessor`, `UserInterface_TownVote`?**
...
- **Should `GeneratedWorld` be split into smaller, more focused modules?**
  _Cohesion score 0.05388961321164711 - nodes in this community are weakly interconnected._
