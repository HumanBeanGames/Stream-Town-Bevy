...
## Corpus Check
- 629 files · ~1,628,845 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7397 nodes · 19785 edges · 283 communities (262 shown, 21 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 1006 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `76cd3167`
...
### Community 0 - "Target"
Cohesion: 0.11
Nodes (11): UserInterface.MainMenu, Units, Target, Utils.Pooling, Sensors, GridSystem.Partitioning, Combat, Environment (+3 more)
...
### Community 4 - "ResMut"
Cohesion: 0.06
Nodes (68): AppExit, AgentCommand, AgentCommandQueue, autosave_game(), bottom_bar_action_buttons(), bottom_bar_input(), bottom_bar_main_buttons(), bottom_bar_scroll_buttons() (+60 more)

### Community 5 - "update_environment_presentation"
Cohesion: 0.08
Nodes (39): AmbientLight, Assets, building_damage_intensity(), building_damage_value(), building_snow_strength(), BuildingMaterialInstance, BuildingMaterialInstanced, BuildingMaterialInstances (+31 more)
...
### Community 13 - "Handle"
Cohesion: 0.07
Nodes (43): BackgroundColor, bottom_bar_texture(), BoundsMaterialExtension, BoundsMaterialUniform, BuildingMaterialExtension, BuildingMaterialUniform, CloudMaterialExtension, CloudMaterialUniform (+35 more)
...
Cohesion: 0.07
Nodes (14): Func, BuildingDamageMaterialHandler, bool, IEnumerator, Renderer, int, STSM_Helper_Attack, Action (+6 more)
...
### Community 19 - "Res"
Cohesion: 0.03
Nodes (163): AccumulatedMouseMotion, AccumulatedMouseScroll, Added, AnimationGraphHandle, AudioSink, ActorNameOverlay, Agent, agent_action_animation() (+155 more)
...
### Community 26 - "String"
Cohesion: 0.05
Nodes (60): AnimationClip, AnimationGraph, AnimationTargetId, active_event_text(), add_animation_layer_branch(), add_rotation_curve(), add_scale_curve(), add_translation_curve() (+52 more)
...
Cohesion: 0.03
Nodes (155): AnyResult, App, generate_world(), adjust_settings_menu(), animate_healing_effects(), archetype_id_by_source(), authored_assignment_penalty_spreads_farmers_across_farms(), authored_building_nodes_follow_construction_age_and_storage_fill() (+147 more)
...
Cohesion: 0.04
Nodes (170): GameConfig, GameplayConfig, BTreeMap, ContentCatalog, FromStr, StableId, GridPos, ActorState (+162 more)
...
Cohesion: 0.27
Nodes (5): CharacterModelHandler, bool, int, List, Transform
...
### Community 46 - ".Log"
Cohesion: 0.05
Nodes (23): AttackUnit, HealthModifier, bool, float, GameObject, HealUnit, Container, ContainerBuilder (+15 more)
...
Cohesion: 0.05
Nodes (71): WorldGenConfig, FoliageHabitat, FoliageLayerDef, actor_specific_exception_opens_only_the_requested_blocked_cell(), can_plan_for_three_hundred_agents(), DirtyRegion, grid(), manhattan() (+63 more)
...
### Community 61 - "Option"
Cohesion: 0.07
Nodes (116): AssetServer, ArchetypeScene, PresentationCatalog, actor_detail_budget(), actor_material(), actor_scene_budget(), animated_pets_resolve_their_own_unity_controllers_and_rigs(), archetype_by_source() (+108 more)
...
Cohesion: 0.06
Nodes (37): ObjectiveDef, ObjectiveKind, authored_trade_rates_clamp_to_stock_gold_and_capacity(), building_damage_and_repair_preserve_health_bounds(), capped_deposit_preserves_inventory_overflow(), complete_gameplay_scenario_round_trips(), default_ruler_vote_cooldown(), deterministic_fish_god_value() (+29 more)
...
### Community 77 - "drive_converted_animations"
Cohesion: 0.13
Nodes (25): AnimationNodeIndex, AnimationPlayer, ActivePetVisual, ActorAnimationDriver, advance_animation_crossfade(), animation_event_occurrences(), animation_selection_duration(), apply_animation_blend() (+17 more)
...
Cohesion: 0.05
Nodes (151): ArchetypesById, ArchetypeBounds, ArchetypeDef, ArchetypeKind, AuthoredRecord, AuthoredValue, BuildingDef, BuildingModelDef (+143 more)

### Community 97 - "WorldGenSaveData"
Cohesion: 0.11
...
### Community 115 - "GameEventSettings"
Cohesion: 0.13
Nodes (10): ContainerBuilder, GameEventConfigSettingsInstaller, bool, ParticleSystem, Transform, GameEventSettings, ContainerBuilder, GameEventSettingsInstaller (+2 more)
...
Cohesion: 0.04
Nodes (12): BuildCostModifier, InputButton, PlayerControls.ObjectSelection, Processors, World, Level, MetaData, Buildings (+4 more)
...
### Community 131 - "TechnologyTreeGroup"
Cohesion: 0.23
...
### Community 133 - "ResourceRuntimeData"
Cohesion: 0.32
...
### Community 169 - "TownResourceRuntimeData"
Cohesion: 0.18
...
### Community 171 - "RoleEquipment"
Cohesion: 0.31
Nodes (6): AddEquipmentSet(), RoleEquipment, bool, GameObject, string, BodyType
...
### Community 174 - "TerrainGenSettings"
Cohesion: 0.22
...
Cohesion: 0.07
Nodes (25): ContainerBuilder, FoliageGenSettingsInstaller, ContainerBuilder, WaterFoliageGenSettingsInstaller, Material, materials, Mesh, meshes (+17 more)
...
Cohesion: 0.02
Nodes (60): Api, CameraProcessor, PersistentScoped, ContainerBuilder, TargetSettingsInstaller, Transform, PlayerSpawnPoint, TL_API (+52 more)

### Community 216 - "RuntimeData Template"
Cohesion: 0.33
Nodes (3): Checklist for New RuntimeData, RuntimeData Structure, RuntimeData Template

### Community 217 - "TimeSettings"
Cohesion: 0.33
Nodes (4): ContainerBuilder, TimeDataSettingsInstaller, int, TimeSettings

### Community 218 - "WorldGenScaleSettings"
Cohesion: 0.33
...
Cohesion: 0.10
Nodes (17): Action, CancellationToken, Container, ContainerBuilder, float, List, Task, SaveProcessor (+9 more)
...
### Community 262 - "STSM_Helper_Build"
Cohesion: 0.18
...
Cohesion: 0.03
Nodes (35): CellSpacePartitioningInstaller, ContainerBuilder, ContainerBuilder, InstantiationBarrier, ContainerBuilder, MetaDataInstaller, ContainerBuilder, Volume (+27 more)
...
Cohesion: 0.03
Nodes (55): ContainerBuilder, BuildingConfigSettingsInstaller, ContainerBuilder, WorldGenBehaviorSettingsInstaller, ContainerBuilder, WorldGenLayerSettingsInstaller, bool, List (+47 more)

### Community 281 - "Q: role level experience progression station equipment inventory skill upgrade"
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: role level experience progression station equipment inventory skill upgrade, Source Nodes

### Community 284 - "VfxAnimationController"
Cohesion: 0.29
...
- **Why does `SaveProcessor` connect `SaveProcessor` to `Target`, `BuildingProcessor`, `ResourceProcessor`, `SettingsProcessor`, `WorldGenProcessor`, `ObjectPoolingProcessor`, `IInstaller`, `PlayerProcessor`, `SaveFileData`, `GameEventProcessor`, `PlayerRole`, `SeasonProcessor`, `TechTreeProcessor`, `.Log`, `StreamTownSessionBridge`, `GameMasterCommands`, `FoliageGenerationSettings`, `TimeProcessor`, `MonoBehaviour`, `FoliageProcessor`, `UserInterface_GameMenu`, `GUIDProcessor`, `WorldGenSaveData`, `ResourceGenerationSettings`, `ResourceDataSaveData`, `TownGoalProcessor`, `MainMenuManager`, `WorldSaveData`, `IProcessor`, `Resource`, `PlayerSaveData`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `WorldGenProcessor` connect `WorldGenProcessor` to `Target`, `BuildingProcessor`, `TwitchChatProcessor`, `ResourceProcessor`, `ObjectPoolingProcessor`, `IInstaller`, `GameStateProcessor`, `PlayerProcessor`, `ScriptableObject`, `WorldGenRuntimeData`, `UserInterface_Debug`, `GridProcessor`, `TerrainGenSettings`, `.Log`, `ResourceData`, `TwitchClientProcessor`, `ProjectCamera`, `CampGenerationSettings`, `GameMasterCommands`, `WorldGenDebugSettings`, `FoliageGenerationSettings`, `.GenerateFromSettings`, `CellSpacePartitioning`, `MonoBehaviour`, `FoliageProcessor`, `WorldGenScaleSettings`, `GUIDProcessor`, `Coordinator`, `ResourceGenerationSettings`, `GameEvent`, `EnemySpawner`, `IProcessor`, `SaveProcessor`, `AIPath`, `PlayerSaveData`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `Player` connect `Player` to `Target`, `RoleData`, `TwitchChatProcessor`, `PoolableObject`, `HealthHandler`, `GameEventSystem`, `Pet`, `BuildingPlacer`, `PlayerProcessor`, `MiscCommands`, `RoleHandler`, `SelectedPlayerGroup`, `GameEventProcessor`, `Station`, `PlayerRole`, `UserInterface_Debug`, `CommandDictionary`, `CharacterModelHandler`, `StreamTownSessionBridge`, `BuildingBase`, `GameMasterCommands`, `UserInterface_DisplayUsernames`, `LabelDisplayProcessor`, `TargetSensor`, `SaveProcessor`, `VoteEvent`, `.SetTargetType`?**
