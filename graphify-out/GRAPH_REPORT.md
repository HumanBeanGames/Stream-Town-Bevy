...
## Corpus Check
- 671 files · ~1,805,979 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9256 nodes · 27591 edges · 318 communities (291 shown, 27 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 1053 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d10d84a4`
...
- `building_direction_commands_follow_the_visible_town_axes()` --calls--> `generate_world()`  [INFERRED]
  bevy-port/crates/stream_town_game/src/lib.rs → bevy-port/crates/stream_town_domain/src/world.rs
...
### Community 0 - "Vec"
Cohesion: 0.04
Nodes (93): AnimationClip, AnimationTargetId, add_animation_composition(), add_animation_layer_branch(), add_rotation_curve(), add_scale_curve(), add_translation_curve(), advance_animation_crossfade() (+85 more)
...
### Community 4 - "Res"
Cohesion: 0.03
Nodes (237): Added, AnimatedBy, AnimationGraphHandle, AnimationTransitions, AudioSink, ActivePetVisual, ActorAnimationDriver, ActorNameOverlay (+229 more)

### Community 5 - "stream_town_game/src/lib.rs"
Cohesion: 0.01
Nodes (271): AccessibleNode, accessibility_settings_selection(), AccessibilityActionDispatch, AccessibilityAnnouncement, AccessibilityCandidate, AccessibilityHighContrastText, AccessibilityRuntime, active_event_text() (+263 more)

### Community 6 - "TwitchChatProcessor"
Cohesion: 0.06
Nodes (25): bool, float, Func, int, PlayerExistsByIDDelegate, PlayerExistsByNameDelegate, Queue, string (+17 more)

### Community 7 - "station_candidate"
Cohesion: 0.16
Nodes (24): EnemyDef, ResourceReward, RoleDef, BTreeSet, StationDef, active_station_ids(), actor_idle_anchor(), assigned_station() (+16 more)
...
Cohesion: 0.18
Nodes (45): aged_buildings(), building_cost_reductions(), building_level_caps(), building_node_age(), convert_export(), enemy_camp_generation_layers(), enemy_definition(), field_value() (+37 more)
...
### Community 18 - "Option"
Cohesion: 0.05
Nodes (182): GameConfig, ArchetypeDef, ArchetypeScene, MainMenuModelInstance, MainMenuSceneReference, Option, String, PresentationCatalog (+174 more)
...
Cohesion: 0.06
Nodes (56): SecretsAuthorizationEvent, bot_and_broadcaster_oauth_keep_chat_and_moderation_authority_separate(), bot_and_broadcaster_tokens_use_distinct_vault_entries(), channel_point_reward_tag_survives_privmsg_conversion(), CredentialVault, DeviceAuthorization, ensure_oauth_identity(), envelope_from_privmsg() (+48 more)

### Community 21 - "GridPos"
Cohesion: 0.08
Nodes (40): actor_specific_exception_opens_only_the_requested_blocked_cell(), can_plan_for_three_hundred_agents(), DirtyRegion, grid(), GridPos, manhattan(), NavGrid, NavigationError (+32 more)
...
Cohesion: 0.11
Nodes (39): changing_seed_changes_world_hash(), generate_world(), generated_resources_preserve_unity_target_types_and_reachable_fish(), generation_is_deterministic(), authored_assignment_penalty_spreads_farmers_across_farms(), battering_ram_targets_and_damages_buildings_from_authored_mask(), builder_completes_and_upgrades_authored_construction(), building_approach() (+31 more)
...
Cohesion: 0.04
Nodes (85): AccessibilityNode, AssetId, advance_loading_phase(), advance_loading_runtime(), advance_world_loading_cover(), append_terrain_quad(), append_terrain_skirt(), asset_root_collection_ready() (+77 more)
...
Cohesion: 0.05
Nodes (67): ObjectiveDef, Display, FromStr, StableId, authored_trade_rates_clamp_to_stock_gold_and_capacity(), building_damage_and_repair_preserve_health_bounds(), BuildingState, capped_deposit_preserves_inventory_overflow() (+59 more)
...
Cohesion: 0.10
Nodes (10): int, TechTreeSettings, ContainerBuilder, TechTreeSettingsInstaller, InputButton, SharedTypes, TownGoal.Data, TechTree.Data (+2 more)

### Community 30 - "MenuRuntime"
Cohesion: 0.04
Nodes (134): AccessibilityFocusVisualQuery, AnyResult, AppExit, PlayerSettings, Default, DirectBroadcastControl, accessibility_button_enabled(), accessibility_input() (+126 more)

### Community 31 - "WorldGenProcessor"
Cohesion: 0.06
Nodes (26): HashSet, Action, bool, BoxCollider, Container, ContainerBuilder, Func, GameObject (+18 more)
...
### Community 38 - "Handle"
Cohesion: 0.05
Nodes (49): AccessibilityMotionDefaults, authored_main_ui_image_with_ppu(), authored_ui_image_with_corner_scale(), BoundsMaterialExtension, BoundsMaterialUniform, BuildingMaterialExtension, BuildingMaterialUniform, CharacterMaterialExtension (+41 more)

### Community 39 - ".default"
Cohesion: 0.12
Nodes (34): authority_tab(), checked_in_authoring_assets_pass_headless_validation(), default_catalog_path(), default_config_path(), default_presentation_path(), default_technology_layout_path(), foliage_editor_rejects_invalid_generation_values_without_mutation(), game_config_save_is_atomic_validated_and_round_trips() (+26 more)
...
### Community 43 - ".new"
Cohesion: 0.02
Nodes (202): AccessibilityActionRequest, accessibility_motion_preferences_preserve_authored_parameters(), accessibility_navigation_preserves_editable_text_focus(), accessibility_scope_keeps_modal_navigation_inside_the_open_surface(), accessibility_tagging_tolerates_ui_removed_before_deferred_annotation(), action_ranges_and_tower_acquisition_are_euclidean(), agent_facing_matches_unity_rotation_and_action_targets(), animate_fish_school() (+194 more)
...
Cohesion: 0.08
Nodes (69): ContentCatalog, EnemyCampGenerationDef, ActorState, RoleProgress, Default, String, action_animation_speed(), action_cooldown() (+61 more)
...
Cohesion: 0.06
Nodes (20): AudioHandler, AudioClip, AudioSource, bool, Camera, float, PlayerAudioHandler, SimpleMusicController (+12 more)

### Community 51 - "StreamTownSessionBridge"
Cohesion: 0.11
Nodes (13): bool, double, float, Func, int, List, long, MenuItem (+5 more)

### Community 52 - "Targetable"
Cohesion: 0.04
Nodes (40): Station, Dictionary, float, int, List, Queue, Transform, Vector3 (+32 more)
...
### Community 60 - "content_tab_contents"
Cohesion: 0.11
Nodes (31): ArchetypeKind, ability_choices(), action_animation_choices(), animation_quat_keys_editor(), animation_transform_tracks_editor(), animation_vec3_keys_editor(), archetype_kind_choice(), building_model_node_choices() (+23 more)

### Community 61 - "stream_town_domain/src/content.rs"
Cohesion: 0.10
Nodes (39): AuthoredRecord, AuthoredValue, BuildingDef, BuildingModelDef, default_resource_generation_layers(), EnemyModelSetDef, EnemyRunAnimation, EnemyWeaponModelDef (+31 more)
...
Cohesion: 0.10
Nodes (37): asset(), component(), component_at(), ContentConversionReport, convert(), converts_active_catalog_references_and_round_trips_ron(), converts_building_role_slot_modifiers(), converts_disable_after_time_lifetime() (+29 more)
...
Cohesion: 0.05
Nodes (36): Action, CancellationToken, Task, IAsyncInitializableProcessor, ProcessorStartupContext, Action, bool, BoxCollider (+28 more)
...
Cohesion: 0.06
Nodes (35): bool, CancellationToken, CancellationTokenSource, Dictionary, int, long, MenuItem, string (+27 more)
...
### Community 83 - ".SetGeneratedResources"
Cohesion: 0.15
...
Cohesion: 0.05
Nodes (83): AmbientLight, ActiveMaterialHandles, apply_material_overrides(), authored_post_process_stack(), authored_rgb_filter(), building_damage_intensity(), building_damage_value(), building_material() (+75 more)
...
### Community 107 - "capture_direct_broadcast_frame"
Cohesion: 0.12
Nodes (15): CadenceTick, capture_direct_broadcast_frame(), duration_as_micros(), gpu_readback_padding_is_removed_without_corrupting_rows(), publish_stream_only_frame(), remove_gpu_row_padding(), Duration, Instant (+7 more)
...
Cohesion: 0.16
Nodes (7): CancellationToken, Func, int, List, UTF8Encoding, BinarySaveCodec, BinaryReader

### Community 112 - "TargetSensor"
Cohesion: 0.08
Nodes (11): ProjectileShooter, float, int, string, SensorBase, bool, float, UnityEvent (+3 more)
...
### Community 116 - "ToolState"
Cohesion: 0.08
Nodes (44): AssetEditorSection, broadcast_encoder_label(), format_game_master_ids(), format_runtime_frame_times(), inject_runtime_command(), launch_runtime_game(), migration_tab(), parse_game_master_ids() (+36 more)

### Community 117 - "SelectedPlayerGroup"
Cohesion: 0.15
...
### Community 119 - "STSM_Idle_Player"
Cohesion: 0.10
...
### Community 123 - "ModelPreviewControls"
Cohesion: 0.20
Nodes (16): content_tab(), delete_enemy_camp_generation_layer(), draw_building_visual(), draw_model_preview(), duplicate_enemy_camp_generation_layer(), enemy_camp_generation_editor(), enemy_camp_generation_layer_lifecycle_is_complete(), ModelPreviewControls (+8 more)
...
Cohesion: 0.15
Nodes (21): BroadcastConfig, BroadcastEncoderPreference, BroadcastEncoder, configured_1080p60_encoder_sustains_realtime_output(), copy_packed_video_frame(), encoder_candidates(), encoder_input_format(), encoder_is_hardware() (+13 more)
...
### Community 159 - "ResourceRuntimeData"
Cohesion: 0.32
...
### Community 171 - "StationProcessor"
Cohesion: 0.16
Nodes (8): bool, List, ObjectPoolingSettings, ContainerBuilder, ObjectPoolingSettingsInstaller, Container, ContainerBuilder, StationProcessor

### Community 172 - "BuildingModelHandler"
Cohesion: 0.17
...
### Community 182 - ".GetMissingProcessorDependencies"
Cohesion: 0.27
...
### Community 190 - "stream_town_tools/src/main.rs"
Cohesion: 0.11
Nodes (38): apply_building_draft(), apply_role_draft(), building_draft(), building_editor_preserves_the_complete_template_record(), BuildingDraft, canonical_preview_node_name(), character_model_choices_include_converted_hierarchy_nodes(), debug_fingerprint() (+30 more)
...
### Community 210 - "ErrorData"
Cohesion: 0.22
Nodes (7): Color, ErrorData, List, GroupErrorData, List, NodeErrorData, TechTree.Data.Error

### Community 211 - "DirectBroadcastRuntime"
Cohesion: 0.10
Nodes (32): apply_direct_broadcast_control(), bandwidth_test_never_claims_to_be_publicly_live(), begin_twitch_live_verification(), BroadcastMetricsSnapshot, configure_direct_broadcast(), DirectBroadcastPhase, DirectBroadcastRuntime, operator_live_button_label() (+24 more)
...
### Community 268 - "animate_loading_icon"
Cohesion: 0.29
Nodes (8): RotatingNodeDef, animate_loading_icon(), apply_loading_icon_rotation(), loading_icon_rotation(), loading_icon_rotation_uses_the_authored_prefab_contract(), LoadingIconSpinner, MainMenuRotatingDefinitions, UiTransform
...
Cohesion: 0.10
Nodes (36): apply_preview_material_overrides(), apply_preview_node_visibility(), drive_model_preview_animation(), frame_model_preview(), ModelPreviewCamera, ModelPreviewRuntime, ModelPreviewScene, PreviewMaterialApplied (+28 more)
...
### Community 290 - "DebugProcessor"
Cohesion: 0.05
Nodes (19): Dictionary, DebugSettings, ContainerBuilder, DebugSettingsInstaller, Container, ContainerBuilder, DebugProcessor, Container (+11 more)
...
### Community 295 - "item_info"
Cohesion: 0.17
Nodes (15): building_definition_id(), eligible_technology_ids(), item_info(), prefixed_id(), resolve_active_technology_vote_option(), resolve_player_id(), resolve_technology_id(), Result (+7 more)
...
Cohesion: 0.06
Nodes (45): amf_quality_profile_keeps_static_grid_detail_between_keyframes(), average_milliseconds(), bandwidth_test_url_is_constructed_without_logging_the_key(), build_ingest_url(), configure_amf_quality(), DirectBroadcastSnapshot, draw_centered_sensitive_label(), ingest() (+37 more)
...
Cohesion: 0.11
Nodes (48): add_archetype_scene(), apply_enemy_camp_generation_draft(), apply_foliage_draft(), apply_objective_draft(), apply_resource_generation_draft(), apply_technology_draft(), authoring_snapshot(), AuthoringSnapshot (+40 more)
...
### Community 301 - "objective_catalog_editor"
Cohesion: 0.60
...
Cohesion: 0.12
Nodes (17): AuthorizationEvent, BroadcastPrerequisites, BroadcastTarget, DirectTwitchBroadcastPlugin, LiveVerification, LiveVerificationEvent, LiveVerificationTarget, PreparedBroadcast (+9 more)
...
### Community 309 - "player_window_mode"
Cohesion: 0.67
...
- **Why does `Utils` connect `Utils` to `SeasonProcessor`, `Age`, `TownGoal.Data`, `DebugProcessor`, `GenerationSettings`, `UpdateGraphBounds`, `ScriptablesProcessorInfrastructure`, `TargetProcessor`, `AudioHandler`, `Targetable`, `StringUtils`, `MonoBehaviour`, `ScriptableObject`, `BuildingPlacer`, `Easings`, `SnapToGridMouseMovement`, `FPSDisplay`, `Resource`, `ChanceObjectList`, `RandomEnabler`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `StableId` connect `StableId` to `Vec`, `String`, `Res`, `stream_town_game/src/lib.rs`, `station_candidate`, `config.rs`, `UnityAsset`, `save.rs`, `Option`, `command.rs`, `twitch.rs`, `GridPos`, `generate_world`, `advance_world_loading_cover`, `Option`, `item_info`, `String`, `.new`, `AnimationControllerDef`, `component_field_value`, `String`, `ContentCatalog`, `Result`, `convert`, `objective_catalog_editor`, `stream_town_migrate/src/presentation.rs`, `content_tab_contents`, `stream_town_domain/src/content.rs`, `stream_town_tools/src/main.rs`, `stream_town_migrate/src/menu_scene.rs`, `technology_graph.rs`, `setup_rendering`, `GeneratedWorld`, `String`, `stream_town_domain/src/presentation.rs`, `ToolState`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `PlayerProcessor` connect `PlayerProcessor` to `PlayerRoleData`, `BuildingProcessor`, `EnemySpawner`, `TwitchChatProcessor`, `BottomBarInterface`, `RoleHandler`, `UserInterface_Debug`, `SelectedPlayer`, `WorldGenProcessor`, `TechTreeProcessor`, `Player`, `StreamTownSessionBridge`, `TwitchClientProcessor`, `UIProcessor`, `GUIDProcessor`, `MonoBehaviour`, `Utils`, `ObjectPoolingProcessor`, `UserInterface_TownVote`, `BuildingPlacer`, `RaidEvent`, `Resource`, `SaveProcessor`, `TimeProcessor`, `SelectedPlayerGroup`, `GameEvent`, `VoteEvent`, `Enemy`?**
