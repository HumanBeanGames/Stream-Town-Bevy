...
## Corpus Check
- 670 files · ~1,759,143 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8745 nodes · 25285 edges · 310 communities (277 shown, 33 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 1034 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5e49ef77`
...
Cohesion: 0.10
Nodes (56): WorldGenConfig, algorithmic_generation_matches_unity_validation_fingerprints(), authored_foliage_is_deterministic_and_respects_habitat_and_resources(), authored_grid_centre(), authored_world_to_grid(), AuthoredResourceLayer, cell_hash(), changing_seed_changes_world_hash() (+48 more)
...
Cohesion: 0.04
Nodes (33): bool, float, Func, int, PlayerExistsByIDDelegate, PlayerExistsByNameDelegate, Queue, string (+25 more)

### Community 7 - "ResMut"
Cohesion: 0.05
Nodes (122): AccessibilityFocusVisualQuery, AccumulatedMouseScroll, AppExit, accessibility_button_enabled(), accessibility_input(), accessibility_scope_active(), AccessibilityAnnouncement, AccessibilityRuntime (+114 more)
...
### Community 9 - ".new"
Cohesion: 0.02
Nodes (213): AccessibilityActionRequest, GameConfig, generate_world(), accessibility_motion_preferences_preserve_authored_parameters(), accessibility_scope_keeps_modal_navigation_inside_the_open_surface(), action_ranges_and_tower_acquisition_are_euclidean(), advance_falling_fish(), agent_facing_matches_unity_rotation_and_action_targets() (+205 more)

### Community 10 - "SettingsProcessor"
Cohesion: 0.07
Nodes (10): AudioMixer, bool, Container, ContainerBuilder, UniversalRendererData, UniversalRenderPipelineAsset, Preset, SettingsProcessor (+2 more)

### Community 11 - "Buildings"
Cohesion: 0.07
...
Cohesion: 0.03
Nodes (94): AccessibilityNode, AssetId, advance_loading_phase(), advance_loading_runtime(), advance_world_loading_cover(), asset_root_collection_ready(), authored_rotating_node_names(), begin_world_loading_cover() (+86 more)

### Community 13 - "stream_town_migrate/src/content.rs"
Cohesion: 0.11
Nodes (38): PassiveResourceContribution, animation_parameter_name(), archetype_kind(), asset(), authored_value(), building_model_definitions(), component(), component_at() (+30 more)
...
Cohesion: 0.04
Nodes (79): AmbientLight, Assets, ActiveMaterialHandles, animate_healing_effects(), building_snow_strength(), BuildingMaterialInstance, BuildingMaterialInstances, CharacterBaseMaterialCache (+71 more)
...
### Community 23 - "Option"
Cohesion: 0.05
Nodes (140): ArchetypeDef, ArchetypeKind, ArchetypeScene, MainMenuSceneReference, Option, PresentationCatalog, actor_material(), animated_pets_resolve_their_own_unity_controllers_and_rigs() (+132 more)
...
Cohesion: 0.05
Nodes (59): ObjectiveDef, FromStr, StableId, authored_trade_rates_clamp_to_stock_gold_and_capacity(), building_damage_and_repair_preserve_health_bounds(), capped_deposit_preserves_inventory_overflow(), complete_gameplay_scenario_round_trips(), default_ruler_vote_cooldown() (+51 more)
...
### Community 30 - "Res"
Cohesion: 0.04
Nodes (200): Aabb, Added, AnimatedBy, AnimationGraphHandle, AnimationPlayer, AnimationTransitions, AudioSink, ActivePetVisual (+192 more)
...
Cohesion: 0.08
Nodes (13): RotationHandler, float, Quaternion, Vector3, EnemyModelHandlerEditor, bool, int, List (+5 more)
...
Cohesion: 0.09
Nodes (41): ArchetypeBounds, AuthoredRecord, AuthoredValue, BuildingDef, BuildingModelDef, EnemyDef, EnemyModelSetDef, EnemyRunAnimation (+33 more)

### Community 37 - "SettingsData"
Cohesion: 0.08
Nodes (17): string, GameIO, SaveFileType, bool, int, string, VideoSettingsPreset, bool (+9 more)

### Community 38 - "DebugProcessor"
Cohesion: 0.04
Nodes (33): float, int, Material, AllSeasonSettings, IMainThreadInitializableProcessor, Container, ContainerBuilder, DebugProcessor (+25 more)
...
Cohesion: 0.22
Nodes (23): ArchetypesById, RotatingNodeDef, archetype_bounds(), component_field_value(), component_type(), convert_archetypes(), converted_rotating_axis(), disable_after_milliseconds() (+15 more)
...
Cohesion: 0.16
Nodes (17): AtomicBool, BroadcastController, BroadcastMetrics, BroadcastMetricsSnapshot, capture_process_audio(), encode_broadcast_session(), MediaInput, Arc (+9 more)

### Community 50 - "IRuntimeDataScriptable"
Cohesion: 0.05
Nodes (33): AudioHandler, AudioClip, AudioSource, bool, Camera, float, PlayerAudioHandler, Container (+25 more)
...
Cohesion: 0.09
Nodes (16): PetType, bool, int, List, string, InventoryEntrySaveData, InventorySaveData, int (+8 more)
...
Cohesion: 0.09
Nodes (11): Container, ContainerBuilder, Slider, TextMeshProUGUI, UIProcessor, IPostInitializeProcessor, Color, GameObject (+3 more)
...
Cohesion: 0.05
Nodes (28): CollectResource, AnimationCurve, bool, int, object, ResourceHolder, uint, GUIDComponent (+20 more)
...
### Community 83 - "Handle"
Cohesion: 0.04
Nodes (92): BackgroundColor, AccessibilityMotionDefaults, apply_authored_ui_fonts(), authored_main_ui_image_with_ppu(), authored_ui_image(), authored_ui_image_with_corner_scale(), BoundsMaterialExtension, BoundsMaterialUniform (+84 more)

### Community 84 - "Access_Text"
Cohesion: 0.09
Nodes (11): Access_AmbienceVolumeText, Access_EdgeScrollingSensitivityText, Access_FOVLevelText, Access_MasterVolumeText, Access_MusicVolumeText, Access_PanningSensitivityText, Access_SoundEffectsVolumeText, Access_Text (+3 more)

### Community 85 - "NavGrid"
Cohesion: 0.13
...
Cohesion: 0.01
Nodes (316): AccessibleNode, AnimationClip, AnimationGraph, AnimationNodeIndex, AnimationTargetId, accessibility_settings_selection(), AccessibilityActionDispatch, AccessibilityCandidate (+308 more)

### Community 87 - "station_candidate"
Cohesion: 0.18
Nodes (22): StationDef, active_station_ids(), assigned_station(), best_station_id(), cached_station_targets(), compatible_station_ids(), compatible_target_ids(), compatible_target_ids_with_station_runtime() (+14 more)

### Community 88 - "IProcessor"
Cohesion: 0.05
Nodes (21): Container, ContainerBuilder, GridProcessor, Container, IProcessor, Container, ContainerBuilder, CreditsProcessor (+13 more)

### Community 89 - "FoliageProcessor"
Cohesion: 0.08
Nodes (29): Bounds, Container, ContainerBuilder, Dictionary, HashSet, List, Material, Matrix4x4 (+21 more)

### Community 90 - "save_secrets_fields"
Cohesion: 0.21
Nodes (14): AnyResult, legacy_unity_settings_path(), load_player_settings(), load_runtime_config(), player_settings_path(), FnOnce, PathBuf, runtime_config_path() (+6 more)

### Community 91 - "UserInterface_Event"
Cohesion: 0.13
Nodes (11): Animator, GameObject, int, FishGodEvent, OnMessageReceivedArgs, EventCommands, GameObject, Slider (+3 more)
...
### Community 114 - "Utils"
Cohesion: 0.07
Nodes (12): SelectionBase, Utils, Pets.Enumerations, Sensors, Pets, GameEventSystem, GameEventSystem.Events, Twitch.Commands (+4 more)
...
### Community 118 - ".EnsureValidCredentials"
Cohesion: 0.19
...
Cohesion: 0.18
Nodes (16): begin_direct_broadcast(), capture_direct_broadcast_frame(), configure_direct_broadcast(), DirectBroadcastControl, DirectBroadcastPhase, DirectBroadcastRuntime, DirectBroadcastSnapshot, poll_direct_broadcast_authorization() (+8 more)
...
Cohesion: 0.14
Nodes (17): AudioFrame, bandwidth_test_url_is_constructed_without_logging_the_key(), black_rgba_frame(), BroadcastPrerequisites, build_ingest_url(), DirectTwitchBroadcastPlugin, ingest(), ingest_selection_prefers_default_or_named_region() (+9 more)

### Community 129 - "UserInterface_Roles"
Cohesion: 0.16
...
### Community 134 - ".GetMissingDataScriptableDependencies"
Cohesion: 0.22
...
Cohesion: 0.05
Nodes (13): InputButton, Transform, PlayerSpawnPoint, UserInterface.MainMenu, Processors, Core, World, MetaData (+5 more)

### Community 154 - "GameStateProcessor"
Cohesion: 0.21
...
### Community 156 - ".Draw"
Cohesion: 0.07
Nodes (28): NodeUnlockSaveData, Button, EnumField, ObjectiveVisualElement, Port, Button, EnumField, UnlockVisualElement (+20 more)
...
Cohesion: 0.15
Nodes (20): archetype_scenes(), authored_mask(), building_placements(), BuildingPlacement, child_technology_guids(), collect_model_dependencies(), decomposes_combined_unity_flag_values(), footprint_from_unity_size() (+12 more)
...
### Community 173 - "ScriptablesProcessorInfrastructure"
Cohesion: 0.08
...
### Community 185 - "GridPos"
Cohesion: 0.11
Nodes (33): GridPos, BuildingState, EnemyCampState, RaidState, BTreeSet, ActionPresentation, agent_path(), battering_ram_targets_and_damages_buildings_from_authored_mask() (+25 more)
...
Cohesion: 0.02
Nodes (84): int, AudioSettings, List, CampGenSettings, float, Material, Volume, DayAndNightSettings (+76 more)
...
### Community 190 - "ObjectiveSaveData"
Cohesion: 0.50
...
### Community 194 - "STSM_Idle_Player"
Cohesion: 0.10
...
### Community 253 - ".Log"
Cohesion: 0.12
Nodes (8): Action, HideInCallstack, Object, DebugLogCategory, LoadSceneMode, Scene, IEnumerator, ResourceData[]&gt;
...
Cohesion: 0.24
Nodes (12): BroadcastConfig, BroadcastEncoderPreference, AuthorizationEvent, BroadcastTarget, encoder_candidates(), open_audio_encoder(), open_video_encoder(), Debug (+4 more)
...
### Community 273 - "record_gpu_readiness"
Cohesion: 0.25
...
### Community 280 - "SimpleDisableAfterTime"
Cohesion: 0.25
...
### Community 298 - "SimpleRotateOnAxis"
Cohesion: 0.40
...
Cohesion: 0.04
Nodes (23): Player, Dictionary, GameObject, List, Vector3, Vector3, Action, Container (+15 more)
...
- **Why does `Utils` connect `Utils` to `UserInterface`, `StringUtils`, `EnemySpawner`, `TechTree.Elements`, `World.Generation`, `Buildings`, `Easings`, `STStateMachine.States`, `SimpleDisableAfterTime`, `Processors`, `.Draw`, `BuildingScriptablesEditor.cs`, `GenerationSettings`, `CommonEnums.cs`, `UpdateGraphBounds`, `SimpleRotateOnAxis`, `SimpleEventOnStart`, `RandomEnabler`, `ScriptablesProcessorInfrastructure`, `SimpleRandomModelEnabled`, `SimpleScreenShot`, `DisableOnAwake`, `BuildingPlacer`, `SimpleHideRendererOnAwake`, `FPSDisplay`, `SnapToGridMouseMovement`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `StableId` connect `StableId` to `GeneratedWorld`, `ToolState`, `.new`, `advance_world_loading_cover`, `stream_town_migrate/src/content.rs`, `legacy.rs`, `save.rs`, `ContentCatalog`, `setup_rendering`, `twitch.rs`, `Option`, `command.rs`, `String`, `stream_town_migrate/src/presentation.rs`, `Res`, `stream_town_domain/src/content.rs`, `TechnologyGraphViewState`, `String`, `component_field_value`, `AnimationControllerDef`, `runtime_console.rs`, `tools_ui`, `GridPos`, `stream_town_migrate/src/menu_scene.rs`, `UnityAsset`, `stream_town_game/src/lib.rs`, `station_candidate`, `config.rs`, `stream_town_domain/src/presentation.rs`, `Option`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `PlayerProcessor` connect `Player` to `RoleProcessor`, `BuildingProcessor`, `UserInterface_Roles`, `MonoBehaviour`, `EnemySpawner`, `TwitchChatProcessor`, `BottomBarInterface`, `HealthHandler`, `WorldGenProcessor`, `UserInterface_Debug`, `NewKingVote`, `DebugProcessor`, `TechTreeProcessor`, `PlayerRole`, `PlayerRoleData`, `StreamTownSessionBridge`, `TwitchClientProcessor`, `UIProcessor`, `GameEventProcessor`, `ObjectPoolingProcessor`, `UserInterface_TownVote`, `BuildingPlacer`, `IProcessor`, `UserInterface_Event`, `Resource`, `SaveProcessor`, `RaidEvent`, `TownGoalProcessor`, `Utils`, `RoleHandler`, `.Log`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
...
- **Should `BuildingProcessor` be split into smaller, more focused modules?**
  _Cohesion score 0.03570843570843571 - nodes in this community are weakly interconnected._
