...
## Corpus Check
- 603 files · ~1,532,970 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6164 nodes · 14491 edges · 276 communities (249 shown, 27 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 983 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3517c802`
...
Cohesion: 0.03
Nodes (72): ContainerBuilder, AllBuildingDataSettingsInstaller, ContainerBuilder, BuildingConfigSettingsInstaller, ContainerBuilder, ResourceDataSettingsInstaller, ContainerBuilder, WaterFoliageGenSettingsInstaller (+64 more)

### Community 3 - "Processors"
Cohesion: 0.06
Nodes (10): InputButton, UserInterface.MainMenu, Processors, MetaData, Audio, Settings, VFX, Environment (+2 more)
...
Cohesion: 0.10
Nodes (5): List, GameSettings, OnChatCommandReceivedArgs, TwitchClientProcessor, PlayerCommands
...
### Community 15 - "IInstaller"
Cohesion: 0.07
Nodes (21): ContainerBuilder, TerrainGenSettingsInstaller, bool, List, ObjectPoolingSettings, AnimationCurve, bool, float (+13 more)
...
Cohesion: 0.15
Nodes (37): AppExit, Agent, AgentAnimation, animate_agents(), camera_controls(), capture_screenshot(), credits_input(), drive_native_animations() (+29 more)
...
Cohesion: 0.16
Nodes (4): IReadOnlyList, MenuItem, StreamTownSessionBridge, FrameCapture
...
Cohesion: 0.12
Nodes (25): can_plan_for_three_hundred_agents(), DirtyRegion, grid(), GridPos, manhattan(), NavGrid, NavigationError, OpenNode (+17 more)
...
Cohesion: 0.07
Nodes (85): ArchetypesById, ArchetypeBounds, ArchetypeDef, ArchetypeKind, ArchetypeScene, AuthoredRecord, AuthoredValue, BuildingDef (+77 more)
...
Cohesion: 0.13
Nodes (31): AnimationClipDef, AnimationConditionDef, AnimationConditionMode, AnimationControllerDef, AnimationMotionDef, AnimationParameterDef, AnimationParameterKind, AnimationQuatKeyframe (+23 more)
...
Cohesion: 0.12
Nodes (34): App, broadcaster_gate_precedes_twitch_command_dispatch(), embedded_content(), embedded_presentation(), embedded_unity_content_catalog_is_valid(), generate_connect_code(), generated_terrain_mesh(), generated_terrain_mesh_matches_navigation_grid() (+26 more)
...
Cohesion: 0.09
Nodes (16): Dictionary, DebugSettings, ContainerBuilder, DebugSettingsInstaller, IMainThreadInitializableProcessor, Container, ContainerBuilder, HideInCallstack (+8 more)
...
### Community 135 - "Utils"
Cohesion: 0.05
Nodes (13): BuildCostModifier, STStateMachine.States, PlayerControls.ObjectSelection, Units, Utils, Behaviours, Animation, Sensors (+5 more)
...
Cohesion: 0.18
Nodes (27): AnimationGraph, Assets, AssetServer, MaterialDef, PresentationCatalog, BTreeMap, actor_material(), archetype_by_source() (+19 more)
...
Cohesion: 0.29
Nodes (12): AnimationNodeIndex, AnimationPlayer, ActorAnimationDriver, animation_nodes_for_selection(), apply_animation_blend(), ConvertedAnimationDriver, current_normalized_time(), drive_converted_animations() (+4 more)
...
### Community 147 - "ResourceStorageModifier"
Cohesion: 0.24
...
### Community 158 - "TownResourceRuntimeData"
Cohesion: 0.18
...
### Community 179 - "GameEventRuntimeData"
Cohesion: 0.25
...
### Community 186 - "DayAndNightSettings"
Cohesion: 0.22
...
Cohesion: 0.15
Nodes (11): Foliage, FoliageSaveType, FoliageType, PLayerActivityStatus, ResourceType, ReviveType, SaveItem, Seasons (+3 more)

### Community 204 - "PlayerDeathHandler"
Cohesion: 0.25
...
### Community 206 - "GameEventSettings"
Cohesion: 0.25
...
Cohesion: 0.12
Nodes (15): CreditsRuntimeData, bool, GameStateRuntimeData, IRuntimeDataScriptable, bool, List, RectTransform, UnityEvent (+7 more)
...
Cohesion: 0.15
Nodes (23): AnimationGraphHandle, animation_root_name(), apply_material_overrides(), attach_converted_animations(), attach_native_animations(), cleanup_state_entities(), cleanup_world(), collect_animation_targets() (+15 more)
...
Cohesion: 0.24
Nodes (13): cell_hash(), changing_seed_changes_world_hash(), generate_world(), GeneratedResource, GeneratedWorld, generation_is_deterministic(), hash_world(), String (+5 more)
...
### Community 244 - "WorldGenDebugSettings"
Cohesion: 0.29
...
### Community 254 - "CampGenerationSettings"
Cohesion: 0.17
...
Cohesion: 0.02
Nodes (59): CameraProcessor, CellSpacePartitioningInstaller, ContainerBuilder, ContainerBuilder, MetaDataInstaller, PersistentScoped, ContainerBuilder, FoliageGenSettingsInstaller (+51 more)
...
- **Why does `SaveProcessor` connect `SaveProcessor` to `BuildingProcessor`, `ScriptableObject`, `DebugProcessor`, `PlayerCommands`, `MonoBehaviour`, `.Log`, `SettingsProcessor`, `WorldGenProcessor`, `Resource`, `WorldSaveData`, `PlayerRole`, `Character`, `IInstaller`, `PlayerProcessor`, `ResourceGenerationSettings`, `ResourceDataSaveData`, `GameEventProcessor`, `SaveFileData`, `GUIDProcessor`, `TechTreeProcessor`, `TimeProcessor`, `SeasonProcessor`, `ResourceProcessor`, `StreamTownSessionBridge`, `IProcessor`, `FoliageProcessor`, `MainMenuManager`, `TownGoalProcessor`, `PlayerSaveData`, `UserInterface_GameMenu`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `WorldGenProcessor` connect `WorldGenProcessor` to `BuildingProcessor`, `ScriptableObject`, `DebugProcessor`, `TwitchChatProcessor`, `MonoBehaviour`, `.Log`, `IInstaller`, `.GenerateFromSettings`, `PlayerProcessor`, `ResourceGenerationSettings`, `GUIDProcessor`, `CellSpacePartitioning`, `UserInterface_Debug`, `SaveProcessor`, `ResourceProcessor`, `TwitchClientProcessor`, `Access_Dropdown`, `WorldGenRuntimeData`, `AIPath`, `RaidEvent`, `IProcessor`, `Target`, `FoliageProcessor`, `Coordinator`, `Player`, `EnemySpawner`, `PlayerSaveData`, `WorldGenDebugSettings`, `GameStateProcessor`, `CampGenerationSettings`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `SettingsProcessor` connect `SettingsProcessor` to `ScriptablesProcessorInfrastructure`, `GraphicsProcessor`, `Access_Slider`, `IProcessor`, `SettingsData`, `SaveProcessor`, `MainMenuManager`, `MonoBehaviour`, `UIElementWrapper`, `IInstaller`, `Access_Text`, `Access_Dropdown`, `Access_Toggle`, `Autosave`, `UserInterface_GameMenu`?**
...
- **Should `ScriptableObject` be split into smaller, more focused modules?**
  _Cohesion score 0.025128865979381444 - nodes in this community are weakly interconnected._