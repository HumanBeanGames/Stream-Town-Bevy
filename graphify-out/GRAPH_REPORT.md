...
## Corpus Check
- 605 files · ~1,576,472 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6634 nodes · 16805 edges · 302 communities (249 shown, 53 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 991 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dd8a36c3`
...
## Communities (302 total, 53 thin omitted)
...
Cohesion: 0.10
Nodes (63): animation_state_id(), animation_state_machine_id(), append_vec3_keys(), array_index(), clip_id(), color_value(), convert_clips(), extracts_indexed_material_properties() (+55 more)

### Community 4 - "Character"
Cohesion: 0.11
Nodes (10): Pets.Enumerations, StreamTown.EditorTools, TownGoal, Core, Pets, GameEventSystem, GameEventSystem.Events, Twitch (+2 more)
...
Cohesion: 0.10
Nodes (61): AssetServer, GridPos, cell_hash(), changing_seed_changes_world_hash(), generate_world(), GeneratedResource, GeneratedWorld, generation_is_deterministic() (+53 more)
...
Cohesion: 0.06
Nodes (20): ContainerBuilder, WorldGenBehaviorSettingsInstaller, ContainerBuilder, WorldGenDebugSettingsInstaller, ContainerBuilder, BuildingSettingsInstaller, ContainerBuilder, ObjectPoolingSettingsInstaller (+12 more)
...
### Community 16 - "Utils"
Cohesion: 0.09
Nodes (5): BuildingScriptablesEditor, Utils, SavingAndLoading, SavingAndLoading.Structs, GameResources
...
### Community 20 - "WorldInstanceDeterminism"
Cohesion: 0.33
...
### Community 26 - ".Log"
Cohesion: 0.07
Nodes (12): Container, ContainerBuilder, HideInCallstack, Object, DebugLogCategory, DebugProcessor, Container, ContainerBuilder (+4 more)
...
Cohesion: 0.03
Nodes (120): App, AppExit, active_event_text(), ActivePetVisual, AgentCommand, AgentCommandQueue, AgentEquipmentPresentation, authored_level_curves_drive_effective_role_stats() (+112 more)
...
### Community 47 - "Target"
Cohesion: 0.10
Nodes (11): PlayerControls.ObjectSelection, Units, Target, Utils.Pooling, Sensors, GridSystem.Partitioning, Combat, Environment (+3 more)
...
Cohesion: 0.05
Nodes (61): ObjectiveDef, ObjectiveKind, FromStr, StableId, authored_trade_rates_clamp_to_stock_gold_and_capacity(), BuildingState, capped_deposit_preserves_inventory_overflow(), complete_gameplay_scenario_round_trips() (+53 more)
...
### Community 74 - "Result"
Cohesion: 0.11
Nodes (43): AvatarMaskDef, MaterialAlphaMode, MaterialDef, PrefabPresentationBinding, RendererMaterialBinding, BTreeMap, assign_clip_rigs_and_reference_poses(), avatar_mask_id() (+35 more)

### Community 75 - "UserInterface_ObjectSelection"
Cohesion: 0.14
Nodes (13): BoxCollider, Button, GameObject, Image, List, object, Slider, TMP_Dropdown (+5 more)

### Community 76 - "Processors"
Cohesion: 0.07
Nodes (15): CameraProcessor, BuildCostModifier, InputButton, CreditsRuntimeData, UserInterface.MainMenu, Processors, Character.Enumerations, World (+7 more)
...
Cohesion: 0.07
Nodes (23): int, List, Vector2, GridNode, Color, CollisionColours, CollisionType, Queue (+15 more)
...
Cohesion: 0.07
Nodes (15): TargetSettings, Container, ContainerBuilder, List, TargetProcessor, Dictionary, List, TargetRuntimeData (+7 more)
...
### Community 90 - "Option"
Cohesion: 0.06
Nodes (60): AnimationNodeIndex, AnimationPlayer, PresentationCatalog, ActorCustomization, advance_animation_crossfade(), animation_event_occurrences(), animation_nodes_for_selection(), animation_property_value() (+52 more)
...
Cohesion: 0.08
Nodes (39): AnimationClipDef, AnimationConditionDef, AnimationConditionMode, AnimationEventDef, AnimationFloatKeyframe, AnimationLayerBlendMode, AnimationLayerDef, AnimationMotionDef (+31 more)
...
### Community 108 - "retargeted_animation_clip"
Cohesion: 0.20
Nodes (16): AnimationClip, AnimationTargetId, add_rotation_curve(), add_scale_curve(), add_translation_curve(), ensure_two_keyframes(), normalized_quat(), retargeted_animation_clip() (+8 more)
...
Cohesion: 0.09
Nodes (12): IResourceHolder, Container, ContainerBuilder, Dictionary, TownResourceProcessor, bool, float, ParticleSystem (+4 more)
...
Cohesion: 0.09
Nodes (14): bool, BoxCollider, Container, float, int, List, Quaternion, Vector3 (+6 more)
...
Cohesion: 0.06
Nodes (67): AnyResult, ConfigError, default_configuration_is_valid_and_round_trips_ron(), enabled_twitch_requires_public_configuration(), GameConfig, GameplayConfig, BTreeMap, Default (+59 more)
...
### Community 148 - ".PoolObjectsAsync"
Cohesion: 0.26
Nodes (7): Action, CancellationToken, Task, GameObject, int, string, PooledObjectData

### Community 149 - "TechnologyTreeGroup"
Cohesion: 0.25
Nodes (5): Color, float, string, TechnologyTreeGroup, Group

### Community 150 - "PlayerRole"
Cohesion: 0.09
Nodes (10): PlayerRoleData, AudioClip, bool, float, int, StatModifiers, Dictionary, List (+2 more)
...
### Community 154 - "EnemyWeaponModel"
Cohesion: 0.24
...
### Community 162 - "DayAndNightRuntimeData"
Cohesion: 0.24
...
### Community 172 - "STStateMachine.States"
Cohesion: 0.07
...
### Community 174 - "ChanceObjectList"
Cohesion: 0.27
...
### Community 185 - "ObjectPoolingRuntimeData"
Cohesion: 0.43
...
Cohesion: 0.16
Nodes (6): int, Vector2, GridSettings, Container, ContainerBuilder, GridProcessor
...
### Community 193 - ".OnSceneLoaded"
Cohesion: 0.33
Nodes (3): ContainerBuilder, LoadSceneMode, Scene
...
### Community 204 - "TerrainGenerationSettings"
Cohesion: 0.33
...
### Community 224 - "Query"
Cohesion: 0.07
Nodes (96): Added, AmbientLight, AnimationGraph, AnimationGraphHandle, Assets, BackgroundColor, ActorAnimationDriver, add_animation_layer_branch() (+88 more)
...
### Community 240 - "VideoSettingsPresetsInstaller"
Cohesion: 0.40
...
### Community 244 - "GUIDRuntimeData"
Cohesion: 0.50
Nodes (3): bool, Dictionary, GUIDRuntimeData
...
Cohesion: 0.04
Nodes (33): ContainerBuilder, InstantiationBarrier, ContainerBuilder, AllBuildingDataSettingsInstaller, ContainerBuilder, AudioSettingsInstaller, ContainerBuilder, BuildingConfigSettingsInstaller (+25 more)

### Community 269 - "UI_TechOption"
Cohesion: 0.22
Nodes (7): Button, GameObject, Image, Slider, TextMeshProUGUI, Transform, UI_TechOption

### Community 270 - "ProjectCameraInstaller"
Cohesion: 0.50
Nodes (3): Camera, GameObject, ProjectCameraInstaller

### Community 275 - "ObjectiveSaveData"
Cohesion: 0.50
...
### Community 277 - "UI_Objective"
Cohesion: 0.50
Nodes (3): Slider, TextMeshProUGUI, UI_Objective

### Community 278 - "UIRoleDisplay"
Cohesion: 0.50
Nodes (3): Image, TextMeshProUGUI, UIRoleDisplay

### Community 280 - "ScriptableObject"
Cohesion: 0.02
Nodes (75): List, CampGenSettings, float, Material, Volume, DayAndNightSettings, List, FoliageGenSettings (+67 more)
...
- **Why does `SaveProcessor` connect `SaveProcessor` to `BuildingProcessor`, `Character`, `IInstaller`, `GUIDProcessor`, `WorldGenProcessor`, `MonoBehaviour`, `PlayerSaveData`, `SettingsProcessor`, `.InjectRuntimeData`, `PlayerProcessor`, `ScriptableObject`, `.Log`, `SaveFileData`, `ResourceDataSaveData`, `GameEventProcessor`, `PlayerCommands`, `TechTreeProcessor`, `TimeProcessor`, `SeasonProcessor`, `RoleProcessor`, `StreamTownSessionBridge`, `ResourceProcessor`, `IProcessor`, `FoliageProcessor`, `WorldSaveData`, `MainMenuManager`, `TownGoalProcessor`, `UserInterface_GameMenu`, `Resource`, `ObjectPoolingProcessor`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `WorldGenProcessor` connect `WorldGenProcessor` to `BuildingProcessor`, `TwitchChatProcessor`, `IInstaller`, `GUIDProcessor`, `MonoBehaviour`, `PlayerProcessor`, `ScriptableObject`, `.Log`, `RaidEvent`, `CellSpacePartitioning`, `UserInterface_Debug`, `SaveProcessor`, `.InjectRuntimeData`, `Target`, `ResourceProcessor`, `TwitchClientProcessor`, `Access_Dropdown`, `WorldGenRuntimeData`, `GridProcessor`, `IProcessor`, `FoliageProcessor`, `Coordinator`, `Player`, `EnemySpawner`, `AIPath`, `ObjectPoolingProcessor`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `SettingsProcessor` connect `SettingsProcessor` to `ScriptablesProcessorInfrastructure`, `GraphicsProcessor`, `Access_Slider`, `IProcessor`, `SettingsData`, `SaveProcessor`, `MainMenuManager`, `IInstaller`, `MonoBehaviour`, `Access_Toggle`, `UIElementWrapper`, `UserInterface_GameMenu`, `Access_Text`, `Access_Dropdown`, `Autosave`?**
