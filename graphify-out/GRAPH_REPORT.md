...
## Corpus Check
- 629 files · ~1,627,208 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7374 nodes · 19684 edges · 301 communities (277 shown, 24 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 1006 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `801ecd6e`
...
## Communities (301 total, 24 thin omitted)
...
Cohesion: 0.10
Nodes (3): Container, ContainerBuilder, BuildingProcessor

### Community 2 - "update_vote_panels"
Cohesion: 0.09
Nodes (24): CommandFeedback, CurrentEventFill, CurrentEventPanel, CurrentEventText, Hud, hud_play_time(), hud_season_meter_percent(), HudMetric (+16 more)
...
### Community 4 - "ResMut"
Cohesion: 0.05
Nodes (84): AccumulatedMouseMotion, AccumulatedMouseScroll, AnyResult, AppExit, PlayerSettings, Default, AgentCommand, AgentCommandQueue (+76 more)

### Community 5 - "stream_town_domain/src/content.rs"
Cohesion: 0.08
...
### Community 13 - "Handle"
Cohesion: 0.06
Nodes (54): BackgroundColor, bottom_bar_action_buttons(), bottom_bar_button_dispatches_through_the_typed_command_queue(), bottom_bar_main_buttons(), bottom_bar_scroll_buttons(), bottom_bar_texture(), BottomBarActionEnabled, BottomBarContext (+46 more)
...
Cohesion: 0.10
Nodes (11): Func, List, int, STSM_Helper_Attack, Action, bool, float, int (+3 more)
...
### Community 18 - "BuildingType"
Cohesion: 0.10
Nodes (6): BuildingType, foodCost, goldCost, maxLevel, oreCost, woodCost

### Community 19 - "RenderAssets"
Cohesion: 0.06
Nodes (156): Added, AnimationGraphHandle, AudioSink, actor_material(), actor_scene_budget(), ActorNameOverlay, Agent, agent_is_moving() (+148 more)
...
Cohesion: 0.05
Nodes (22): Animator, GameObject, int, FishGodEvent, Action, Container, ContainerBuilder, List (+14 more)
...
### Community 26 - "StableId"
Cohesion: 0.03
Nodes (120): AnimationGraph, AnimationNodeIndex, AnimationPlayer, GameplayConfig, BTreeMap, FromStr, StableId, StreamUserType (+112 more)
...
Cohesion: 0.02
Nodes (160): App, generate_world(), adjust_settings_menu(), AgentEnemyModelPresentation, AgentEquipmentPresentation, animate_healing_effects(), archetype_id_by_source(), authored_assignment_penalty_spreads_farmers_across_farms() (+152 more)
...
### Community 33 - "RoleProcessor"
Cohesion: 0.11
Nodes (6): RoleSlotModifier, int, Container, ContainerBuilder, int, RoleProcessor
...
Cohesion: 0.06
Nodes (103): GameConfig, ContentCatalog, GridPos, ActorState, String, GeneratedFoliage, GeneratedResource, GeneratedWorld (+95 more)
...
### Community 46 - ".Log"
Cohesion: 0.06
Nodes (17): Container, ContainerBuilder, HideInCallstack, Object, DebugLogCategory, DebugProcessor, Container, ContainerBuilder (+9 more)
...
Cohesion: 0.05
Nodes (64): WorldGenConfig, actor_specific_exception_opens_only_the_requested_blocked_cell(), can_plan_for_three_hundred_agents(), DirtyRegion, grid(), manhattan(), NavGrid, NavigationError (+56 more)
...
### Community 61 - "Option"
Cohesion: 0.05
Nodes (97): AmbientLight, Assets, AssetServer, PresentationCatalog, actor_detail_budget(), animation_property_value(), animation_root_name(), BottomBarContextPanel (+89 more)
...
### Community 69 - "Enemy"
Cohesion: 0.09
Nodes (10): Action, float, Enemy, IEnumerator, bool, IEnumerator, int, List (+2 more)
...
### Community 77 - "STSM_Action_PlayerBase"
Cohesion: 0.14
...
Cohesion: 0.09
Nodes (10): STSM_Action_GatherResource, bool, float, Vector3, bool, float, uint, Vector3 (+2 more)
...
Cohesion: 0.04
Nodes (36): DepositResources, BuildingResourceModelHandler, GameObject, ResourceStorageModifier, float, int, Dictionary, float (+28 more)
...
Cohesion: 0.05
Nodes (14): BuildCostModifier, ObjectSelectionProcessor, InputButton, UserInterface.MainMenu, Processors, World, Level, Processors.Editor (+6 more)

### Community 126 - "Units"
Cohesion: 0.06
Nodes (16): AttackUnit, HealthModifier, bool, float, GameObject, HealUnit, STSM_Action_Heal, STStateMachine.States (+8 more)
...
### Community 131 - "retargeted_animation_clip"
Cohesion: 0.21
...
### Community 135 - ".SetGeneratedResources"
Cohesion: 0.40
...
Cohesion: 0.06
Nodes (21): Container, ContainerBuilder, GUIDProcessor, bool, BoxCollider, Container, ContainerBuilder, float (+13 more)
...
### Community 247 - "BuildingDamageMaterialHandler"
Cohesion: 0.29
...
Cohesion: 0.01
Nodes (108): CameraProcessor, CellSpacePartitioningInstaller, ContainerBuilder, ContainerBuilder, InstantiationBarrier, ContainerBuilder, MetaDataInstaller, PersistentScoped (+100 more)

### Community 277 - "ObjectPoolingSettings"
Cohesion: 0.25
...
### Community 293 - "ObjectiveSaveData"
Cohesion: 0.50
Nodes (3): int, string, ObjectiveSaveData

### Community 294 - "BuildingRuntimeData"
Cohesion: 0.50
...
- **Why does `SaveProcessor` connect `SaveProcessor` to `BuildingProcessor`, `SettingsProcessor`, `WorldGenProcessor`, `ObjectPoolingProcessor`, `Character`, `MonoBehaviour`, `PlayerProcessor`, `ScriptableObject`, `SaveFileData`, `GameEventProcessor`, `RoleProcessor`, `SeasonProcessor`, `TechTreeProcessor`, `.Log`, `StreamTownSessionBridge`, `ResourceProcessor`, `GameSettings`, `FoliageGenerationSettings`, `TimeProcessor`, `FoliageProcessor`, `UserInterface_GameMenu`, `ResourceDataSaveData`, `TownGoalProcessor`, `MainMenuManager`, `WorldSaveData`, `IProcessor`, `Resource`, `SaveDataMapper`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `WorldGenProcessor` connect `WorldGenProcessor` to `Target`, `BuildingProcessor`, `TwitchChatProcessor`, `ObjectPoolingProcessor`, `MonoBehaviour`, `PlayerProcessor`, `ScriptableObject`, `WorldGenRuntimeData`, `UserInterface_Debug`, `Player`, `GridProcessor`, `.Log`, `ResourceProcessor`, `TwitchClientProcessor`, `Access_Dropdown`, `Enemy`, `.GenerateFromSettings`, `CellSpacePartitioning`, `FoliageProcessor`, `Coordinator`, `EnemySpawner`, `IProcessor`, `SaveProcessor`, `AIPath`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `Player` connect `Player` to `BuildingProcessor`, `RoleData`, `TwitchChatProcessor`, `GUIDComponent`, `HealthHandler`, `ObjectPoolingProcessor`, `Character`, `Pet`, `BuildingPlacer`, `PlayerProcessor`, `MiscCommands`, `RoleHandler`, `GameEventProcessor`, `Station`, `UserInterface_Debug`, `CommandDictionary`, `BuildingRuntimeData`, `CharacterModelHandler`, `TwitchUser`, `UnitTextDisplay`, `StreamTownSessionBridge`, `Enemy`, `UserInterface_DisplayUsernames`, `LabelDisplayProcessor`, `TargetSensor`, `SelectedPlayer`, `SaveProcessor`, `VoteEvent`, `.SetTargetType`?**
...
- **Should `update_vote_panels` be split into smaller, more focused modules?**
