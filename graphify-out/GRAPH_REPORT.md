...
## Corpus Check
- 604 files · ~1,564,826 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6496 nodes · 16233 edges · 262 communities (241 shown, 21 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 991 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1bea69a5`
...
### Community 2 - "Option"
Cohesion: 0.09
Nodes (49): ContentCatalog, StationDef, ActorState, String, active_event_text(), actor_archetype(), apply_combat_damage(), archetype_by_source() (+41 more)
...
### Community 4 - "select_grid_cell"
Cohesion: 0.08
Nodes (42): AmbientLight, AppExit, camera_controls(), capture_screenshot(), credits_input(), debug_weather_override(), default_town_camera_transform(), environment_palette() (+34 more)
...
Cohesion: 0.10
Nodes (13): Func, List, BuildingDamageMaterialHandler, bool, IEnumerator, Renderer, Action, bool (+5 more)
...
Cohesion: 0.14
Nodes (30): ArchetypeBounds, ArchetypeDef, ArchetypeKind, ArchetypeScene, AuthoredRecord, AuthoredValue, BuildingDef, ContentError (+22 more)
...
Cohesion: 0.06
Nodes (56): ObjectiveDef, ObjectiveKind, FromStr, StableId, ActorCustomization, authored_trade_rates_clamp_to_stock_gold_and_capacity(), BuildingState, capped_deposit_preserves_inventory_overflow() (+48 more)
...
Cohesion: 0.05
Nodes (21): Container, ContainerBuilder, HideInCallstack, Object, DebugProcessor, int, STSM_Helper_Build, STSM_Action_Build (+13 more)
...
### Community 83 - "process_injected_commands"
Cohesion: 0.09
Nodes (103): AssetServer, GameConfig, Default, GridPos, GeneratedWorld, Vec, actor_material(), Agent (+95 more)
...
Cohesion: 0.04
Nodes (105): App, cell_hash(), changing_seed_changes_world_hash(), generate_world(), GeneratedResource, generation_is_deterministic(), hash_world(), String (+97 more)
...
Cohesion: 0.05
Nodes (29): DepositResources, PlayerInventory, Dictionary, ResourceInventory, bool, int, int, ActiveResourceIncrementer (+21 more)

### Community 120 - "run_transport"
Cohesion: 0.14
...
### Community 131 - "drive_converted_animations"
Cohesion: 0.21
Nodes (15): AnimationNodeIndex, AnimationPlayer, ActorAnimationDriver, animation_nodes_for_selection(), apply_animation_blend(), building_instance_ids(), ConvertedAnimationDriver, current_normalized_time() (+7 more)
...
### Community 138 - "IRuntimeDataScriptable"
Cohesion: 0.15
...
### Community 149 - "ResourceGenerationSettings"
Cohesion: 0.18
...
Cohesion: 0.07
Nodes (13): PersistentScoped, Transform, PlayerSpawnPoint, Slider, TextMeshProUGUI, UI_Objective, float, Vector3 (+5 more)
...
### Community 190 - "TechVoteSaveData"
Cohesion: 0.33
...
### Community 192 - "WeatherProcessor"
Cohesion: 0.08
...
### Community 208 - "ResourceDataSettings"
Cohesion: 0.25
...
### Community 221 - "BuildingRuntimeData"
Cohesion: 0.50
...
Cohesion: 0.12
Nodes (27): AnimationClip, AnimationGraph, AnimationGraphHandle, AnimationTargetId, Assets, add_rotation_curve(), add_scale_curve(), add_translation_curve() (+19 more)

### Community 225 - "WorldSaveData"
Cohesion: 0.09
Nodes (17): int, string, ObjectiveSaveData, List, SaveGameData, bool, int, List (+9 more)
...
Cohesion: 0.03
Nodes (58): List, FoliageGenSettings, bool, ParticleSystem, Transform, GameEventSettings, int, Vector2 (+50 more)
...
- **Why does `SaveProcessor` connect `SaveProcessor` to `BuildingProcessor`, `MonoBehaviour`, `GUIDProcessor`, `SettingsProcessor`, `WorldGenProcessor`, `Character`, `ResourceGenerationSettings`, `PlayerProcessor`, `ScriptableObject`, `FoliageGenerationSettings`, `SaveFileData`, `ResourceDataSaveData`, `GameEventProcessor`, `TechTreeProcessor`, `TimeProcessor`, `SeasonProcessor`, `PlayerRole`, `StreamTownSessionBridge`, `DebugProcessor`, `PlayerCommands`, `TechVoteSaveData`, `IProcessor`, `ResourceProcessor`, `FoliageProcessor`, `WorldSaveData`, `MainMenuManager`, `TownGoalProcessor`, `SaveDataMapper`, `Resource`, `ObjectPoolingProcessor`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `WorldGenProcessor` connect `WorldGenProcessor` to `BuildingProcessor`, `TwitchChatProcessor`, `MonoBehaviour`, `GUIDProcessor`, `Target`, `.GenerateFromSettings`, `ResourceGenerationSettings`, `PlayerProcessor`, `ScriptableObject`, `RaidEvent`, `CellSpacePartitioning`, `UserInterface_Debug`, `SaveProcessor`, `GameStateProcessor`, `TerrainGenSettings`, `ResourceData`, `TwitchClientProcessor`, `ProjectCamera`, `WorldGenRuntimeData`, `DebugProcessor`, `IProcessor`, `GridProcessor`, `ResourceProcessor`, `CampGenerationSettings`, `FoliageProcessor`, `Player`, `EnemySpawner`, `AIPath`, `ObjectPoolingProcessor`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `SettingsProcessor` connect `SettingsProcessor` to `ScriptablesProcessorInfrastructure`, `GraphicsProcessor`, `Access_Slider`, `IProcessor`, `SettingsData`, `SaveProcessor`, `MainMenuManager`, `Access_GOList`, `MonoBehaviour`, `Autosave`, `Access_Toggle`, `Access_Dropdown`, `Access_TextInput`, `Access_Text`, `ProjectCamera`?**
