...
## Corpus Check
- 670 files · ~1,775,402 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8935 nodes · 26081 edges · 309 communities (288 shown, 21 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 1044 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4120de95`
...
Cohesion: 0.03
Nodes (48): BuildingBase, bool, float, int, List, UnityEvent, SortBuildingByLowerLevel, TilerBuilding (+40 more)
...
### Community 4 - "Res"
Cohesion: 0.04
Nodes (204): Aabb, Added, AnimatedBy, AnimationGraphHandle, AnimationPlayer, AnimationTransitions, AudioSink, ActivePetVisual (+196 more)

### Community 5 - "update_environment_presentation"
Cohesion: 0.09
Nodes (34): AmbientLight, autosave_game(), building_damage_intensity(), building_damage_value(), building_snow_strength(), BuildingMaterialInstance, BuildingMaterialInstanced, BuildingMaterialInstances (+26 more)
...
Cohesion: 0.06
Nodes (62): AccessibilityNode, AssetId, advance_loading_phase(), advance_loading_runtime(), advance_world_loading_cover(), asset_root_collection_ready(), authored_rotating_node_names(), begin_world_loading_cover() (+54 more)
...
### Community 9 - ".new"
Cohesion: 0.03
Nodes (154): AccessibilityActionRequest, generate_world(), generate_world_with_content(), accessibility_motion_preferences_preserve_authored_parameters(), accessibility_navigation_preserves_editable_text_focus(), accessibility_scope_keeps_modal_navigation_inside_the_open_surface(), accessibility_tagging_tolerates_ui_removed_before_deferred_annotation(), action_ranges_and_tower_acquisition_are_euclidean() (+146 more)
...
Cohesion: 0.03
Nodes (242): GameConfig, GameplayConfig, BTreeMap, ContentCatalog, EnemyDef, ObjectiveDef, ObjectiveKind, ResourceReward (+234 more)
...
Cohesion: 0.06
Nodes (56): BTreeSet, TwitchConfig, secrets_restart_requirements(), SecretsAuthorizationEvent, bot_and_broadcaster_tokens_use_distinct_vault_entries(), broadcaster_oauth_uses_only_the_stream_key_scope(), channel_point_reward_tag_survives_privmsg_conversion(), CredentialVault (+48 more)
...
### Community 23 - "Option"
Cohesion: 0.04
Nodes (213): MainMenuModelInstance, MainMenuSceneReference, Option, String, PresentationCatalog, ActiveMaterialHandles, actor_material(), AgentCommandQueue (+205 more)

### Community 24 - "Result"
Cohesion: 0.26
Nodes (6): BinaryParser<'a>, FnMut, Result, Self, T, LegacyWorldState

### Community 25 - ".LoadSceneAsync"
Cohesion: 0.17
...
Cohesion: 0.13
Nodes (37): WorldGenConfig, authored_grid_centre(), authored_world_to_grid(), AuthoredResourceLayer, avalanche_instance_hash(), cell_hash(), changing_seed_changes_world_hash(), fnv_mix() (+29 more)

### Community 30 - "String"
Cohesion: 0.03
Nodes (170): AccessibilityFocusVisualQuery, AccessibleNode, AppExit, RulerVoteKind, accessibility_button_enabled(), accessibility_input(), accessibility_scope_active(), accessibility_should_clear_focus() (+162 more)
...
Cohesion: 0.04
Nodes (43): GlobalAudioController, AudioSource, bool, float, IEnumerator, SeasonAudioData, AudioClip, List (+35 more)
...
Cohesion: 0.08
Nodes (21): Mesh, Transform, Vector3, SaveDataMapper, int, uint, EnemyCampSaveData, string (+13 more)
...
### Community 76 - ".Log"
Cohesion: 0.04
Nodes (41): Action, CancellationToken, Task, IAsyncInitializableProcessor, ProcessorStartupContext, HideInCallstack, Object, Container (+33 more)
...
Cohesion: 0.05
Nodes (69): AudioMixSettings, BuildingHealthDisplayMode, CameraSettings, clamp_sensitivity(), clamp_unit(), default_ui_scale_percent(), defaults_are_valid_and_round_trip(), DisplayMode (+61 more)
...
### Community 91 - "UserInterface_TownGoal"
Cohesion: 0.19
...
Cohesion: 0.01
Nodes (126): CameraProcessor, CellSpacePartitioningInstaller, ContainerBuilder, ContainerBuilder, InstantiationBarrier, ContainerBuilder, MetaDataInstaller, ContainerBuilder (+118 more)
...
### Community 100 - "TechTreeUtilities"
Cohesion: 0.16
...
Cohesion: 0.07
Nodes (51): AnimationClip, AnimationGraph, AnimationNodeIndex, AnimationTargetId, add_animation_composition(), add_animation_layer_branch(), add_rotation_curve(), add_scale_curve() (+43 more)
...
Cohesion: 0.08
Nodes (34): apply_direct_broadcast_control(), AuthorizationEvent, BroadcastMetricsSnapshot, BroadcastPrerequisites, BroadcastTarget, configure_direct_broadcast(), DirectBroadcastControl, DirectBroadcastPhase (+26 more)
...
Cohesion: 0.11
Nodes (17): bool, float, ParticleSystem, SortedSet, Transform, GameEventRuntimeData, EnemyType, Foliage (+9 more)
...
Cohesion: 0.12
Nodes (12): Color, Foldout, List, Port, Sprite, VisualElement, TechTreeNode, Action (+4 more)
...
### Community 172 - "EquipmentHandlerEditor"
Cohesion: 0.29
...
### Community 195 - "Utils"
Cohesion: 0.04
Nodes (40): BuildCostModifier, InputButton, STStateMachine.States, UserInterface.MainMenu, PlayerControls.ObjectSelection, Units, Utils, Processors (+32 more)
...
### Community 221 - "format_game_master_ids"
Cohesion: 0.40
...
Cohesion: 0.01
Nodes (242): AnyResult, accessibility_settings_selection(), AccessibilityActionDispatch, AccessibilityCandidate, AccessibilityHighContrastText, actor_detail_budget(), actor_scene_budget(), ActorHealthFill (+234 more)
...
### Community 264 - "preview_lerp_color"
Cohesion: 1.00
...
Cohesion: 0.09
Nodes (11): Slider, TextMeshProUGUI, UI_Objective, bool, float, VisualEffect, VfxAnimationController, Transform (+3 more)
...
Cohesion: 0.07
Nodes (33): average_milliseconds(), bandwidth_test_never_claims_to_be_publicly_live(), bandwidth_test_url_is_constructed_without_logging_the_key(), begin_twitch_live_verification(), build_ingest_url(), DirectBroadcastSnapshot, DirectTwitchBroadcastPlugin, draw_centered_sensitive_label() (+25 more)
...
Cohesion: 0.03
Nodes (29): Api, PersistentScoped, Projectile, Transform, PlayerSpawnPoint, TL_API, Image, TextMeshProUGUI (+21 more)

### Community 310 - "IRuntimeDataScriptable"
Cohesion: 0.05
Nodes (23): InputButton, SharedTypes, CreditsRuntimeData, bool, GameStateRuntimeData, IRuntimeDataScriptable, bool, Dictionary (+15 more)
...
- **Why does `Utils` connect `Utils` to `StringUtils`, `EnemySpawner`, `TechTree.Elements`, `CommonEnums.cs`, `EventProcessor`, `GenerationSettings`, `UpdateGraphBounds`, `IProcessor`, `DebugProcessor`, `AudioHandler`, `SimpleDisableAfterTime`, `IRuntimeDataScriptable`, `UIProcessor`, `ScriptablesProcessorInfrastructure`, `CameraController`, `BuildingPlacer`, `FPSDisplay`, `MonoBehaviour`, `DayAndNightProcessor`, `SnapToGridMouseMovement`, `RoleData`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `StableId` connect `StableId` to `String`, `Res`, `update_environment_presentation`, `advance_world_loading_cover`, `.new`, `Result`, `save.rs`, `command.rs`, `twitch.rs`, `Option`, `simulation.rs`, `stream_town_migrate/src/presentation.rs`, `world.rs`, `String`, `stream_town_tools/src/main.rs`, `stream_town_domain/src/content.rs`, `TechnologyGraphViewState`, `AnimationControllerDef`, `runtime_console.rs`, `String`, `stream_town_migrate/src/menu_scene.rs`, `.new`, `ToolState`, `stream_town_migrate/src/content.rs`, `tools_ui`, `config.rs`, `convert`, `stream_town_domain/src/presentation.rs`, `stream_town_game/src/lib.rs`, `Result`, `build_converted_animation`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `PlayerProcessor` connect `PlayerProcessor` to `PlayerRole`, `BuildingProcessor`, `.PrepareRuntimeForLoad`, `EnemySpawner`, `TwitchChatProcessor`, `BottomBarInterface`, `GameEvent`, `UserInterface_Debug`, `HealthHandler`, `WorldGenProcessor`, `TimeProcessor`, `MiscCommands`, `IProcessor`, `TechTreeProcessor`, `NewKingVote`, `Player`, `StreamTownSessionBridge`, `TwitchClientProcessor`, `UIProcessor`, `PlayerRoleData`, `Utils`, `.Log`, `UserInterface_TownVote`, `BuildingPlacer`, `RoleHandler`, `MonoBehaviour`, `Resource`, `SaveProcessor`, `GameEventProcessor`, `Enemy`, `RoleData`?**
