...
## Corpus Check
- 670 files · ~1,824,412 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9479 nodes · 28682 edges · 311 communities (287 shown, 24 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 1061 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6bd2b8fc`
...
Cohesion: 0.05
Nodes (76): AmbientLight, ActiveMaterialHandles, blend_environment_palette(), building_damage_intensity(), building_damage_value(), building_material(), building_snow_strength(), BuildingMaterialInstance (+68 more)
...
### Community 4 - "RuntimeConfig"
Cohesion: 0.03
Nodes (187): AccessibilityActionRequest, AccessibilityFocusVisualQuery, AnyResult, PlayerSettings, Default, accessibility_input(), accessibility_scope_active(), accessibility_settings_selection() (+179 more)

### Community 5 - "stream_town_game/src/lib.rs"
Cohesion: 0.01
Nodes (402): ArchetypeKind, generate_world(), generate_world_with_content(), accessibility_motion_preferences_preserve_authored_parameters(), accessibility_navigation_preserves_editable_text_focus(), accessibility_scope_keeps_modal_navigation_inside_the_open_surface(), accessibility_tagging_tolerates_ui_removed_before_deferred_annotation(), AccessibilityActionDispatch (+394 more)
...
Cohesion: 0.05
Nodes (14): ContainerBuilder, AudioSettingsInstaller, ContainerBuilder, ResourceDataSettingsInstaller, int, AudioSettings, bool, int (+6 more)
...
### Community 18 - "Vec"
Cohesion: 0.04
Nodes (106): AnimationClip, AnimationTargetId, add_animation_composition(), add_animation_layer_branch(), add_rotation_curve(), add_scale_curve(), add_translation_curve(), advance_animation_crossfade() (+98 more)
...
### Community 25 - "Option"
Cohesion: 0.04
Nodes (185): GameConfig, ArchetypeDef, ArchetypeScene, PresentationCatalog, GeneratedWorld, actor_material(), advance_falling_fish(), agent_path_world_target() (+177 more)
...
### Community 29 - "Ui"
Cohesion: 0.09
Nodes (69): animation_assets_editor(), animation_condition_mode_choice(), animation_controller_editor(), animation_layer_blend_choice(), animation_layers_editor(), animation_parameter_kind_choice(), animation_parameters_editor(), animation_property_curves_editor() (+61 more)

### Community 30 - "Res"
Cohesion: 0.03
Nodes (232): Added, AnimatedBy, AnimationGraphHandle, AnimationTransitions, AudioSink, ActivePetVisual, ActorAnimationDriver, ActorHealthOverlay (+224 more)

### Community 31 - "WorldGenProcessor"
Cohesion: 0.06
Nodes (27): HashSet, Action, bool, BoxCollider, Container, Func, GameObject, HashSet (+19 more)

### Community 32 - "simulation.rs"
Cohesion: 0.07
Nodes (36): ActorCustomization, authored_trade_rates_clamp_to_stock_gold_and_capacity(), building_damage_and_repair_preserve_health_bounds(), building_upgrade_reenters_the_full_construction_phase(), capped_deposit_preserves_inventory_overflow(), default_ruler_vote_cooldown(), deterministic_fish_god_value(), deterministic_weather() (+28 more)
...
Cohesion: 0.08
Nodes (16): Vector3, Container, ContainerBuilder, List, TargetProcessor, Dictionary, List, TargetRuntimeData (+8 more)
...
Cohesion: 0.03
Nodes (141): accessibility_button_enabled(), AccessibilityMotionDefaults, AccessibleButtonNodeQuery, AccessibleButtonScope, apply_authored_main_menu_camera(), apply_authored_ui_fonts(), authored_main_ui_image_with_ppu(), authored_ui_image() (+133 more)

### Community 39 - "BinarySaveCodec"
Cohesion: 0.15
Nodes (6): Func, int, List, UTF8Encoding, BinarySaveCodec, BinaryReader
...
Cohesion: 0.07
Nodes (98): ContentCatalog, DirtyRegion, GridPos, ActorState, String, action_animation_speed(), action_cooldown(), active_station_ids() (+90 more)
...
### Community 52 - "World.Generation.Settings"
Cohesion: 0.04
Nodes (32): Projectile, CampGenerationSettings, List, CampGenerationSettingsContainer, FoliageGenerationSettings, List, FoliageGenerationSettingsContainer, List (+24 more)
...
Cohesion: 0.16
Nodes (39): StreamUserType, binary_fixture(), binary_schemas_one_through_three_decode_and_validate_trailer(), BinaryParser, decode_json(), json_active_goal(), json_buildings(), json_customization() (+31 more)
...
Cohesion: 0.02
Nodes (101): ContainerBuilder, GameEventConfigSettingsInstaller, ContainerBuilder, GameSettingsInstaller, ContainerBuilder, TimeDataSettingsInstaller, ContainerBuilder, WorldGenBehaviorSettingsInstaller (+93 more)
...
Cohesion: 0.07
Nodes (52): ArchetypeBounds, AuthoredRecord, AuthoredValue, BuildingDef, BuildingModelDef, ContentError, default_resource_generation_layers(), EnemyCampGenerationDef (+44 more)
...
Cohesion: 0.07
Nodes (39): ObjectiveDef, ObjectiveKind, Display, FromStr, StableId, BuildingState, complete_gameplay_scenario_round_trips(), objective_increment() (+31 more)

### Community 74 - "Utils"
Cohesion: 0.04
Nodes (28): BuildCostModifier, InputButton, STStateMachine.States, UserInterface.MainMenu, PlayerControls.ObjectSelection, Units, Utils, Processors (+20 more)
...
### Community 85 - "TownResourceProcessor"
Cohesion: 0.08
Nodes (10): int, ActiveResourceIncrementer, Container, ContainerBuilder, Dictionary, TownResourceProcessor, Container, ContainerBuilder (+2 more)

### Community 86 - "buildings_tab"
Cohesion: 0.14
Nodes (24): ability_choices(), action_animation_choices(), animation_events_editor(), animation_quat_keys_editor(), animation_transform_tracks_editor(), animation_vec3_keys_editor(), building_model_node_choices(), buildings_tab() (+16 more)
...
Cohesion: 0.05
Nodes (62): invalid_requests_are_rejected_before_writing(), read_optional_json(), request_and_status_round_trip_through_atomic_store(), BTreeMap, Error, Into, Option, Path (+54 more)
...
Cohesion: 0.04
Nodes (26): SortBuildingByLowerLevel, Transform, Animator, GameObject, IEnumerator, int, FishGodEvent, bool (+18 more)

### Community 92 - "DebugProcessor"
Cohesion: 0.05
Nodes (19): AttackUnit, Container, ContainerBuilder, HideInCallstack, Object, DebugProcessor, int, STSM_Helper_Build (+11 more)

### Community 93 - "MonoBehaviour"
Cohesion: 0.01
Nodes (95): Api, CameraProcessor, CellSpacePartitioningInstaller, ContainerBuilder, ContainerBuilder, InstantiationBarrier, PersistentScoped, ContainerBuilder (+87 more)

### Community 94 - "convert_fbx_to_glb.py"
Cohesion: 0.14
Nodes (28): arguments(), bake_uniform_scale(), bounds_record(), convert(), discover_sources(), evaluated_scene_bounds(), inspect_glb(), main() (+20 more)

### Community 95 - "LabelDisplayProcessor"
Cohesion: 0.08
...
Cohesion: 0.04
Nodes (32): DepositResources, BuildingResourceModelHandler, GameObject, ResourceStorageModifier, float, int, PlayerInventory, Dictionary (+24 more)
...
Cohesion: 0.08
Nodes (12): Container, ContainerBuilder, EventType, ParticleSystem, SortedSet, Transform, GameEventProcessor, EventType (+4 more)

### Community 103 - "TownGoalProcessor"
Cohesion: 0.19
Nodes (6): Container, ContainerBuilder, Goal, List, Objective, TownGoalProcessor

### Community 104 - "SaveProcessor.cs"
Cohesion: 0.05
...
Cohesion: 0.08
Nodes (18): Color, List, Texture2D, EditorUtils, string, ScriptableObjectAssetData, BuildingScriptablesEditor, bool (+10 more)
...
Cohesion: 0.04
Nodes (19): BuildingModelHandler, GameObject, List, BuildingModelHandlerEditor, BuildingPlacerEditor, BuildingResourceModelHandlerEditor, EnemyModelHandlerEditor, RoleScriptablesEditor (+11 more)
...
### Community 140 - "DirectBroadcastControl"
Cohesion: 0.11
...
Cohesion: 0.13
Nodes (29): ActorKind, actor_prefix(), clamped_cell(), content_id(), convert(), duration_days(), entity_id(), ImportReport (+21 more)
...
### Community 154 - "IProcessor"
Cohesion: 0.17
Nodes (5): Container, IProcessor, Container, ContainerBuilder, WeatherProcessor

### Community 155 - "advance_world_loading_cover"
Cohesion: 0.07
Nodes (54): AccessibilityNode, advance_loading_phase(), advance_loading_runtime(), advance_world_loading_cover(), asset_root_collection_ready(), begin_world_loading_cover(), begin_world_reveal(), boot_loading_display_progress() (+46 more)
...
### Community 163 - "GeneratedResource"
Cohesion: 0.24
...
### Community 171 - "STSM_StateAction"
Cohesion: 0.24
...
### Community 173 - "EnemyModelHandler"
Cohesion: 0.09
Nodes (10): bool, int, List, EnemyModelHandler, int, STSM_Action_Attack, bool, float (+2 more)
...
### Community 195 - "PassiveResourceIncrementer"
Cohesion: 0.24
...
### Community 198 - "effective_role_stats"
Cohesion: 0.09
Nodes (32): actor_movement_speed(), authored_building_nodes_follow_construction_age_and_storage_fill(), building_construction_cost(), building_cost_reduction_percent(), building_cost_summary(), building_definition_id(), building_instance_ids(), building_max_health() (+24 more)
...
### Community 208 - "draw_world_preview"
Cohesion: 0.29
...
Cohesion: 0.06
Nodes (66): apply_building_draft(), AssetEditorSection, authoring_apply_preserves_the_complete_local_twitch_setup(), authority_tab(), building_draft(), building_editor_preserves_the_complete_template_record(), BuildingDraft, canonical_preview_node_name() (+58 more)
...
### Community 221 - "parse_model_clip_events"
Cohesion: 0.31
...
### Community 243 - "EquipmentHandlerEditor"
Cohesion: 0.29
...
### Community 253 - ".new"
Cohesion: 0.17
Nodes (16): absolute_path(), backup_candidate(), checked_in_schema_one_fixture_imports_retained_terrain(), conversion_preserves_mesh_and_relocates_invalid_positions(), conversion_rejects_malformed_retained_mesh(), decode_binary(), decode_legacy(), export_world_oracle() (+8 more)
...
### Community 276 - "PlayerDeathHandler"
Cohesion: 0.29
...
Cohesion: 0.06
Nodes (67): apply_preview_material_overrides(), apply_preview_node_visibility(), drive_model_preview_animation(), foliage_editor_rejects_invalid_generation_values_without_mutation(), frame_model_preview(), main(), ModelPreviewCamera, ModelPreviewRuntime (+59 more)
...
### Community 287 - "BuildingConfigSettings"
Cohesion: 0.29
Nodes (5): ContainerBuilder, BuildingConfigSettingsInstaller, Dictionary, int, BuildingConfigSettings

### Community 289 - "String"
Cohesion: 0.03
Nodes (80): AccessibleNode, AssetId, active_event_text(), AgentCommand, AgentCommandQueue, announce_technology_vote(), authored_rotating_node_names(), AuthoredCreditsElement (+72 more)

### Community 291 - "Requirement"
Cohesion: 0.33
Nodes (4): RequirementType, object, Requirement, Requirements

### Community 292 - "RandomEnabler"
Cohesion: 0.33
Nodes (4): float, GameObject, IEnumerator, RandomEnabler

### Community 293 - "OpenNode"
Cohesion: 0.43
...
### Community 297 - "selection_panel_details"
Cohesion: 0.33
Nodes (7): EnemyCampState, RaidState, BTreeSet, building_health_fraction(), selected_enemy_camp_at_cell(), selection_panel_actor_details(), selection_panel_details()

### Community 298 - "resolve_combat_projectile_impact"
Cohesion: 0.38
...
### Community 302 - "technology_vote_options"
Cohesion: 0.47
Nodes (6): resolve_active_technology_vote_option(), resolve_technology_id(), TechVote, technology_vote_leader(), technology_vote_option_tally(), technology_vote_options()
...
## Knowledge Gaps
- **384 isolated node(s):** `StreamTown.EditorTools`, `Attributes`, `BuildCostModifier`, `StartupState`, `InputButton` (+379 more)
...
- **Why does `Utils` connect `Utils` to `EnemySpawner`, `Editor`, `ScriptablesProcessorInfrastructure`, `TechTree.Elements`, `BuildingConfigSettings`, `GenerationSettings`, `RandomEnabler`, `SimpleScreenShot`, `Easings`, `ScriptableObject`, `World.Generation`, `BuildingPlacer`, `CommonEnums.cs`, `StringUtils`, `SnapToGridMouseMovement`, `FPSDisplay`, `MonoBehaviour`, `SaveProcessor.cs`, `UpdateGraphBounds`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `StableId` connect `StableId` to `setup_rendering`, `String`, `stream_town_game/src/lib.rs`, `config.rs`, `save.rs`, `Vec`, `command.rs`, `twitch.rs`, `String`, `Option`, `advance_world_loading_cover`, `.default`, `Ui`, `Res`, `.new`, `simulation.rs`, `String`, `GeneratedResource`, `RenderAssets`, `selection_panel_details`, `resolve_combat_projectile_impact`, `ToolState`, `AnimationControllerDef`, `technology_vote_options`, `ContentCatalog`, `stream_town_migrate/src/presentation.rs`, `TechnologyGraphLayout`, `stream_town_domain/src/content.rs`, `stream_town_migrate/src/menu_scene.rs`, `Result`, `effective_role_stats`, `stream_town_migrate/src/content.rs`, `technology_graph.rs`, `draw_world_preview`, `stream_town_tools/src/main.rs`, `buildings_tab`, `settings.rs`, `stream_town_domain/src/presentation.rs`, `world.rs`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `PlayerProcessor` connect `PlayerProcessor` to `BuildingProcessor`, `SelectedPlayerGroup`, `EnemySpawner`, `TwitchChatProcessor`, `BottomBarInterface`, `UserInterface_Debug`, `HealthHandler`, `IProcessor`, `WorldGenProcessor`, `TechTreeProcessor`, `Player`, `.Log`, `StreamTownSessionBridge`, `TwitchClientProcessor`, `UIProcessor`, `UserInterface_TownVote`, `Utils`, `RoleHandler`, `BuildingPlacer`, `TimeProcessor`, `TownResourceProcessor`, `GameEvent`, `MonoBehaviour`, `SaveProcessor`, `GameEventProcessor`, `VoteEvent`?**
...
- **Should `BuildingProcessor` be split into smaller, more focused modules?**
  _Cohesion score 0.03686396677050883 - nodes in this community are weakly interconnected._
