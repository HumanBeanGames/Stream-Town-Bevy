...
## Corpus Check
- 609 files · ~1,606,067 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7038 nodes · 18512 edges · 264 communities (241 shown, 23 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 994 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fe53f9d0`
...
Cohesion: 0.05
Nodes (70): AnimationClip, AnimationGraph, AnimationGraphHandle, AnimationNodeIndex, AnimationPlayer, AnimationTargetId, ActorAnimationDriver, add_animation_layer_branch() (+62 more)
...
### Community 12 - "GameMasterCommands"
Cohesion: 0.11
...
### Community 16 - "Utils"
Cohesion: 0.06
Nodes (7): Utils, Animation, SavingAndLoading, Twitch.Commands, VFX, SavingAndLoading.Structs, Character
...
### Community 27 - "ResMut"
Cohesion: 0.08
Nodes (55): AppExit, BackgroundColor, AuthoredCreditsElement, autosave_game(), broadcaster_gate_precedes_twitch_command_dispatch(), capture_screenshot(), credits_input(), CreditsFade (+47 more)
...
Cohesion: 0.05
Nodes (20): AttackUnit, HealthModifier, bool, float, GameObject, HealUnit, STSM_Action_Build, STSM_Action_GatherResource (+12 more)

### Community 33 - "simulation.rs"
Cohesion: 0.08
...
Cohesion: 0.04
Nodes (37): Station, Dictionary, float, int, List, Queue, Transform, Vector3 (+29 more)
...
Cohesion: 0.11
Nodes (32): StreamUserType, active_event_text(), building_definition_id(), building_model_node_names(), CommandFeedback, CommandOrigin, eligible_technology_ids(), equipment_node_names() (+24 more)
...
Cohesion: 0.10
Nodes (11): Dictionary, DebugSettings, ContainerBuilder, DebugSettingsInstaller, Container, ContainerBuilder, DebugLogCategory, DebugProcessor (+3 more)
...
Cohesion: 0.09
Nodes (37): AmbientLight, Assets, building_damage_intensity(), building_damage_value(), building_snow_strength(), BuildingMaterialInstance, BuildingMaterialInstanced, BuildingMaterialInstances (+29 more)
...
Cohesion: 0.03
Nodes (98): AnyResult, AudioSink, ActivePetVisual, adjust_settings_menu(), AgentCommand, AgentCommandQueue, AgentEquipmentPresentation, AmbienceAudio (+90 more)
...
### Community 90 - "Option"
Cohesion: 0.10
Nodes (59): AssetServer, ArchetypeDef, ArchetypeKind, ArchetypeScene, PresentationCatalog, actor_detail_budget(), actor_scene_budget(), animation_property_value() (+51 more)
...
Cohesion: 0.12
Nodes (13): Coordinator, StartupState, Action, bool, CancellationTokenSource, Dictionary, GameObject, IEnumerator (+5 more)
...
Cohesion: 0.06
Nodes (13): BuildingModelHandlerEditor, BuildingPlacerEditor, BuildingResourceModelHandlerEditor, EnemyModelHandlerEditor, RoleScriptablesEditor, WindControllerEditor, GridProcessorEditor, GridSystemEditor (+5 more)
...
### Community 120 - "TreeMaterialExtension"
Cohesion: 0.15
...
### Community 121 - "Res"
Cohesion: 0.07
Nodes (123): Added, actor_material(), ActorNameOverlay, Agent, agent_is_moving(), AgentAnimation, animate_agents(), animate_building_effects() (+115 more)
...
### Community 131 - "select_grid_cell"
Cohesion: 0.12
Nodes (21): AccumulatedMouseMotion, AccumulatedMouseScroll, apply_player_settings(), camera_controls(), default_town_camera_transform(), player_msaa(), player_window_mode(), select_grid_cell() (+13 more)

### Community 132 - ".Update"
Cohesion: 0.17
Nodes (16): List, Material, materials, Mesh, meshes, Dictionary, int, List (+8 more)

### Community 133 - ".EnsureValidCredentials"
Cohesion: 0.19
...
Cohesion: 0.05
Nodes (27): ActivityStatus, InputButton, SharedTypes, bool, float, string, UserType, TwitchUser (+19 more)
...
### Community 170 - ".GetMissingProcessorDependencies"
Cohesion: 0.27
...
### Community 204 - "CreditsProcessor"
Cohesion: 0.28
...
### Community 217 - "WorldGenLayerSettings"
Cohesion: 0.33
...
Cohesion: 0.02
Nodes (76): ContainerBuilder, BuildingConfigSettingsInstaller, ContainerBuilder, FoliageGenSettingsInstaller, ContainerBuilder, GameEventConfigSettingsInstaller, ContainerBuilder, TimeDataSettingsInstaller (+68 more)
...
- **Why does `SaveProcessor` connect `SaveProcessor` to `BuildingProcessor`, `TwitchChatProcessor`, `SettingsProcessor`, `WorldGenProcessor`, `UserInterface_GameMenu`, `.Log`, `MonoBehaviour`, `PlayerProcessor`, `ScriptableObject`, `IInstaller`, `UserInterface`, `ResourceDataSaveData`, `GameEventProcessor`, `SaveFileData`, `TechTreeProcessor`, `TimeProcessor`, `SeasonProcessor`, `DebugProcessor`, `IProcessor`, `SaveDataMapper`, `StreamTownSessionBridge`, `ResourceProcessor`, `PoolableObject`, `FoliageProcessor`, `PlayerRole`, `WorldSaveData`, `TownGoalProcessor`, `MainMenuManager`, `Resource`, `ResourceGenerationSettings`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `WorldGenProcessor` connect `WorldGenProcessor` to `BuildingProcessor`, `TwitchChatProcessor`, `GameMasterCommands`, `.Log`, `MonoBehaviour`, `.GenerateFromSettings`, `PlayerProcessor`, `ScriptableObject`, `IInstaller`, `UserInterface_Debug`, `CampGenerationSettings`, `DebugProcessor`, `IProcessor`, `TerrainGenSettings`, `ResourceProcessor`, `TwitchClientProcessor`, `PoolableObject`, `WorldGenDebugSettings`, `Target`, `WorldGenRuntimeData`, `ProjectCamera`, `GridProcessor`, `CellSpacePartitioning`, `WorldGenLayerSettings`, `FoliageProcessor`, `RaidEvent`, `WorldGenScaleSettings`, `Coordinator`, `LoadingManager`, `EnemySpawner`, `SaveProcessor`, `ResourceGenerationSettings`, `AIPath`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `Player` connect `Player` to `BuildingProcessor`, `TwitchChatProcessor`, `GameMasterCommands`, `RoleData`, `Pet`, `BuildingPlacer`, `PlayerProcessor`, `HealthHandler`, `UserInterface`, `GameEventProcessor`, `Station`, `UserInterface_Debug`, `MiscCommands`, `SelectedPlayerGroup`, `CharacterModelHandler`, `LabelDisplayProcessor`, `StreamTownSessionBridge`, `PoolableObject`, `RoleHandler`, `UserInterface_DisplayUsernames`, `TargetSensor`, `SaveProcessor`, `VoteEvent`, `Resource`, `.SetTargetType`, `CommandDictionary`?**
