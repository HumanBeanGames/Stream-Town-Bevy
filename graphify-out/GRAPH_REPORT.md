...
## Corpus Check
- 671 files · ~1,779,939 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8992 nodes · 26231 edges · 315 communities (286 shown, 29 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 1044 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `33a3732b`
...
### Community 0 - "Vec"
Cohesion: 0.05
Nodes (79): AnimationClip, AnimationGraph, AnimationNodeIndex, AnimationTargetId, add_animation_composition(), add_animation_layer_branch(), add_rotation_curve(), add_scale_curve() (+71 more)

### Community 1 - "BuildingProcessor"
Cohesion: 0.05
Nodes (24): BuildPlacerData, GameObject, Renderer, string, Vector2, bool, Dictionary, int (+16 more)
...
Cohesion: 0.05
Nodes (62): AccessibilityNode, AssetId, advance_loading_phase(), advance_loading_runtime(), advance_world_loading_cover(), asset_root_collection_ready(), begin_world_loading_cover(), begin_world_reveal() (+54 more)
...
Cohesion: 0.11
Nodes (30): broadcast_render_mode_default(), BroadcastConfig, BroadcastEncoderPreference, BroadcastRenderMode, ConfigError, default_configuration_is_valid_and_round_trips_ron(), direct_broadcast_settings_are_strictly_validated(), ease_in_out_cubic() (+22 more)
...
### Community 18 - "Option"
Cohesion: 0.05
Nodes (164): ArchetypeScene, PresentationCatalog, actor_material(), actor_scene_budget(), advance_falling_fish(), animate_falling_fish(), apply_agent_commands(), apply_authored_main_menu_camera() (+156 more)
...
Cohesion: 0.09
Nodes (48): ArchetypeBounds, ArchetypeDef, ArchetypeKind, AuthoredRecord, AuthoredValue, BuildingDef, BuildingModelDef, ContentError (+40 more)
...
Cohesion: 0.05
Nodes (71): ObjectiveDef, ObjectiveKind, Display, FromStr, StableId, authored_trade_rates_clamp_to_stock_gold_and_capacity(), building_damage_and_repair_preserve_health_bounds(), BuildingState (+63 more)
...
### Community 30 - "ResMut"
Cohesion: 0.03
Nodes (160): AccessibilityFocusVisualQuery, AppExit, PlayerSettings, Default, accessibility_button_enabled(), accessibility_input(), accessibility_scope_active(), accessibility_should_clear_focus() (+152 more)
...
Cohesion: 0.03
Nodes (101): BackgroundColor, AccessibilityMotionDefaults, authored_main_ui_image_with_ppu(), authored_ui_image(), authored_ui_image_with_corner_scale(), BoundsMaterialExtension, BoundsMaterialUniform, BuildingMaterialExtension (+93 more)
...
Cohesion: 0.07
Nodes (89): ContentCatalog, GridPos, ActorState, EnemyCampState, String, action_animation_speed(), action_cooldown(), ActionPresentation (+81 more)
...
Cohesion: 0.05
Nodes (29): AudioHandler, AudioClip, AudioSource, bool, Camera, float, PlayerAudioHandler, ContainerBuilder (+21 more)
...
Cohesion: 0.02
Nodes (91): CameraProcessor, CellSpacePartitioningInstaller, ContainerBuilder, ContainerBuilder, InstantiationBarrier, ContainerBuilder, MetaDataInstaller, PersistentScoped (+83 more)
...
### Community 60 - "Result"
Cohesion: 0.17
Nodes (29): apply_foliage_draft(), apply_role_draft(), apply_technology_draft(), commit_catalog_candidate(), create_technology_group(), create_technology_node(), delete_selected_role(), delete_selected_technology_group() (+21 more)
...
Cohesion: 0.05
Nodes (82): AmbientLight, ActiveMaterialHandles, animate_main_menu_clouds(), apply_material_overrides(), building_damage_intensity(), building_damage_value(), building_material(), building_snow_strength() (+74 more)
...
### Community 82 - "UserInterface"
Cohesion: 0.07
Nodes (16): Slider, TextMeshProUGUI, UI_Objective, TextMeshProUGUI, UI_VoteObjectiveRow, Image, TextMeshProUGUI, UIRoleDisplay (+8 more)

### Community 83 - "DirectBroadcastRuntime"
Cohesion: 0.10
Nodes (27): apply_direct_broadcast_control(), bandwidth_test_never_claims_to_be_publicly_live(), begin_twitch_live_verification(), BroadcastMetricsSnapshot, DirectBroadcastControl, DirectBroadcastRuntime, poll_direct_broadcast_authorization(), poll_direct_broadcast_worker() (+19 more)
...
### Community 93 - "IProcessor"
Cohesion: 0.06
Nodes (17): TargetSettings, ContainerBuilder, TargetSettingsInstaller, Container, IProcessor, Action, Container, ContainerBuilder (+9 more)
...
### Community 107 - "GameConfig"
Cohesion: 0.14
Nodes (35): GameConfig, GameplayConfig, BTreeMap, StationDef, active_station_ids(), actor_idle_anchor(), append_terrain_skirt(), assigned_station() (+27 more)
...
### Community 111 - "TechTreeProcessor.cs"
Cohesion: 0.09
Nodes (9): InputButton, SharedTypes, TownGoal.Data, StreamTown.EditorTools, TownGoal, TechTree.Data, TechTree.ScriptableObjects, Data (+1 more)
...
### Community 116 - "drive_tidal_music"
Cohesion: 0.19
...
Cohesion: 0.11
Nodes (12): bool, int, Vector2, GridSettings, ContainerBuilder, GridSettingsInstaller, Container, ContainerBuilder (+4 more)
...
### Community 126 - "save_secrets_fields"
Cohesion: 0.16
Nodes (19): AnyResult, audio_acceptance_manifest(), audio_acceptance_record(), FoliageAcceptanceCapture, legacy_unity_settings_path(), load_player_settings(), load_runtime_config(), open_twitch_verification_uri() (+11 more)
...
Cohesion: 0.02
Nodes (100): ContainerBuilder, BuildingConfigSettingsInstaller, ContainerBuilder, CampGenSettingsInstaller, ContainerBuilder, FoliageGenSettingsInstaller, ContainerBuilder, GameEventConfigSettingsInstaller (+92 more)
...
Cohesion: 0.05
Nodes (16): BuildCostModifier, InputButton, Transform, PlayerSpawnPoint, UserInterface.MainMenu, Processors, World, Level (+8 more)
...
### Community 209 - "VfxAnimationController"
Cohesion: 0.12
...
Cohesion: 0.01
Nodes (277): AccessibleNode, accessibility_settings_selection(), AccessibilityActionDispatch, AccessibilityCandidate, AccessibilityHighContrastText, active_event_text(), actor_combat_visual(), actor_detail_budget() (+269 more)
...
Cohesion: 0.10
Nodes (47): authority_tab(), broadcast_encoder_label(), checked_in_authoring_assets_pass_headless_validation(), default_catalog_path(), default_config_path(), default_technology_layout_path(), foliage_editor_rejects_invalid_generation_values_without_mutation(), format_game_master_ids() (+39 more)
...
### Community 293 - "preview_grid_point"
Cohesion: 0.67
...
Cohesion: 0.07
Nodes (40): amf_quality_profile_keeps_static_grid_detail_between_keyframes(), AuthorizationEvent, average_milliseconds(), bandwidth_test_url_is_constructed_without_logging_the_key(), BroadcastPrerequisites, BroadcastTarget, build_ingest_url(), configure_amf_quality() (+32 more)

### Community 299 - "ToolState"
Cohesion: 0.11
Nodes (41): authoring_snapshot(), AuthoringSnapshot, content_tab(), draw_world_preview(), inject_runtime_command(), inspector_tab(), launch_runtime_game(), migration_tab() (+33 more)
...
Cohesion: 0.04
Nodes (18): Player, Dictionary, GameObject, Vector3, Vector3, OnChatCommandReceivedArgs, BroadcasterCommands, BuildingCommands (+10 more)
...
- **Why does `Utils` connect `Utils` to `StringUtils`, `EnemySpawner`, `TechTree.Elements`, `CommonEnums.cs`, `GenerationSettings`, `UpdateGraphBounds`, `Character`, `SimpleScreenShot`, `Processors`, `Units`, `ScriptablesProcessorInfrastructure`, `BuildingPlacer`, `UserInterface`, `Easings`, `SnapToGridMouseMovement`, `FPSDisplay`, `SimpleDisableAfterTime`, `UnitTextDisplay`, `TechTreeProcessor.cs`, `RandomEnabler`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `StableId` connect `StableId` to `Vec`, `String`, `Res`, `.new`, `config.rs`, `save.rs`, `Option`, `command.rs`, `twitch.rs`, `GeneratedWorld`, `stream_town_domain/src/content.rs`, `Option`, `update_vote_panels`, `TechnologyGraphViewState`, `generate_world`, `AnimationControllerDef`, `runtime_console.rs`, `String`, `ContentCatalog`, `ToolState`, `stream_town_migrate/src/presentation.rs`, `Result`, `stream_town_migrate/src/menu_scene.rs`, `stream_town_migrate/src/content.rs`, `setup_rendering`, `stream_town_domain/src/presentation.rs`, `stream_town_game/src/lib.rs`, `GameConfig`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `PlayerProcessor` connect `PlayerProcessor` to `PlayerRole`, `BuildingProcessor`, `EnemySpawner`, `TwitchChatProcessor`, `BottomBarInterface`, `UserInterface_Debug`, `HealthHandler`, `WorldGenProcessor`, `PlayerRoleData`, `TechTreeProcessor`, `Player`, `StreamTownSessionBridge`, `TwitchClientProcessor`, `UIProcessor`, `UserInterface_Event`, `MonoBehaviour`, `NewKingVote`, `ObjectPoolingProcessor`, `UserInterface_TownVote`, `BuildingPlacer`, `UserInterface`, `GameEvent`, `IProcessor`, `Resource`, `SaveProcessor`, `RoleHandler`, `GameEventProcessor`?**
